        ...
        wp_localize_script(
            'dt_metrics_project_script', 'dtMetricsProject', [
                ...
                'translations'       => [
                    ...
                    'stacked_chart_title' => __( 'Records with values for the selected field', 'disciple_tools' ),
                    'cumulative_chart_title' => __( 'Records with values for the selected field', 'disciple_tools' ),
                    'additions_chart_title' => __( 'Records with changes on the selected field', 'disciple_tools' ),
