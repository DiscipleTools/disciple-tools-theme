    ...
    public function __construct(){
        ...
        if ( strpos( $url_path, 'metrics' ) !== false ){
            ...
            add_action( 'after_setup_theme', function () {
                ...
                if ( dt_has_permissions( array( 'dt_all_access_contacts', 'view_project_metrics' ) ) ){ // tests if project level permissions
                    /* Contacts */
            ...
            add_filter( 'dt_metrics_menu', function ( $content ) {
                ...
                if ( $content === '' ){
                    ...
                    if ( dt_has_permissions( array( 'dt_all_access_contacts', 'view_project_metrics' ) ) ){
