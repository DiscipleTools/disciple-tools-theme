...
class DT_Metrics_Personal_Groups_Points_Map extends DT_Metrics_Chart_Base
{
    ...
    public $title;
    public $slug = 'mapbox_groups_points_map'; // lowercase
    ...
    public function __construct() {
        ...
        $this->title = __( 'Groups Points Map', 'disciple_tools' );
    ...
    public function points_geojson( WP_REST_Request $request ) {
        ...
        return self::get_my_groups_points_geojson( $my_list, $status );
    }
    ...
    public static function get_my_groups_points_geojson( $my_list, $status = null ) {
        global $wpdb;
...
new DT_Metrics_Personal_Groups_Points_Map();
