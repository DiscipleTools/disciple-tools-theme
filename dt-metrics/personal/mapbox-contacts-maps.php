...
class DT_Metrics_Mapbox_Personal_Contacts_Maps extends DT_Metrics_Chart_Base
{
    ...
    public $base_filter = array( 'shared_with' => array( 'me' ) );
    ...
    public function __construct() {
        ...
        if ( !empty( $modules['access_module']['enabled'] ) ){
            $this->base_filter = array( array( array( 'type' => array( 'access' ), 'assigned_to' => array( 'me' ), 'overall_status' => array( '-closed' ) ), array( 'type' => array( 'connection', 'personal' ), 'shared_with' => array( 'me' ) ) ) );
        }
