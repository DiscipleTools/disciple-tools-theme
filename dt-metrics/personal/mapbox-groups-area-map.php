...
class DT_Metrics_Personal_Groups_Area_Map extends DT_Metrics_Chart_Base
{
    ...
    public $title;
    public $slug = 'mapbox_groups_area_map'; // lowercase
    ...
    public function __construct() {
        ...
        $this->title = __( 'Groups Area Map', 'disciple_tools' );
    ...
    public function get_grid_totals( WP_REST_Request $request ) {
        ...
        $results = self::get_my_groups_grid_totals( $my_list, $status );
    ...
    public function list_by_grid_id( WP_REST_Request $request ) {
        ...
        return self::query_my_groups_under_grid_id( $grid_id, $my_list, $status );
    }

    public static function get_my_groups_grid_totals( $my_list, $status = null ) {
    ...
    public static function query_my_groups_under_grid_id( $grid_id, $user_post_ids, $status = null ) {
        global $wpdb;
...
new DT_Metrics_Personal_Groups_Area_Map();
