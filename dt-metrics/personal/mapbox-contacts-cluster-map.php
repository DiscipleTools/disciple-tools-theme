...
class DT_Metrics_Personal_Contacts_Cluster_Map extends DT_Metrics_Chart_Base
{
    ...
    public function __construct() {
        ...
        $this->title = __( 'Contacts Cluster Map', 'disciple_tools' );
    ...
    public function cluster_geojson( WP_REST_Request $request ) {
        ...
        return self::get_my_contacts_cluster_geojson( $my_list, $status );
    }

    public static function get_my_contacts_cluster_geojson( array $user_post_ids, $status = null ) {
        global $wpdb;
...
new DT_Metrics_Personal_Contacts_Cluster_Map();
