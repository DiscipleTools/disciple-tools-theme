jQuery(document).ready(function() {
    ...
    if( '#project_reports' === window.location.hash  ) {
        project_reports()
    }
...
function project_reports() {
    ...
    chartDiv.empty().html(`
        <span class="section-header">`+ label.title_reports +`</span>
        <span style="float:right; font-size:1.5em;color:#3f729b;"><a data-open="dt-project-legend"><i class="fi-info"></i></a></span>
        <div class="medium reveal" id="dt-project-legend" data-reveal>`+ legend() +`<button class="close-button" data-close aria-label="Close modal" type="button">
                        <span aria-hidden="true">&times;</span>
                    </button></div>
        ...
        <div class="grid-x grid-padding-x grid-padding-y">
            ...
            <div class="cell">
            <button type="button" data-open="reveal-baptisms" class="button">View Baptisms</button>
                <div class="large reveal" id="reveal-baptisms" data-reveal>
                    <h2>Baptisms</h2>
                    <div id="baptisms-content"></div>
    ...
    console.log( sourceData.baptisms )
    let baptisms = jQuery('#baptisms-content')

    jQuery.each( sourceData.baptisms, function(i, v) {
        baptisms.append('<tr><td>'+v.post_title+'</td><td>'+v.baptism_date+'</td></tr>')
    })
    baptisms.prepend('<table class="stack"><tr><td>Name</td><td>Date</td></tr>')
    baptisms.append('</table>')



    new Foundation.Reveal(jQuery('#reveal-baptisms'));
    new Foundation.Reveal(jQuery('#dt-project-legend'));
