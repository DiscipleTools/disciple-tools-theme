jQuery(document).ready(function() {
  ...
  chartDiv.empty().html(`
    <div class="section-header">${ _.escape(window.wp_js_object.translations.milestones) }</div>
    <div class="section-subheader">${ _.escape(window.wp_js_object.translations.filter_to_date_range) }:</div>
