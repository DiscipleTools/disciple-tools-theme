...
class Disciple_Tools_Network_Queries {
    ...
    public static function locations_current_state() : array {
        ...
        $results['active_countries'] = (int) count( Disciple_Tools_Mapping_Queries::active_countries_location_grid() );
        $results['active_admin1'] = (int) count( Disciple_Tools_Mapping_Queries::active_admin1_location_grid() );
        $results['active_admin2'] = (int) count( Disciple_Tools_Mapping_Queries::active_admin2_location_grid() );
