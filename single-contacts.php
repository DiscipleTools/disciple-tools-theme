...
<!--    <div id="errors"></div>-->
    ...
    <div class="reveal" id="create-tag-modal" data-reveal data-reset-on-close>
        ...
        <form class="js-create-tag">
            ...
            <input name="title" id="new-tag" type="text" placeholder="<?php echo esc_html_e( "Tag", 'disciple_tools' ); ?>" required aria-describedby="name-help-text">
        ...
        <form id="create-user-form">
            ...
            <label for="user-display">
                ...
                <input name="user-display" id="user-display" type="text"
                       ...
                       placeholder="<?php echo esc_html_e( "Display Name", 'disciple_tools' ) ?>">
            </label>
