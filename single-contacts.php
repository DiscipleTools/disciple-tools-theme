            ...
            <div class="cell grid-y grid-margin-y" style="display: block">
                ...
                <section id="duplicates" class="small-12 grid-y grid-margin-y cell">
                    <div class="bordered-box detail-notification-box" style="background-color:#ff9800">
                        <h4 class="section-header" style="color:white;">
                            <?php esc_html_e( "This contact has possible duplicates.", 'disciple_tools' ) ?></h4>
                    ...
                    <div class="grid-x grid-margin-x grid-margin-y grid">
                        <section id="relationships" class="xlarge-6 large-12 medium-6 cell grid-item">
                            ...
                            <div class="bordered-box" id="connections-tile">
                                ...
                                <div class="section-body">
                                    ...
                                    <div id="groups_t" name="form-groups"
                                        class="scrollable-typeahead typeahead-margin-when-active">
                                        <div class="typeahead__container">
                                            <div class="typeahead__field">
                                                <span class="typeahead__query">
                                                    <input class="js-typeahead-groups input-height" name="groups[query]"
                                                        placeholder="<?php echo esc_html_x( "Search Groups", 'input field placeholder', 'disciple_tools' ) ?>"
                                                        autocomplete="off">
                                                </span>
                                                <span class="typeahead__button">
                                                    <button type="button" data-open="create-group-modal"
                                                        class="create-new-group typeahead__image_button input-height">
                                                        <img
                                    ...
                                    <div id="<?php echo esc_attr( $connection . '_connection' ) ?>">
                                        ...
                                        <var id="<?php echo esc_html( $connection ) ?>-result-container"
                                            class="result-container"></var>
                                        <div id="<?php echo esc_html( $connection ) ?>_t"
                                            name="form-<?php echo esc_html( $connection ) ?>"
                                            class="scrollable-typeahead typeahead-margin-when-active">
                                            <div class="typeahead__container">
                                                <div class="typeahead__field">
                                                    <span class="typeahead__query">
                                                        <input
                                                            class="js-typeahead-<?php echo esc_html( $connection ) ?> input-height"
                                                            name="<?php echo esc_html( $connection ) ?>[query]"
                                                            placeholder="<?php echo esc_html_x( "Search multipliers and contacts", 'input field placeholder', 'disciple_tools' ) ?>"
                                                            autocomplete="off">
                                                    </span>
                                                    <span class="typeahead__button">
                                                        <button type="button"
                                                            data-connection-key="<?php echo esc_html( $connection ) ?>"
                                                            class="create-new-contact typeahead__image_button input-height">
                                                            <img
                                                                src="<?php echo esc_html( get_template_directory_uri() . '/dt-assets/images/add-contact.svg' ) ?>" />
                                                        </button>
                                                    </span>
                                                </div>
                                            </div>
                            ...
                            <div class="bordered-box" id="progress-tile">
                                ...
                                <div class="section-body">
                                    ...
                                    <div class="progress" role="progressbar" tabindex="0"
                                        ...
                                        aria-valuemax="100">
                                        <div id="seeker-progress" class="progress-meter"
                                            style="width: <?php echo esc_html( $percentage ) ?>%"></div>
                                    </div>
                                    ...
                                    <div class="baptism_date">
                                        <div class="section-subheader">
                                            <?php esc_html_e( 'Baptism Date', 'disciple_tools' )?>
                        ...
                        <?php
                            ...
                            foreach ( $sections as $section ){
                                ?>
                        <section id="<?php echo esc_html( $section ) ?>"
                            class="xlarge-6 large-12 medium-6 cell grid-item">
                            ...
                            <div class="bordered-box" id="other-tile">
                                ...
                                <div class="section-body">
                                    ...
                                    <div class="tags">
                                        ...
                                        <div id="tags_t" name="form-tags"
                                            class="scrollable-typeahead typeahead-margin-when-active">
                                            <div class="typeahead__container">
                                                <div class="typeahead__field">
                                                    <span class="typeahead__query">
                                                        <input class="js-typeahead-tags input-height" name="tags[query]"
                                                            placeholder="<?php echo esc_html_x( "Search Tags", 'input field placeholder', 'disciple_tools' ) ?>"
                                                            autocomplete="off">
                                                    </span>
                                                    <span class="typeahead__button">
...
<div class="reveal" id="unassignable-contact-modal" data-reveal>
    ...
    <button class="button loader confirm-reason-button" type="button" id="confirm-unassignable"
        data-field="unassignable">
        <?php echo esc_html_x( 'Confirm', 'button', 'disciple_tools' )?>
    </button>
    <button class="close-button" data-close aria-label="Close modal" type="button">
        <span aria-hidden="true">&times;</span>
...
<div class="reveal" id="create-tag-modal" data-reveal data-reset-on-close>
    ...
    <form class="js-create-tag">
        ...
        <input name="title" id="new-tag" type="text"
            placeholder="<?php echo esc_html_x( "tag", 'input field placeholder', 'disciple_tools' ); ?>" required
...
<div class="reveal" id="baptism-modal" data-reveal>
    ...
    <div>
        ...
        <div class="modal_baptized_by details">
            <var id="modal_baptized_by-result-container"
                class="result-container modal_baptized_by-result-container"></var>
            <div id="modal_baptized_by_t" name="form-modal_baptized_by"
                class="scrollable-typeahead typeahead-margin-when-active">
                <div class="typeahead__container">
                    <div class="typeahead__field">
                        <span class="typeahead__query">
                            <input class="js-typeahead-modal_baptized_by input-height" name="modal_baptized_by[query]"
                                placeholder="<?php echo esc_html_x( "Search multipliers and contacts", 'input field placeholder', 'disciple_tools' ) ?>"
                                autocomplete="off">
                        </span>
                    </div>
        ...
        <input type="text" data-date-format='yy-mm-dd'
            value="<?php echo esc_html( $contact["baptism_date"]["formatted"] ?? '' )?>" id="modal-baptism-date-picker"
            autocomplete="off">

        <!--            <span class="section-subheader">--><?php //esc_html_e( "Baptism Generation", 'disciple_tools' ) ?>
        <!--</span>-->
...
<div class="reveal" id="make-user-from-contact-modal" data-reveal data-reset-on-close>
    ...
    <p><strong><?php echo esc_html_x( "This contact is already connected to a user.", 'Make user modal', 'disciple_tools' ) ?></strong>
    </p>
    <?php else : ?>

    <p><?php echo esc_html_x( "This will invite this contact to become a user of this system. By default, they will be given the role of a 'multiplier'.", 'Make user modal', 'disciple_tools' ) ?>
    </p>
    <p><?php echo esc_html_x( "In the fields below, enter their email address and a 'Display Name' which they can change later.", 'Make user modal', 'disciple_tools' ) ?>
    </p>
    ...
    <form id="create-user-form">
        ...
        <input name="user-email" id="user-email" type="email" placeholder="user@example.com" required
        ...
        <label for="user-display">
            ...
            <input name="user-display" id="user-display" type="text" value="<?php the_title_attribute(); ?>"
...
<div class="reveal" id="link-to-user-modal" data-reveal data-reset-on-close style="min-height:500px">
    ...
    <p><?php echo esc_html_x( "To link to an existing user, first, find the user using the field below.", 'Step 1 of link user', 'disciple_tools' ) ?>
    </p>
    ...
    <div class="user-select details">
        ...
        <div id="user-select_t" name="form-user-select">
            <div class="typeahead__container">
                <div class="typeahead__field">
                    <span class="typeahead__query">
                        <input class="js-typeahead-user-select input-height" name="user-select[query]"
                            placeholder="<?php echo esc_html_x( "Search Users", 'input field placeholder', 'disciple_tools' ) ?>"
                            autocomplete="off">
                    </span>
                    <span class="typeahead__button">
                        <button type="button" class="search_user-select typeahead__image_button input-height"
    ...
    <div class="confirm-merge-with-user" style="display: none">
        <p><?php echo esc_html_x( "To finish the linking, merge this contact with the existing user details.", 'Step 2 of link user', 'disciple_tools' ) ?>
        </p>
    </div>
...
<div class="reveal" id="merge-with-contact-modal" data-reveal style="min-height:500px">
    ...
    <div class="merge_with details">
        ...
        <div id="merge_with_t" name="form-merge_with">
            <div class="typeahead__container">
                <div class="typeahead__field">
                    <span class="typeahead__query">
                        <input class="js-typeahead-merge_with input-height" name="merge_with[query]"
                            placeholder="<?php echo esc_html_x( "Search multipliers and contacts", 'input field placeholder', 'disciple_tools' ) ?>"
                            autocomplete="off">
                    </span>
                    <span class="typeahead__button">
                        <button type="button" class="search_merge_with typeahead__image_button input-height"
                            data-id="user-select_t">
                            <img
                                src="<?php echo esc_html( get_template_directory_uri() . '/dt-assets/images/chevron_down.svg' ) ?>" />
                        </button>
    ...
    <div class="confirm-merge-with-contact" style="display: none">
        <p><span id="name-of-contact-to-merge"></span>
            <?php echo esc_html_x( "selected.", 'added to the end of a sentence', 'disciple_tools' ) ?></p>
