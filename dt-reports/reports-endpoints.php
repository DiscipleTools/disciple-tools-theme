...
/**
 * Class Disciple_Tools_Reports_Endpoints
 */
class Disciple_Tools_Reports_Endpoints
{
    ...
    /**
     * Disciple_Tools_Reports_Endpoints The single instance of Disciple_Tools_Reports_Endpoints.
     *
     * @var     object
     * @access    private
     * @since     0.1.0
    ...
    /**
     * Main Disciple_Tools_Reports_Endpoints Instance
     * Ensures only one instance of Disciple_Tools_Reports_Endpoints is loaded or can be loaded.
     *
     * @since 0.1.0
     * @static
     * @return Disciple_Tools_Reports_Endpoints instance
     */
