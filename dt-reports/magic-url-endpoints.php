...
'           . $name . ': ' . $link;
            ...
            $message_html = '
            <p style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">'. $note .'</p>
            ...
            foreach ( $emails as $email ) {
                $sent = dt_send_email( $email, $subject, $message_plain_text, $message_html );
