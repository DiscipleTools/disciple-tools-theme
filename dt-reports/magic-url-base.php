    ...
    public function dt_details_additional_section( $section, $post_type ) {
        ...
        if ( $section === "apps" && $post_type === $magic_post_type ) {
            ...
            <div class="section-app-links <?php echo esc_attr( $this->meta_key ); ?>">
                ...
                <a type="button" class="empty-select-button select-button small button copy_to_clipboard" data-value="<?php echo esc_url( site_url() . '/' . $this->root . '/' .$this->type . '/' . $key ) ?>"><img class="dt-icon" src="<?php echo get_template_directory_uri() . '/dt-assets/images/duplicate.svg' ?>" /></a>
