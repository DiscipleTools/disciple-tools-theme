<ul class="tabs" data-tabs id="my-contact-tabs">
    <li class="tabs-title is-active"><a href="#panel1" aria-selected="true">My Groups</a></li>
    <li class="tabs-title"><a href="#panel2">Team Groups</a></li>
    <li class="tabs-title"><a href="#panel3">Groups By Location</a></li>
