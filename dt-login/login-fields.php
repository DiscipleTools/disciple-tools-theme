    ...
    private static function get_defaults() {
        $defaults = [
            ...
            'google_captcha' => [
                ...
                'label' => 'Google Captcha Keys (Deprecated: Use Enterprise below)',
            ...
            'google_captcha_enterprise' => [
                ...
                'label' => 'Google Enterprise ReCaptcha Keys (Recommended)',
                'description' => 'Put your google enterprise captcha key here to enable google captcha in the login forms',
                'value' => '',
                'type' => 'label',
            ],
            'google_captcha_enterprise_key' => [
                ...
                'label' => 'Google Enterprise Recaptcha Key',
                'description' => 'The site key from Google reCAPTCHA Enterprise. Used with the GCP project ID (from Firebase settings) for enterprise captcha verification.',
                'value' => '',
                'type' => 'text',
                'multisite_level' => true,
            ],
