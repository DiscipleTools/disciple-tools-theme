...
if ( version_compare( phpversion(), '7.0', '<' ) ) {
    ...
    class Disciple_Tools
    {
        ...
        public function __construct() {
             ...
             * dt-mapping
             */
            require_once( get_template_directory() . '/dt-mapping/location-grid-endpoints.php' ); // Location grid geocoder
            require_once( get_template_directory() . '/dt-mapping/location-grid-list-api.php' ); // Location grid geocoder
