...
gulp.task('generate-favicon', function(done) {
	realFavicon.generateFavicon({
		masterPicture: 'dt-assets/dt-caret.png',
		dest: 'dt-assets/favicons',
		iconsPath: '/wp-content/themes/disciple-tools-theme/dt-assets/favicons',
		design: {
			ios: {
...
gulp.task('inject-favicon-markups', function() {
	return gulp.src([ 'dt-assets/favicons/markups.html' ])
		.pipe(realFavicon.injectFaviconMarkups(JSON.parse(fs.readFileSync(FAVICON_DATA_FILE)).favicon.html_code))
		.pipe(gulp.dest('dt-assets/favicons'));
});
