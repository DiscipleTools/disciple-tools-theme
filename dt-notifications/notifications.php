...
class Disciple_Tools_Notifications
{
    ...
    public static function pretty_timestamp($timestamp)
    {
        ...
        if ($timestamp > $one_hour_ago) {
            ...
            $friendly_time = 'Yesterday'; //date( "g:i a", strtotime( $timestamp ) );
    ...
    public static function insert_notification_for_post_update($post_type, $fields, $old_fields, $fields_changed_keys)
    {
        ...
        if (sizeof($notification_on_fields) > 0) {
            ...
            $subassigned = 'contacts' === $post_type ? Disciple_Tools_Posts::get_subassigned_users($fields['ID']) : [];
    ...
    public static function get_notification_message_html($notification)
    {
        ...
        if ('created' === $notification['notification_name']) {
        ...
        } elseif ('share' === $notification['notification_name']) {
            $source_user = get_userdata($notification['source_user_id']);
        ...
        } elseif ('mention' === $notification['notification_name']) {
            $source_user = get_userdata($notification['source_user_id']);
        ...
        } elseif ('comment' === $notification['notification_name']) {
            $source_user = get_userdata($notification['source_user_id']);
            $comment = get_comment($notification['secondary_item_id']);
            $comment_content = $comment ? self::format_comment($comment->comment_content) : '';
            $comment_content = "\r\n\r\n ".$comment_content;
        ...
        } elseif ('subassigned' === $notification['notification_name']) {
            $source_user = get_userdata($notification['source_user_id']);
            $display_name = $source_user ? $source_user->display_name : __('System', 'disciple_tools');
        ...
        } elseif ('milestone' === $notification['notification_name']) {
        ...
        } elseif ('requires_update' === $notification['notification_name']) {
        ...
        } elseif ('contact_info_update' === $notification['notification_name']) {
            $source_user = get_userdata($notification['source_user_id']);
            $display_name = $source_user ? $source_user->display_name : __('System', 'disciple_tools');
        ...
        } elseif ('assignment_declined' === $notification['notification_name']) {
