var DtWebComponents=function(x){"use strict";var In=Object.defineProperty;var Pn=(x,q,W)=>q in x?In(x,q,{enumerable:!0,configurable:!0,writable:!0,value:W}):x[q]=W;var Xe=(x,q,W)=>Pn(x,typeof q!="symbol"?q+"":q,W);/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const fe=globalThis,Ie=fe.trustedTypes,Zt=Ie?Ie.createPolicy("lit-html",{createHTML:o=>o}):void 0,Jt="$lit$",Z=`lit$${Math.random().toFixed(9).slice(2)}$`,Qt="?"+Z,Js=`<${Qt}>`,te=document,be=()=>te.createComment(""),ge=o=>o===null||typeof o!="object"&&typeof o!="function",it=Array.isArray,Qs=o=>it(o)||typeof(o==null?void 0:o[Symbol.iterator])=="function",st=`[ 	
\f\r]`,me=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Yt=/-->/g,Xt=/>/g,ie=RegExp(`>|${st}(?:([^\\s"'>=/]+)(${st}*=${st}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ei=/'/g,ti=/"/g,ii=/^(?:script|style|textarea|title)$/i,Ys=o=>(e,...t)=>({_$litType$:o,strings:e,values:t}),f=Ys(1),U=Symbol.for("lit-noChange"),E=Symbol.for("lit-nothing"),si=new WeakMap,se=te.createTreeWalker(te,129);function oi(o,e){if(!it(o)||!o.hasOwnProperty("raw"))throw Error("invalid template strings array");return Zt!==void 0?Zt.createHTML(e):e}const Xs=(o,e)=>{const t=o.length-1,i=[];let s,a=e===2?"<svg>":e===3?"<math>":"",r=me;for(let n=0;n<t;n++){const l=o[n];let c,b,g=-1,v=0;for(;v<l.length&&(r.lastIndex=v,b=r.exec(l),b!==null);)v=r.lastIndex,r===me?b[1]==="!--"?r=Yt:b[1]!==void 0?r=Xt:b[2]!==void 0?(ii.test(b[2])&&(s=RegExp("</"+b[2],"g")),r=ie):b[3]!==void 0&&(r=ie):r===ie?b[0]===">"?(r=s??me,g=-1):b[1]===void 0?g=-2:(g=r.lastIndex-b[2].length,c=b[1],r=b[3]===void 0?ie:b[3]==='"'?ti:ei):r===ti||r===ei?r=ie:r===Yt||r===Xt?r=me:(r=ie,s=void 0);const y=r===ie&&o[n+1].startsWith("/>")?" ":"";a+=r===me?l+Js:g>=0?(i.push(c),l.slice(0,g)+Jt+l.slice(g)+Z+y):l+Z+(g===-2?n:y)}return[oi(o,a+(o[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),i]};class ve{constructor({strings:e,_$litType$:t},i){let s;this.parts=[];let a=0,r=0;const n=e.length-1,l=this.parts,[c,b]=Xs(e,t);if(this.el=ve.createElement(c,i),se.currentNode=this.el.content,t===2||t===3){const g=this.el.content.firstChild;g.replaceWith(...g.childNodes)}for(;(s=se.nextNode())!==null&&l.length<n;){if(s.nodeType===1){if(s.hasAttributes())for(const g of s.getAttributeNames())if(g.endsWith(Jt)){const v=b[r++],y=s.getAttribute(g).split(Z),w=/([.?@])?(.*)/.exec(v);l.push({type:1,index:a,name:w[2],strings:y,ctor:w[1]==="."?to:w[1]==="?"?io:w[1]==="@"?so:Pe}),s.removeAttribute(g)}else g.startsWith(Z)&&(l.push({type:6,index:a}),s.removeAttribute(g));if(ii.test(s.tagName)){const g=s.textContent.split(Z),v=g.length-1;if(v>0){s.textContent=Ie?Ie.emptyScript:"";for(let y=0;y<v;y++)s.append(g[y],be()),se.nextNode(),l.push({type:2,index:++a});s.append(g[v],be())}}}else if(s.nodeType===8)if(s.data===Qt)l.push({type:2,index:a});else{let g=-1;for(;(g=s.data.indexOf(Z,g+1))!==-1;)l.push({type:7,index:a}),g+=Z.length-1}a++}}static createElement(e,t){const i=te.createElement("template");return i.innerHTML=e,i}}function de(o,e,t=o,i){var r,n;if(e===U)return e;let s=i!==void 0?(r=t._$Co)==null?void 0:r[i]:t._$Cl;const a=ge(e)?void 0:e._$litDirective$;return(s==null?void 0:s.constructor)!==a&&((n=s==null?void 0:s._$AO)==null||n.call(s,!1),a===void 0?s=void 0:(s=new a(o),s._$AT(o,t,i)),i!==void 0?(t._$Co??(t._$Co=[]))[i]=s:t._$Cl=s),s!==void 0&&(e=de(o,s._$AS(o,e.values),s,i)),e}let eo=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:i}=this._$AD,s=((e==null?void 0:e.creationScope)??te).importNode(t,!0);se.currentNode=s;let a=se.nextNode(),r=0,n=0,l=i[0];for(;l!==void 0;){if(r===l.index){let c;l.type===2?c=new ce(a,a.nextSibling,this,e):l.type===1?c=new l.ctor(a,l.name,l.strings,this,e):l.type===6&&(c=new oo(a,this,e)),this._$AV.push(c),l=i[++n]}r!==(l==null?void 0:l.index)&&(a=se.nextNode(),r++)}return se.currentNode=te,s}p(e){let t=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}};class ce{get _$AU(){var e;return((e=this._$AM)==null?void 0:e._$AU)??this._$Cv}constructor(e,t,i,s){this.type=2,this._$AH=E,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=s,this._$Cv=(s==null?void 0:s.isConnected)??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=de(this,e,t),ge(e)?e===E||e==null||e===""?(this._$AH!==E&&this._$AR(),this._$AH=E):e!==this._$AH&&e!==U&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Qs(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==E&&ge(this._$AH)?this._$AA.nextSibling.data=e:this.T(te.createTextNode(e)),this._$AH=e}$(e){var a;const{values:t,_$litType$:i}=e,s=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=ve.createElement(oi(i.h,i.h[0]),this.options)),i);if(((a=this._$AH)==null?void 0:a._$AD)===s)this._$AH.p(t);else{const r=new eo(s,this),n=r.u(this.options);r.p(t),this.T(n),this._$AH=r}}_$AC(e){let t=si.get(e.strings);return t===void 0&&si.set(e.strings,t=new ve(e)),t}k(e){it(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,s=0;for(const a of e)s===t.length?t.push(i=new ce(this.O(be()),this.O(be()),this,this.options)):i=t[s],i._$AI(a),s++;s<t.length&&(this._$AR(i&&i._$AB.nextSibling,s),t.length=s)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)==null?void 0:i.call(this,!1,!0,t);e&&e!==this._$AB;){const s=e.nextSibling;e.remove(),e=s}}setConnected(e){var t;this._$AM===void 0&&(this._$Cv=e,(t=this._$AP)==null||t.call(this,e))}}class Pe{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,s,a){this.type=1,this._$AH=E,this._$AN=void 0,this.element=e,this.name=t,this._$AM=s,this.options=a,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=E}_$AI(e,t=this,i,s){const a=this.strings;let r=!1;if(a===void 0)e=de(this,e,t,0),r=!ge(e)||e!==this._$AH&&e!==U,r&&(this._$AH=e);else{const n=e;let l,c;for(e=a[0],l=0;l<a.length-1;l++)c=de(this,n[i+l],t,l),c===U&&(c=this._$AH[l]),r||(r=!ge(c)||c!==this._$AH[l]),c===E?e=E:e!==E&&(e+=(c??"")+a[l+1]),this._$AH[l]=c}r&&!s&&this.j(e)}j(e){e===E?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class to extends Pe{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===E?void 0:e}}class io extends Pe{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==E)}}class so extends Pe{constructor(e,t,i,s,a){super(e,t,i,s,a),this.type=5}_$AI(e,t=this){if((e=de(this,e,t,0)??E)===U)return;const i=this._$AH,s=e===E&&i!==E||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,a=e!==E&&(i===E||s);s&&this.element.removeEventListener(this.name,this,i),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t;typeof this._$AH=="function"?this._$AH.call(((t=this.options)==null?void 0:t.host)??this.element,e):this._$AH.handleEvent(e)}}class oo{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){de(this,e)}}const ao={I:ce},ot=fe.litHtmlPolyfillSupport;ot==null||ot(ve,ce),(fe.litHtmlVersions??(fe.litHtmlVersions=[])).push("3.2.1");const ro=(o,e,t)=>{const i=(t==null?void 0:t.renderBefore)??e;let s=i._$litPart$;if(s===void 0){const a=(t==null?void 0:t.renderBefore)??null;i._$litPart$=s=new ce(e.insertBefore(be(),a),a,void 0,t??{})}return s._$AI(o),s};/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const V=[];for(let o=0;o<256;o++)V[o]=(o>>4&15).toString(16)+(o&15).toString(16);function _o(o){let e=0,t=8997,i=0,s=33826,a=0,r=40164,n=0,l=52210;for(let c=0;c<o.length;c++)t^=o.charCodeAt(c),e=t*435,i=s*435,a=r*435,n=l*435,a+=t<<8,n+=s<<8,i+=e>>>16,t=e&65535,a+=i>>>16,s=i&65535,l=n+(a>>>16)&65535,r=a&65535;return V[l>>8]+V[l&255]+V[r>>8]+V[r&255]+V[s>>8]+V[s&255]+V[t>>8]+V[t&255]}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const wi="important",jo=" !"+wi,Q=ut(class extends ht{constructor(o){var e;if(super(o),o.type!==ct.ATTRIBUTE||o.name!=="style"||((e=o.strings)==null?void 0:e.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(o){return Object.keys(o).reduce((e,t)=>{const i=o[t];return i==null?e:e+`${t=t.includes("-")?t:t.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${i};`},"")}update(o,[e]){const{style:t}=o.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(e)),this.render(e);for(const i of this.ft)e[i]==null&&(this.ft.delete(i),i.includes("-")?t.removeProperty(i):t[i]=null);for(const i in e){const s=e[i];if(s!=null){this.ft.add(i);const a=typeof s=="string"&&s.endsWith(jo);i.includes("-")||a?t.setProperty(i,a?s.slice(0,-11):s,a?wi:""):t[i]=s}}return U}});class _i extends R{static get styles(){return $`
    ...
    `}}window.customElements.define("dt-label",_i);class Do extends oe{static get styles(){return $`
      @keyframes spin {
        0% {
...
*/const $i=Object.freeze({left:0,top:0,width:16,height:16}),Re=Object.freeze({rotate:0,vFlip:!1,hFlip:!1}),we=Object.freeze({...$i,...Re}),vt=Object.freeze({...we,body:"",hidden:!1}),zo=Object.freeze({width:null,height:null}),xi=Object.freeze({...zo,...Re});function Ro(o,e=0){const t=o.replace(/^-?[0-9.]*/,"");function i(s){for(;s<0;)s+=4;return s%4}if(t===""){const s=parseInt(o);return isNaN(s)?0:i(s)}else if(t!==o){let s=0;switch(t){case"%":s=25;break;case"deg":s=90}if(s){let a=parseFloat(o.slice(0,o.length-t.length));return isNaN(a)?0:(a=a/s,a%1===0?i(a):0)}}return e}const No=/[\s,]+/;function qo(o,e){e.split(No).forEach(t=>{switch(t.trim()){case"horizontal":o.hFlip=!0;break;case"vertical":o.vFlip=!0;break}})}const ki={...xi,preserveAspectRatio:""};function Si(o){const e={...ki},t=(i,s)=>o.getAttribute(i)||s;return e.width=t("width",null),e.height=t("height",null),e.rotate=Ro(t("rotate","")),qo(e,t("flip","")),e.preserveAspectRatio=t("preserveAspectRatio",t("preserveaspectratio","")),e}function Fo(o,e){for(const t in ki)if(o[t]!==e[t])return!0;return!1}const _e=/^[a-z0-9]+(-[a-z0-9]+)*$/,$e=(o,e,t,i="")=>{const s=o.split(":");if(o.slice(0,1)==="@"){if(s.length<2||s.length>3)return null;i=s.shift().slice(1)}if(s.length>3||!s.length)return null;if(s.length>1){const n=s.pop(),l=s.pop(),c={provider:s.length>0?s[0]:i,prefix:l,name:n};return e&&!Ne(c)?null:c}const a=s[0],r=a.split("-");if(r.length>1){const n={provider:i,prefix:r.shift(),name:r.join("-")};return e&&!Ne(n)?null:n}if(t&&i===""){const n={provider:i,prefix:"",name:a};return e&&!Ne(n,t)?null:n}return null},Ne=(o,e)=>o?!!((o.provider===""||o.provider.match(_e))&&(e&&o.prefix===""||o.prefix.match(_e))&&o.name.match(_e)):!1;function Uo(o,e){const t={};!o.hFlip!=!e.hFlip&&(t.hFlip=!0),!o.vFlip!=!e.vFlip&&(t.vFlip=!0);const i=((o.rotate||0)+(e.rotate||0))%4;return i&&(t.rotate=i),t}function Ti(o,e){const t=Uo(o,e);for(const i in vt)i in Re?i in o&&!(i in t)&&(t[i]=Re[i]):i in e?t[i]=e[i]:i in o&&(t[i]=o[i]);return t}function Vo(o,e){const t=o.icons,i=o.aliases||Object.create(null),s=Object.create(null);function a(r){if(t[r])return s[r]=[];if(!(r in s)){s[r]=null;const n=i[r]&&i[r].parent,l=n&&a(n);l&&(s[r]=[n].concat(l))}return s[r]}return Object.keys(t).concat(Object.keys(i)).forEach(a),s}function Bo(o,e,t){const i=o.icons,s=o.aliases||Object.create(null);let a={};function r(n){a=Ti(i[n]||s[n],a)}return r(e),t.forEach(r),Ti(o,a)}function Ai(o,e){const t=[];if(typeof o!="object"||typeof o.icons!="object")return t;o.not_found instanceof Array&&o.not_found.forEach(s=>{e(s,null),t.push(s)});const i=Vo(o);for(const s in i){const a=i[s];a&&(e(s,Bo(o,s,a)),t.push(s))}return t}const Ho={provider:"",aliases:{},not_found:{},...$i};function yt(o,e){for(const t in e)if(t in o&&typeof o[t]!=typeof e[t])return!1;return!0}function Ei(o){if(typeof o!="object"||o===null)return null;const e=o;if(typeof e.prefix!="string"||!o.icons||typeof o.icons!="object"||!yt(o,Ho))return null;const t=e.icons;for(const s in t){const a=t[s];if(!s.match(_e)||typeof a.body!="string"||!yt(a,vt))return null}const i=e.aliases||Object.create(null);for(const s in i){const a=i[s],r=a.parent;if(!s.match(_e)||typeof r!="string"||!t[r]&&!i[r]||!yt(a,vt))return null}return e}const qe=Object.create(null);function Go(o,e){return{provider:o,prefix:e,icons:Object.create(null),missing:new Set}}function Y(o,e){const t=qe[o]||(qe[o]=Object.create(null));return t[e]||(t[e]=Go(o,e))}function wt(o,e){return Ei(e)?Ai(e,(t,i)=>{i?o.icons[t]=i:o.missing.add(t)}):[]}function Wo(o,e,t){try{if(typeof t.body=="string")return o.icons[e]={...t},!0}catch{}return!1}function Ko(o,e){let t=[];return(typeof o=="string"?[o]:Object.keys(qe)).forEach(s=>{(typeof s=="string"&&typeof e=="string"?[e]:Object.keys(qe[s]||{})).forEach(r=>{const n=Y(s,r);t=t.concat(Object.keys(n.icons).map(l=>(s!==""?"@"+s+":":"")+r+":"+l))})}),t}let xe=!1;function Oi(o){return typeof o=="boolean"&&(xe=o),xe}function ke(o){const e=typeof o=="string"?$e(o,!0,xe):o;if(e){const t=Y(e.provider,e.prefix),i=e.name;return t.icons[i]||(t.missing.has(i)?null:void 0)}}function Ci(o,e){const t=$e(o,!0,xe);if(!t)return!1;const i=Y(t.provider,t.prefix);return Wo(i,t.name,e)}function Li(o,e){if(typeof o!="object")return!1;if(typeof e!="string"&&(e=o.provider||""),xe&&!e&&!o.prefix){let s=!1;return Ei(o)&&(o.prefix="",Ai(o,(a,r)=>{r&&Ci(a,r)&&(s=!0)})),s}const t=o.prefix;if(!Ne({provider:e,prefix:t,name:"a"}))return!1;const i=Y(e,t);return!!wt(i,o)}function Zo(o){return!!ke(o)}function Jo(o){const e=ke(o);return e?{...we,...e}:null}function Qo(o){const e={loaded:[],missing:[],pending:[]},t=Object.create(null);o.sort((s,a)=>s.provider!==a.provider?s.provider.localeCompare(a.provider):s.prefix!==a.prefix?s.prefix.localeCompare(a.prefix):s.name.localeCompare(a.name));let i={provider:"",prefix:"",name:""};return o.forEach(s=>{if(i.name===s.name&&i.prefix===s.prefix&&i.provider===s.provider)return;i=s;const a=s.provider,r=s.prefix,n=s.name,l=t[a]||(t[a]=Object.create(null)),c=l[r]||(l[r]=Y(a,r));let b;n in c.icons?b=e.loaded:r===""||c.missing.has(n)?b=e.missing:b=e.pending;const g={provider:a,prefix:r,name:n};b.push(g)}),e}function Ii(o,e){o.forEach(t=>{const i=t.loaderCallbacks;i&&(t.loaderCallbacks=i.filter(s=>s.id!==e))})}function Yo(o){o.pendingCallbacksFlag||(o.pendingCallbacksFlag=!0,setTimeout(()=>{o.pendingCallbacksFlag=!1;const e=o.loaderCallbacks?o.loaderCallbacks.slice(0):[];if(!e.length)return;let t=!1;const i=o.provider,s=o.prefix;e.forEach(a=>{const r=a.icons,n=r.pending.length;r.pending=r.pending.filter(l=>{if(l.prefix!==s)return!0;const c=l.name;if(o.icons[c])r.loaded.push({provider:i,prefix:s,name:c});else if(o.missing.has(c))r.missing.push({provider:i,prefix:s,name:c});else return t=!0,!0;return!1}),r.pending.length!==n&&(t||Ii([o],a.id),a.callback(r.loaded.slice(0),r.missing.slice(0),r.pending.slice(0),a.abort))})}))}let Xo=0;function ea(o,e,t){const i=Xo++,s=Ii.bind(null,t,i);if(!e.pending.length)return s;const a={id:i,icons:e,callback:o,abort:s};return t.forEach(r=>{(r.loaderCallbacks||(r.loaderCallbacks=[])).push(a)}),s}const _t=Object.create(null);function Pi(o,e){_t[o]=e}function $t(o){return _t[o]||_t[""]}function ta(o,e=!0,t=!1){const i=[];return o.forEach(s=>{const a=typeof s=="string"?$e(s,e,t):s;a&&i.push(a)}),i}var ia={resources:[],index:0,timeout:2e3,rotate:750,random:!1,dataAfterTimeout:!1};function sa(o,e,t,i){const s=o.resources.length,a=o.random?Math.floor(Math.random()*s):o.index;let r;if(o.random){let T=o.resources.slice(0);for(r=[];T.length>1;){const z=Math.floor(Math.random()*T.length);r.push(T[z]),T=T.slice(0,z).concat(T.slice(z+1))}r=r.concat(T)}else r=o.resources.slice(a).concat(o.resources.slice(0,a));const n=Date.now();let l="pending",c=0,b,g=null,v=[],y=[];typeof i=="function"&&y.push(i);function w(){g&&(clearTimeout(g),g=null)}function L(){l==="pending"&&(l="aborted"),w(),v.forEach(T=>{T.status==="pending"&&(T.status="aborted")}),v=[]}function N(T,z){z&&(y=[]),typeof T=="function"&&y.push(T)}function M(){return{startTime:n,payload:e,status:l,queriesSent:c,queriesPending:v.length,subscribe:N,abort:L}}function I(){l="failed",y.forEach(T=>{T(void 0,b)})}function Ce(){v.forEach(T=>{T.status==="pending"&&(T.status="aborted")}),v=[]}function Ze(T,z,le){const ee=z!=="success";switch(v=v.filter(P=>P!==T),l){case"pending":break;case"failed":if(ee||!o.dataAfterTimeout)return;break;default:return}if(z==="abort"){b=le,I();return}if(ee){b=le,v.length||(r.length?X():I());return}if(w(),Ce(),!o.random){const P=o.resources.indexOf(T.resource);P!==-1&&P!==o.index&&(o.index=P)}l="completed",y.forEach(P=>{P(le)})}function X(){if(l!=="pending")return;w();const T=r.shift();if(T===void 0){if(v.length){g=setTimeout(()=>{w(),l==="pending"&&(Ce(),I())},o.timeout);return}I();return}const z={status:"pending",resource:T,callback:(le,ee)=>{Ze(z,le,ee)}};v.push(z),c++,g=setTimeout(X,o.rotate),t(T,e,z.callback)}return setTimeout(X),M}function Mi(o){const e={...ia,...o};let t=[];function i(){t=t.filter(n=>n().status==="pending")}function s(n,l,c){const b=sa(e,n,l,(g,v)=>{i(),c&&c(g,v)});return t.push(b),b}function a(n){return t.find(l=>n(l))||null}return{query:s,find:a,setIndex:n=>{e.index=n},getIndex:()=>e.index,cleanup:i}}function xt(o){let e;if(typeof o.resources=="string")e=[o.resources];else if(e=o.resources,!(e instanceof Array)||!e.length)return null;return{resources:e,path:o.path||"/",maxURL:o.maxURL||500,rotate:o.rotate||750,timeout:o.timeout||5e3,random:o.random===!0,index:o.index||0,dataAfterTimeout:o.dataAfterTimeout!==!1}}const Fe=Object.create(null),Se=["https://api.simplesvg.com","https://api.unisvg.com"],Ue=[];for(;Se.length>0;)Se.length===1||Math.random()>.5?Ue.push(Se.shift()):Ue.push(Se.pop());Fe[""]=xt({resources:["https://api.iconify.design"].concat(Ue)});function ji(o,e){const t=xt(e);return t===null?!1:(Fe[o]=t,!0)}function Ve(o){return Fe[o]}function oa(){return Object.keys(Fe)}function Di(){}const kt=Object.create(null);function aa(o){if(!kt[o]){const e=Ve(o);if(!e)return;const t=Mi(e),i={config:e,redundancy:t};kt[o]=i}return kt[o]}function zi(o,e,t){let i,s;if(typeof o=="string"){const a=$t(o);if(!a)return t(void 0,424),Di;s=a.send;const r=aa(o);r&&(i=r.redundancy)}else{const a=xt(o);if(a){i=Mi(a);const r=o.resources?o.resources[0]:"",n=$t(r);n&&(s=n.send)}}return!i||!s?(t(void 0,424),Di):i.query(e,s,t)().abort}const Ri="iconify2",Te="iconify",Ni=Te+"-count",qi=Te+"-version",Fi=36e5,ra=168;function St(o,e){try{return o.getItem(e)}catch{}}function Tt(o,e,t){try{return o.setItem(e,t),!0}catch{}}function Ui(o,e){try{o.removeItem(e)}catch{}}function At(o,e){return Tt(o,Ni,e.toString())}function Et(o){return parseInt(St(o,Ni))||0}const re={local:!0,session:!0},Vi={local:new Set,session:new Set};let Ot=!1;function na(o){Ot=o}let Be=typeof window>"u"?{}:window;function Bi(o){const e=o+"Storage";try{if(Be&&Be[e]&&typeof Be[e].length=="number")return Be[e]}catch{}re[o]=!1}function Hi(o,e){const t=Bi(o);if(!t)return;const i=St(t,qi);if(i!==Ri){if(i){const n=Et(t);for(let l=0;l<n;l++)Ui(t,Te+l.toString())}Tt(t,qi,Ri),At(t,0);return}const s=Math.floor(Date.now()/Fi)-ra,a=n=>{const l=Te+n.toString(),c=St(t,l);if(typeof c=="string"){try{const b=JSON.parse(c);if(typeof b=="object"&&typeof b.cached=="number"&&b.cached>s&&typeof b.provider=="string"&&typeof b.data=="object"&&typeof b.data.prefix=="string"&&e(b,n))return!0}catch{}Ui(t,l)}};let r=Et(t);for(let n=r-1;n>=0;n--)a(n)||(n===r-1?(r--,At(t,r)):Vi[o].add(n))}function Gi(){if(!Ot){na(!0);for(const o in re)Hi(o,e=>{const t=e.data,i=e.provider,s=t.prefix,a=Y(i,s);if(!wt(a,t).length)return!1;const r=t.lastModified||-1;return a.lastModifiedCached=a.lastModifiedCached?Math.min(a.lastModifiedCached,r):r,!0})}}function la(o,e){const t=o.lastModifiedCached;if(t&&t>=e)return t===e;if(o.lastModifiedCached=e,t)for(const i in re)Hi(i,s=>{const a=s.data;return s.provider!==o.provider||a.prefix!==o.prefix||a.lastModified===e});return!0}function da(o,e){Ot||Gi();function t(i){let s;if(!re[i]||!(s=Bi(i)))return;const a=Vi[i];let r;if(a.size)a.delete(r=Array.from(a).shift());else if(r=Et(s),!At(s,r+1))return;const n={cached:Math.floor(Date.now()/Fi),provider:o.provider,data:e};return Tt(s,Te+r.toString(),JSON.stringify(n))}e.lastModified&&!la(o,e.lastModified)||Object.keys(e.icons).length&&(e.not_found&&(e=Object.assign({},e),delete e.not_found),t("local")||t("session"))}function Wi(){}function ca(o){o.iconsLoaderFlag||(o.iconsLoaderFlag=!0,setTimeout(()=>{o.iconsLoaderFlag=!1,Yo(o)}))}function ua(o,e){o.iconsToLoad?o.iconsToLoad=o.iconsToLoad.concat(e).sort():o.iconsToLoad=e,o.iconsQueueFlag||(o.iconsQueueFlag=!0,setTimeout(()=>{o.iconsQueueFlag=!1;const{provider:t,prefix:i}=o,s=o.iconsToLoad;delete o.iconsToLoad;let a;if(!s||!(a=$t(t)))return;a.prepare(t,i,s).forEach(n=>{zi(t,n,l=>{if(typeof l!="object")n.icons.forEach(c=>{o.missing.add(c)});else try{const c=wt(o,l);if(!c.length)return;const b=o.pendingIcons;b&&c.forEach(g=>{b.delete(g)}),da(o,l)}catch(c){console.error(c)}ca(o)})})}))}const Ct=(o,e)=>{const t=ta(o,!0,Oi()),i=Qo(t);if(!i.pending.length){let l=!0;return e&&setTimeout(()=>{l&&e(i.loaded,i.missing,i.pending,Wi)}),()=>{l=!1}}const s=Object.create(null),a=[];let r,n;return i.pending.forEach(l=>{const{provider:c,prefix:b}=l;if(b===n&&c===r)return;r=c,n=b,a.push(Y(c,b));const g=s[c]||(s[c]=Object.create(null));g[b]||(g[b]=[])}),i.pending.forEach(l=>{const{provider:c,prefix:b,name:g}=l,v=Y(c,b),y=v.pendingIcons||(v.pendingIcons=new Set);y.has(g)||(y.add(g),s[c][b].push(g))}),a.forEach(l=>{const{provider:c,prefix:b}=l;s[c][b].length&&ua(l,s[c][b])}),e?ea(e,i,a):Wi},ha=o=>new Promise((e,t)=>{const i=typeof o=="string"?$e(o,!0):o;if(!i){t(o);return}Ct([i||o],s=>{if(s.length&&i){const a=ke(i);if(a){e({...we,...a});return}}t(o)})});function pa(o){try{const e=typeof o=="string"?JSON.parse(o):o;if(typeof e.body=="string")return{...e}}catch{}}function fa(o,e){const t=typeof o=="string"?$e(o,!0,!0):null;if(!t){const a=pa(o);return{value:o,data:a}}const i=ke(t);if(i!==void 0||!t.prefix)return{value:o,name:t,data:i};const s=Ct([t],()=>e(o,t,ke(t)));return{value:o,name:t,loading:s}}function Lt(o){return o.hasAttribute("inline")}let Ki=!1;try{Ki=navigator.vendor.indexOf("Apple")===0}catch{}function ba(o,e){switch(e){case"svg":case"bg":case"mask":return e}return e!=="style"&&(Ki||o.indexOf("<a")===-1)?"svg":o.indexOf("currentColor")===-1?"bg":"mask"}const ga=/(-?[0-9.]*[0-9]+[0-9.]*)/g,ma=/^-?[0-9.]*[0-9]+[0-9.]*$/g;function It(o,e,t){if(e===1)return o;if(t=t||100,typeof o=="number")return Math.ceil(o*e*t)/t;if(typeof o!="string")return o;const i=o.split(ga);if(i===null||!i.length)return o;const s=[];let a=i.shift(),r=ma.test(a);for(;;){if(r){const n=parseFloat(a);isNaN(n)?s.push(a):s.push(Math.ceil(n*e*t)/t)}else s.push(a);if(a=i.shift(),a===void 0)return s.join("");r=!r}}function Zi(o,e){const t={...we,...o},i={...xi,...e},s={left:t.left,top:t.top,width:t.width,height:t.height};let a=t.body;[t,i].forEach(y=>{const w=[],L=y.hFlip,N=y.vFlip;let M=y.rotate;L?N?M+=2:(w.push("translate("+(s.width+s.left).toString()+" "+(0-s.top).toString()+")"),w.push("scale(-1 1)"),s.top=s.left=0):N&&(w.push("translate("+(0-s.left).toString()+" "+(s.height+s.top).toString()+")"),w.push("scale(1 -1)"),s.top=s.left=0);let I;switch(M<0&&(M-=Math.floor(M/4)*4),M=M%4,M){case 1:I=s.height/2+s.top,w.unshift("rotate(90 "+I.toString()+" "+I.toString()+")");break;case 2:w.unshift("rotate(180 "+(s.width/2+s.left).toString()+" "+(s.height/2+s.top).toString()+")");break;case 3:I=s.width/2+s.left,w.unshift("rotate(-90 "+I.toString()+" "+I.toString()+")");break}M%2===1&&(s.left!==s.top&&(I=s.left,s.left=s.top,s.top=I),s.width!==s.height&&(I=s.width,s.width=s.height,s.height=I)),w.length&&(a='<g transform="'+w.join(" ")+'">'+a+"</g>")});const r=i.width,n=i.height,l=s.width,c=s.height;let b,g;return r===null?(g=n===null?"1em":n==="auto"?c:n,b=It(g,l/c)):(b=r==="auto"?l:r,g=n===null?It(b,c/l):n==="auto"?c:n),{attributes:{width:b.toString(),height:g.toString(),viewBox:s.left.toString()+" "+s.top.toString()+" "+l.toString()+" "+c.toString()},body:a}}let He=(()=>{let o;try{if(o=fetch,typeof o=="function")return o}catch{}})();function va(o){He=o}function ya(){return He}function wa(o,e){const t=Ve(o);if(!t)return 0;let i;if(!t.maxURL)i=0;else{let s=0;t.resources.forEach(r=>{s=Math.max(s,r.length)});const a=e+".json?icons=";i=t.maxURL-s-t.path.length-a.length}return i}function _a(o){return o===404}const $a=(o,e,t)=>{const i=[],s=wa(o,e),a="icons";let r={type:a,provider:o,prefix:e,icons:[]},n=0;return t.forEach((l,c)=>{n+=l.length+1,n>=s&&c>0&&(i.push(r),r={type:a,provider:o,prefix:e,icons:[]},n=l.length),r.icons.push(l)}),i.push(r),i};function xa(o){if(typeof o=="string"){const e=Ve(o);if(e)return e.path}return"/"}const ka={prepare:$a,send:(o,e,t)=>{if(!He){t("abort",424);return}let i=xa(e.provider);switch(e.type){case"icons":{const a=e.prefix,n=e.icons.join(","),l=new URLSearchParams({icons:n});i+=a+".json?"+l.toString();break}case"custom":{const a=e.uri;i+=a.slice(0,1)==="/"?a.slice(1):a;break}default:t("abort",400);return}let s=503;He(o+i).then(a=>{const r=a.status;if(r!==200){setTimeout(()=>{t(_a(r)?"abort":"next",r)});return}return s=501,a.json()}).then(a=>{if(typeof a!="object"||a===null){setTimeout(()=>{a===404?t("abort",a):t("next",s)});return}setTimeout(()=>{t("success",a)})}).catch(()=>{t("next",s)})}};function Ji(o,e){switch(o){case"local":case"session":re[o]=e;break;case"all":for(const t in re)re[t]=e;break}}function Qi(){Pi("",ka),Oi(!0);let o;try{o=window}catch{}if(o){if(Gi(),o.IconifyPreload!==void 0){const t=o.IconifyPreload,i="Invalid IconifyPreload syntax.";typeof t=="object"&&t!==null&&(t instanceof Array?t:[t]).forEach(s=>{try{(typeof s!="object"||s===null||s instanceof Array||typeof s.icons!="object"||typeof s.prefix!="string"||!Li(s))&&console.error(i)}catch{console.error(i)}})}if(o.IconifyProviders!==void 0){const t=o.IconifyProviders;if(typeof t=="object"&&t!==null)for(const i in t){const s="IconifyProviders["+i+"] is invalid.";try{const a=t[i];if(typeof a!="object"||!a||a.resources===void 0)continue;ji(i,a)||console.error(s)}catch{console.error(s)}}}}return{enableCache:t=>Ji(t,!0),disableCache:t=>Ji(t,!1),iconExists:Zo,getIcon:Jo,listIcons:Ko,addIcon:Ci,addCollection:Li,calculateSize:It,buildIcon:Zi,loadIcons:Ct,loadIcon:ha,addAPIProvider:ji,_api:{getAPIConfig:Ve,setAPIModule:Pi,sendAPIQuery:zi,setFetch:va,getFetch:ya,listAPIProviders:oa}}}function Yi(o,e){let t=o.indexOf("xlink:")===-1?"":' xmlns:xlink="http://www.w3.org/1999/xlink"';for(const i in e)t+=" "+i+'="'+e[i]+'"';return'<svg xmlns="http://www.w3.org/2000/svg"'+t+">"+o+"</svg>"}function Sa(o){return o.replace(/"/g,"'").replace(/%/g,"%25").replace(/#/g,"%23").replace(/</g,"%3C").replace(/>/g,"%3E").replace(/\s+/g," ")}function Ta(o){return'url("data:image/svg+xml,'+Sa(o)+'")'}const Pt={"background-color":"currentColor"},Xi={"background-color":"transparent"},es={image:"var(--svg)",repeat:"no-repeat",size:"100% 100%"},ts={"-webkit-mask":Pt,mask:Pt,background:Xi};for(const o in ts){const e=ts[o];for(const t in es)e[o+"-"+t]=es[t]}function is(o){return o+(o.match(/^[-0-9.]+$/)?"px":"")}function Aa(o,e,t){const i=document.createElement("span");let s=o.body;s.indexOf("<a")!==-1&&(s+="<!-- "+Date.now()+" -->");const a=o.attributes,r=Yi(s,{...a,width:e.width+"",height:e.height+""}),n=Ta(r),l=i.style,c={"--svg":n,width:is(a.width),height:is(a.height),...t?Pt:Xi};for(const b in c)l.setProperty(b,c[b]);return i}function Ea(o){const e=document.createElement("span");return e.innerHTML=Yi(o.body,o.attributes),e.firstChild}function ss(o,e){const t=e.icon.data,i=e.customisations,s=Zi(t,i);i.preserveAspectRatio&&(s.attributes.preserveAspectRatio=i.preserveAspectRatio);const a=e.renderedMode;let r;switch(a){case"svg":r=Ea(s);break;default:r=Aa(s,{...we,...t},a==="mask")}const n=Array.from(o.childNodes).find(l=>{const c=l.tagName&&l.tagName.toUpperCase();return c==="SPAN"||c==="SVG"});n?r.tagName==="SPAN"&&n.tagName===r.tagName?n.setAttribute("style",r.getAttribute("style")):o.replaceChild(r,n):o.appendChild(r)}const Mt="data-style";function os(o,e){let t=Array.from(o.childNodes).find(i=>i.hasAttribute&&i.hasAttribute(Mt));t||(t=document.createElement("style"),t.setAttribute(Mt,Mt),o.appendChild(t)),t.textContent=":host{display:inline-block;vertical-align:"+(e?"-0.125em":"0")+"}span,svg{display:block}"}function as(o,e,t){const i=t&&(t.rendered?t:t.lastRender);return{rendered:!1,inline:e,icon:o,lastRender:i}}function Oa(o="iconify-icon"){let e,t;try{e=window.customElements,t=window.HTMLElement}catch{return}if(!e||!t)return;const i=e.get(o);if(i)return i;const s=["icon","mode","inline","width","height","rotate","flip"],a=class extends t{constructor(){super();Xe(this,"_shadowRoot");Xe(this,"_state");Xe(this,"_checkQueued",!1);const l=this._shadowRoot=this.attachShadow({mode:"open"}),c=Lt(this);os(l,c),this._state=as({value:""},c),this._queueCheck()}static get observedAttributes(){return s.slice(0)}attributeChangedCallback(l){if(l==="inline"){const c=Lt(this),b=this._state;c!==b.inline&&(b.inline=c,os(this._shadowRoot,c))}else this._queueCheck()}get icon(){const l=this.getAttribute("icon");if(l&&l.slice(0,1)==="{")try{return JSON.parse(l)}catch{}return l}set icon(l){typeof l=="object"&&(l=JSON.stringify(l)),this.setAttribute("icon",l)}get inline(){return Lt(this)}set inline(l){this.setAttribute("inline",l?"true":null)}restartAnimation(){const l=this._state;if(l.rendered){const c=this._shadowRoot;if(l.renderedMode==="svg")try{c.lastChild.setCurrentTime(0);return}catch{}ss(c,l)}}get status(){const l=this._state;return l.rendered?"rendered":l.icon.data===null?"failed":"loading"}_queueCheck(){this._checkQueued||(this._checkQueued=!0,setTimeout(()=>{this._check()}))}_check(){if(!this._checkQueued)return;this._checkQueued=!1;const l=this._state,c=this.getAttribute("icon");if(c!==l.icon.value){this._iconChanged(c);return}if(!l.rendered)return;const b=this.getAttribute("mode"),g=Si(this);(l.attrMode!==b||Fo(l.customisations,g))&&this._renderIcon(l.icon,g,b)}_iconChanged(l){const c=fa(l,(b,g,v)=>{const y=this._state;if(y.rendered||this.getAttribute("icon")!==b)return;const w={value:b,name:g,data:v};w.data?this._gotIconData(w):y.icon=w});c.data?this._gotIconData(c):this._state=as(c,this._state.inline,this._state)}_gotIconData(l){this._checkQueued=!1,this._renderIcon(l,Si(this),this.getAttribute("mode"))}_renderIcon(l,c,b){const g=ba(l.data.body,b),v=this._state.inline;ss(this._shadowRoot,this._state={rendered:!0,icon:l,inline:v,customisations:c,attrMode:b,renderedMode:g})}};s.forEach(n=>{n in a.prototype||Object.defineProperty(a.prototype,n,{get:function(){return this.getAttribute(n)},set:function(l){this.setAttribute(n,l)}})});const r=Qi();for(const n in r)a[n]=a.prototype[n]=r[n];return e.define(o,a),a}const Ca=Oa()||Qi(),{enableCache:Rn,disableCache:Nn,iconExists:qn,getIcon:Fn,listIcons:Un,addIcon:Vn,addCollection:Bn,calculateSize:Hn,buildIcon:Gn,loadIcons:Wn,loadIcon:Kn,addAPIProvider:Zn,_api:Jn}=Ca;class rs extends R{static get styles(){return $`
    ...
    `}}window.customElements.define("dt-icon",rs);class La extends oe{static get styles(){return $`
      :host {
        margin-top: -0.25rem;
        width: 2rem;
      }
 ...
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const B=o=>o??E;class D extends R{static get formAssociated(){return!0}static get styles(){return[$`
        .input-group {
          position: relative;
        }
 ...
 */const ls=(o,e,t)=>{const i=new Map;for(let s=e;s<=t;s++)i.set(o[s],s);return i},Ee=ut(class extends ht{constructor(o){if(super(o),o.type!==ct.CHILD)throw Error("repeat() can only be used in text expressions")}dt(o,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const s=[],a=[];let r=0;for(const n of o)s[r]=i?i(n,r):r,a[r]=t(n,r),r++;return{values:a,keys:s}}render(o,e,t){return this.dt(o,e,t).values}update(o,[e,t,i]){const s=ja(o),{values:a,keys:r}=this.dt(e,t,i);if(!Array.isArray(s))return this.ut=r,a;const n=this.ut??(this.ut=[]),l=[];let c,b,g=0,v=s.length-1,y=0,w=a.length-1;for(;g<=v&&y<=w;)if(s[g]===null)g++;else if(s[v]===null)v--;else if(n[g]===r[y])l[y]=ne(s[g],a[y]),g++,y++;else if(n[v]===r[w])l[w]=ne(s[v],a[w]),v--,w--;else if(n[g]===r[w])l[w]=ne(s[g],a[w]),Ae(o,l[w+1],s[g]),g++,w--;else if(n[v]===r[y])l[y]=ne(s[v],a[y]),Ae(o,s[g],s[v]),v--,y++;else if(c===void 0&&(c=ls(r,y,w),b=ls(n,g,v)),c.has(n[g]))if(c.has(n[v])){const L=b.get(r[y]),N=L!==void 0?s[L]:null;if(N===null){const M=Ae(o,s[g]);ne(M,a[y]),l[y]=M}else l[y]=ne(N,a[y]),Ae(o,s[g],N),s[L]=null;y++}else jt(s[v]),v--;else jt(s[g]),g++;for(;y<=w;){const L=Ae(o,l[w+1]);ne(L,a[y]),l[y++]=L}for(;g<=v;){const L=s[g++];L!==null&&jt(L)}return this.ut=r,Ma(o,l),U}}),Da=o=>class extends o{constructor(){super(),this.activeIndex=-1,this.filteredOptions=[],this.detectTap=!1}static get properties(){return{...super.properties,value:{type:Array,reflect:!0},query:{type:String,state:!0},options:{type:Array},filteredOptions:{type:Array,state:!0},open:{type:Boolean,state:!0},canUpdate:{type:Boolean,state:!0},activeIndex:{type:Number,state:!0},containerHeight:{type:Number,state:!0},loading:{type:Boolean}}}willUpdate(e){if(super.willUpdate(e),e&&!this.containerHeight&&this.shadowRoot.children&&this.shadowRoot.children.length){const t=this.shadowRoot.querySelector(".input-group");t&&(this.containerHeight=t.offsetHeight)}}updated(){this._scrollOptionListToActive();const e=this.shadowRoot.querySelector(".input-group");!e.style.getPropertyValue("--container-width")&&e.clientWidth>0&&e.style.setProperty("--container-width",`${e.clientWidth}px`)}_select(){console.error("Must implement `_select(value)` function"),this._clearSearch()}static _focusInput(e){e.target===e.currentTarget&&e.target.getElementsByTagName("input")[0].focus()}_inputFocusIn(e){(!e.relatedTarget||!["BUTTON","LI"].includes(e.relatedTarget.nodeName))&&(this.open=!0,this.activeIndex=-1)}_inputFocusOut(e){(!e.relatedTarget||!["BUTTON","LI"].includes(e.relatedTarget.nodeName))&&(this.open=!1,this.canUpdate=!0)}_inputKeyDown(e){}_inputKeyUp(e){switch(e.keyCode||e.which){case 38:this.open=!0,this._listHighlightPrevious();break;case 40:this.open=!0,this._listHighlightNext();break;case 9:this.activeIndex<0?this.open=!1:e.preventDefault(),this._keyboardSelectOption();break;case 13:this._keyboardSelectOption();break;case 27:this.open=!1,this.activeIndex=-1;break;default:this.open=!0,this.query=e.target.value;break}}_scrollOptionListToActive(){const e=this.shadowRoot.querySelector(".option-list"),t=this.shadowRoot.querySelector("button.active");if(e&&t){const i=t.offsetTop,s=t.offsetTop+t.clientHeight,a=e.scrollTop,r=e.scrollTop+e.clientHeight;s>r?e.scrollTo({top:s-e.clientHeight,behavior:"smooth"}):i<a&&e.scrollTo({top:i,behavior:"smooth"})}}_touchStart(e){e.target&&(this.detectTap=!1)}_touchMove(e){e.target&&(this.detectTap=!0)}_touchEnd(e){this.detectTap||(e.target&&e.target.value&&this._clickOption(e),this.detectTap=!1)}_keyboardSelectOption(){this.activeIndex>-1&&(this.activeIndex+1>this.filteredOptions.length?this._select(this.query):this._select(this.filteredOptions[this.activeIndex].id))}_clickOption(e){e.target&&e.target.value&&this._select(e.target.value)}_clickAddNew(e){var t;e.target&&this._select((t=e.target.dataset)==null?void 0:t.label)}_clearSearch(){const e=this.shadowRoot.querySelector("input");e&&(e.value="")}_listHighlightNext(){this.allowAdd?this.activeIndex=Math.min(this.filteredOptions.length,this.activeIndex+1):this.activeIndex=Math.min(this.filteredOptions.length-1,this.activeIndex+1)}_listHighlightPrevious(){this.activeIndex=Math.max(0,this.activeIndex-1)}_renderOption(e,t){return f`
    ...
    `}_baseRenderOptions(){return this.filteredOptions.length?Ee(this.filteredOptions,e=>e.id,(e,t)=>this._renderOption(e,t)):this.loading?f`<li><div>${O("Loading options...")}</div></li>`:f`<li><div>${O("No Data Available")}</div></li>`}_renderOptions(){let e=this._baseRenderOptions();return this.allowAdd&&this.query&&(Array.isArray(e)||(e=[e]),e.push(f`<li tabindex="-1">
      ...
      </li>`)),e}};class Ge extends Da(D){static get styles(){return[...super.styles,$`
        :host {
          position: relative;
    ...
    `}}window.customElements.define("dt-multi-select",Ge);class za extends R{static get styles(){return $`
      root {
        display: block;
      }
      .health-item img {
    ...
    >
      <img
        ...
        alt="${this.metric}"
      />
    </div>`}async _handleClick(e){if(this.disabled)return;const t=!this.active;this.active=t;const i=new CustomEvent("change",{detail:{key:this.key,active:t}});this.dispatchEvent(i)}}window.customElements.define("dt-church-health-icon",za);class ds extends D{static get styles(){return[...super.styles,$`
        .root {
          display: block;
        }
    ...
    `}}window.customElements.define("dt-toggle",ds);class cs extends Ge{static get styles(){return[...super.styles,$`
    ...
    `}handleIconClick(e){const{key:t,active:i}=e.detail;i?this._select(t):this._remove(e)}async handleToggleChange(e){const{field:t,newValue:i}=e.detail;i?this._select(t):this._remove(e)}}window.customElements.define("dt-church-health-circle",cs);class Oe extends Ge{static get properties(){return{...super.properties,allowAdd:{type:Boolean}}}static get styles(){return[...super.styles,$`
        .selected-option a,
    ...
    `}}window.customElements.define("dt-tags",Oe);class us extends Oe{static get styles(){return[...super.styles,$`
        .selected-option a {
    ...
    `}}window.customElements.define("dt-connection",us);class hs extends Oe{static get styles(){return[...super.styles,$`
        .selected-option a {
          border-inline-start: solid 3px transparent;
        }
    ...
    `}}window.customElements.define("dt-users-connection",hs);class ps extends R{static get styles(){return $`
      :root {
        font-size: inherit;
    ...
    `}}window.customElements.define("dt-copy-text",ps);class Dt extends D{static get styles(){return[...super.styles,$`
        input {
          color: var(--dt-form-text-color, #000);
          appearance: none;
    ...
    `}reset(){this.updateTimestamp(""),super.reset()}}window.customElements.define("dt-date",Dt);class fs extends Dt{static get styles(){return[...super.styles,$`
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*We(o,e){if(o!==void 0){let t=0;for(const i of o)yield e(i,t++)}}class bs extends Oe{static get properties(){return{...super.properties,filters:{type:Array}}}static get styles(){return[...super.styles,$`
        .input-group {
          display: flex;
        }
    ...
    `}_renderSelectedOptions(){return(this.value||[]).filter(e=>!e.delete).map(e=>f`
      ...
      <div class="input-group ${this.disabled?"disabled":""}">
        ...
        >
          ${We(this.filters,t=>f`<option value="${t.id}">${t.label}</option>`)}
        </select>
        <ul class="option-list" style=${Q(e)}>
          ${this._renderOptions()}
        </ul>
    ...
    `;return f`
      ...
      `}
    `}}window.customElements.define("dt-modal",gs);class ms extends R{static get properties(){return{...super.properties,title:{type:String},isOpen:{type:Boolean},canEdit:{type:Boolean,state:!0},metadata:{type:Object},center:{type:Array},mapboxToken:{type:String,attribute:"mapbox-token"}}}static get styles(){return[$`
        .map {
          width: 100%;
          min-width: 50vw;
          min-height: 50dvb;
    ...
    `}}window.customElements.define("dt-map-modal",ms);class qa extends R{static get properties(){return{id:{type:String,reflect:!0},placeholder:{type:String},mapboxToken:{type:String,attribute:"mapbox-token"},googleToken:{type:String,attribute:"google-token"},metadata:{type:Object},disabled:{type:Boolean},open:{type:Boolean,state:!0},query:{type:String,state:!0},activeIndex:{type:Number,state:!0},containerHeight:{type:Number,state:!0},loading:{type:Boolean},saved:{type:Boolean},invalid:{type:Boolean},filteredOptions:{type:Array,state:!0}}}static get styles(){return[$`
        :host {
    ...
    `}renderIconSaved(e){return this.saved&&(this.savedTimeout&&clearTimeout(this.savedTimeout),this.savedTimeout=setTimeout(()=>{this.savedTimeout=null,this.saved=!1},5e3)),this.saved?f`<dt-checkmark
            ...
            ></dt-checkmark>`:null}}window.customElements.define("dt-location-map-item",qa);class vs extends D{static get properties(){return{...super.properties,placeholder:{type:String},value:{type:Array,reflect:!0},locations:{type:Array,state:!0},open:{type:Boolean,state:!0},limit:{type:Number,attribute:"limit"},onchange:{type:String},mapboxToken:{type:String,attribute:"mapbox-token"},googleToken:{type:String,attribute:"google-token"},activeItem:{type:String,state:!0}}}static get styles(){return[...super.styles,$`
        :host {
          font-family: Helvetica, Arial, sans-serif;
        }
        .input-group {
    ...
    `:""}renderItem(e,t){const i=Math.round(e.lat*1e7)/1e7,s=Math.round(e.lng*10**7)/10**7,a=`${i}/${s}`,r=this.activeItem&&(this.activeItem===e.label||this.activeItem===a)||t===0&&!this.activeItem;return f`
    ...
    `}}window.customElements.define("dt-location-map",vs);class ys extends D{static get styles(){return[...super.styles,$`
        input {
          color: var(--dt-form-text-color, #000);
          appearance: none;
          background-color: var(--dt-form-background-color, #fff);
    ...
    `}}window.customElements.define("dt-number",ys);class ws extends D{static get styles(){return[...super.styles,$`
        :host {
          position: relative;
        }
    ...
    `}}window.customElements.define("dt-single-select",ws);class zt extends D{static get styles(){return[...super.styles,$`
        input {
          color: var(--dt-form-text-color, #000);
          appearance: none;
    ...
    `}}window.customElements.define("dt-text",zt);class _s extends D{static get styles(){return[...super.styles,$`
        textarea {
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Fa(o,e,t){return o?e(o):t==null?void 0:t(o)}class $s extends zt{static get styles(){return[...super.styles,$`
        :host {
          display: block;
        }
        input {
    ...
    `}renderIcons(){let e=0,t=!1;for(const[a,r]of(this.value||[]).entries())!r.value&&a!==0?e+=1:r.delete&&!t&&(t=!0);let i=.5;t===!1&&(i+=3*e);const s=`padding-block-end: ${i.toString()}rem`;return f`
      ${this.renderIconInvalid()} ${this.renderError()}
    ...
    `}}window.customElements.define("dt-multi-text",$s);class xs extends D{static get styles(){return[...super.styles,$`
        :host {
          margin-bottom: 5px;
    ...
    `}}window.customElements.define("dt-multi-select-button-group",xs);class ks extends R{static get styles(){return $`
      :host {
        display: block;
      }
    ...
    `}}window.customElements.define("dt-alert",ks);class Ss extends R{static get styles(){return $`
      :host {
        --number-of-columns: 7;
    ...
    `}static get properties(){return{postType:{type:String},postTypeLabel:{type:String},posttypesettings:{type:Object,attribute:!0},posts:{type:Array},total:{type:Number},columns:{type:Array},sortedBy:{type:String},loading:{type:Boolean,default:!0},offset:{type:Number},showArchived:{type:Boolean,default:!1},showFieldsSelector:{type:Boolean,default:!1},showBulkEditSelector:{type:Boolean,default:!1},nonce:{type:String},payload:{type:Object},favorite:{type:Boolean},initialLoadPost:{type:Boolean,default:!1},loadMore:{type:Boolean,default:!1},headerClick:{type:Boolean,default:!1}}}constructor(){super(),this.sortedBy="name",this.payload={sort:this.sortedBy,overall_status:["-closed"],fields_to_return:this.sortedColumns},this.initalLoadPost=!1,this.initalLoadPost||(this.posts=[],this.limit=100)}firstUpdated(){this.postTypeSettings=window.post_type_fields,this.sortedColumns=this.columns.includes("favorite")?["favorite",...this.columns.filter(e=>e!=="favorite")]:this.columns,this.style.setProperty("--number-of-columns",this.columns.length-1)}async _getPosts(e){const t=await new CustomEvent("dt:get-data",{bubbles:!0,detail:{field:this.name,postType:this.postType,query:e,onSuccess:i=>{this.initalLoadPost&&this.loadMore&&(this.posts=[...this.posts,...i],this.postsLength=this.posts.length,this.total=i.length,this.loadMore=!1),this.initalLoadPost||(this.posts=[...i],this.offset=this.posts.length,this.initalLoadPost=!0,this.total=i.length),this.headerClick&&(this.posts=i,this.offset=this.posts.length,this.headerClick=!1),this.total=i.length},onError:i=>{console.warn(i)}}});this.dispatchEvent(t)}_headerClick(e){const t=e.target.dataset.id;this.sortedBy===t?t.startsWith("-")?this.sortedBy=t.replace("-",""):this.sortedBy=`-${t}`:this.sortedBy=t,this.payload={sort:this.sortedBy,overall_status:["-closed"],limit:this.limit,fields_to_return:this.columns},this.headerClick=!0,this._getPosts(this.payload)}static _rowClick(e){window.open(e,"_self")}_bulkEdit(){this.showBulkEditSelector=!this.showBulkEditSelector}_fieldsEdit(){this.showFieldsSelector=!this.showFieldsSelector}_toggleShowArchived(){if(this.showArchived=!this.showArchived,this.headerClick=!0,this.showArchived){const{overall_status:e,offset:t,...i}=this.payload;this.payload=i}else this.payload.overall_status=["-closed"];this._getPosts(this.payload)}_sortArrowsClass(e){return this.sortedBy===e?"sortedBy":""}_sortArrowsToggle(e){return this.sortedBy!==`-${e}`?`-${e}`:e}_headerTemplate(){return this.postTypeSettings?f`
        <thead>
          <tr>
            ...
            ${We(this.sortedColumns,e=>{const t=e==="favorite";return f`<th
                class="all"
      ...
      `:null}_rowTemplate(){if(this.posts&&Array.isArray(this.posts)){const e=this.posts.map((t,i)=>this.showArchived||!this.showArchived&&t.overall_status!=="closed"?f`
            ...
            `:null).filter(t=>t!==null);return e.length>0?e:f`<p>No contacts available</p>`}return null}formatDate(e){const t=new Date(e);return new Intl.DateTimeFormat("en-US",{month:"long",day:"numeric",year:"numeric"}).format(t)}_cellTemplate(e){return We(this.sortedColumns,t=>{if(["text","textarea","number"].includes(this.postTypeSettings[t].type))return f` <td
          dir="auto"
    ...
    `}}window.customElements.define("dt-list",Ss);class Ts extends R{static get styles(){return $`
      :host {
