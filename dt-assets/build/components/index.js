 ...
 */function U(s,e,t){return s?e(s):t==null?void 0:t(s)}class Dt extends Ft{static get styles(){return[...super.styles,$`
    ...
    `}}window.customElements.define("dt-multi-text",Dt);class ko extends Dt{static get styles(){return[...super.styles,$`
      ...
      `]}static get properties(){return{...super.properties,groups:{type:Array},open:{type:Boolean,state:!0},activeIndex:{type:Number,state:!0},activeGroup:{type:String,state:!0},isDeleting:{type:Boolean,state:!0}}}constructor(){super(),this.open=!1,this.activeIndex=-1}_addItem(e){var i;const t={verified:!1,value:"",tempKey:Date.now().toString(),group:e.id};(i=this.value[0])!=null&&i.group?this.value=[...this.value,t]:this.value=[t],this.open=!1,this.activeIndex=-1,this.updateComplete.then(()=>{const o=this.renderRoot.querySelectorAll("input"),a=Array.from(o).find(n=>n.getAttribute("data-key")===t.tempKey);a==null||a.focus()})}_removeItem(e){const t=e.currentTarget.dataset.key;if(console.log(e.currentTarget),t){const i=new CustomEvent("change",{bubbles:!0,detail:{field:this.name,oldValue:this.value}}),o=this.value.filter(a=>a.tempKey!==t).map(a=>{const n={...a};return(a.key===t||a.tempKey===t)&&(n.delete=!0,this.activeGroup=n.group),n});this.value=o,i.detail.newValue=this.value,this.dispatchEvent(i),this._setFormValue(this.value)}}_change(e){var i,o;const t=(o=(i=e==null?void 0:e.currentTarget)==null?void 0:i.dataset)==null?void 0:o.key;if(t){const a=new CustomEvent("change",{detail:{field:this.name,oldValue:this.value}});this.value=this.value.map(n=>{var r;return n.key===t||n.tempKey===t?(this.activeGroup=n.group,{...n,value:(r=e.target)==null?void 0:r.value}):n}),a.detail.newValue=this.value,this._setFormValue(this.value),this.dispatchEvent(a)}}handleClick(){if(this.renderRoot.querySelector(".icon-btn").focus(),this.groups){this.open=!this.open,this.activeIndex=-1;const e=this.renderRoot.querySelector(".option-list");e==null||e.focus()}else{const e={verified:!1,value:"",tempKey:Date.now().toString()};this.value=[...this.value,e]}}_handleButtonBlur(e){var t;(t=e.relatedTarget)!=null&&t.id.includes("group-")||(this.open=!1)}_inputKeyDown(e){const t=e.keyCode||e.which;if(this.groups)switch(t){case 38:e.preventDefault(),this.open=!0,this._listHighlightPrevious();break;case 40:e.preventDefault(),this.open=!0,this._listHighlightNext();break;case 9:this.activeIndex<0?this.open=!1:e.preventDefault(),this._keyboardSelectOption();break;case 13:e.preventDefault(),this.open?this._keyboardSelectOption():this.open=!0;break;case 27:this.open=!1,this.activeIndex=-1;break;default:this.open=!0,this.query=e.target.value;break}}_keyboardSelectOption(){this.activeIndex>-1&&(this.activeIndex+1>this.groups.length?this._addItem(this.query):this._addItem(this.groups[this.activeIndex]))}_listHighlightNext(){this.allowAdd?this.activeIndex=Math.min(this.groups.length,this.activeIndex+1):this.activeIndex=Math.min(this.groups.length-1,this.activeIndex+1)}_listHighlightPrevious(){this.activeIndex=Math.max(0,this.activeIndex-1)}_inputFieldTemplate(e,t){var i;return c`
      <div class="field-container">
        <input
          data-key="${e.key??e.tempKey}"
          tabindex="1"
        ...
        ${U(((i=this.value[0])==null?void 0:i.group)||!this.groups&&t>1,()=>c`
            <button
              class="input-addon btn-remove"
              tabindex="1"
              @click=${this._removeItem}
    ...
    `}renderIcons(){const e=this.groups.findIndex(l=>l.id===this.activeGroup);this.loading&&(this.isDeleting=!1);for(const[l,d]of(this.value||[]).entries())d.delete&&!this.isDeleting&&(this.isDeleting=!0,this.activeGroup=d.group);const t=this.groups.map(l=>(this.value||[]).filter(d=>d.group===l.id&&!d.delete).length);let i=0,o=0;for(let l=t.length-1;l>e;l-=1)if(t[l]>0){o+=t[l];break}for(let l=0;l<e;l+=1)if(t[l]>0){i+=t[l];break}let a=0,n=0;for(let l=this.groups.length-1;l>=0;l-=1){const d=this.groups[l];let h=0;l>e?(h=(this.value||[]).filter(p=>p.group===d.id&&!p.delete).length,h>0&&(n+=1)):l===e&&(h=(this.value||[]).filter(p=>p.group===d.id&&!p.delete).length-1,this.isDeleting&&h===0?i>0?h=i-1:o>0&&(n-=1):h=(this.value||[]).filter(p=>p.group===d.id&&!p.delete).length-1),a+=h}a!==0&&(a*=3,a+=n*2.5),a+=.5;const r=`padding-block-end: ${a.toString()}rem`;return c`
      ${this.renderIconInvalid()} ${this.renderError()}
      ${this.renderIconLoading(r)} ${this.renderIconSaved(r)}
      `}_renderInputFields(){(!this.value||!this.value.length)&&(this.value=[{verified:!1,value:"",tempKey:Date.now().toString()}]);const e=this.value[0];return this.groups&&e&&e.group?this.groups.map(t=>{const i=(this.value??[]).filter(o=>!o.delete&&o.group===t.id);return i.length>0?c`
        ...
        ${this.readonly?c`
            ...
            ${this.value?q(this.groups,e=>c`<h3 class="heading">${e.label}</h3>
              ...
              <div class="readonly-options">
                ${q((this.value||[]).filter(t=>t.group===e.id),t=>c`<div class="group-item">${t.value}</div>`)}
              </div>`):c`
            <div class="groups-no-value">
              No items to show.
            </div>
