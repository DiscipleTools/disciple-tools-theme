 ...
 */const V=[];for(let s=0;s<256;s++)V[s]=(s>>4&15).toString(16)+(s&15).toString(16);function ws(s){let e=0,t=8997,i=0,o=33826,a=0,r=40164,n=0,l=52210;for(let d=0;d<s.length;d++)t^=s.charCodeAt(d),e=t*435,i=o*435,a=r*435,n=l*435,a+=t<<8,n+=o<<8,i+=e>>>16,t=e&65535,a+=i>>>16,o=i&65535,l=n+(a>>>16)&65535,r=a&65535;return V[l>>8]+V[l&255]+V[r>>8]+V[r&255]+V[o>>8]+V[o&255]+V[t>>8]+V[t&255]}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function B(s,e,t){return s?e(s):t==null?void 0:t(s)}class xo extends zt{static get styles(){return[...super.styles,$`
        :host {
          display: block;
        }
        input {
              ...
              ${pe(t,a=>a.key||a,a=>{const r=typeof a.key=="string"?a.key:typeof a=="string"?a:String(a.key??a.name??""),n=a.name||(typeof r=="string"?r.split("/").pop():""),l=a.size,d=this._getFilePreviewUrl(a),u=this._isImage(a),h=this._editingFileKey===r;return p`
                    <div class="file-item ${o?"file-item-grid":"file-item-list"}">
                      ...
                      ${B(h,()=>p`
                        ...
                        `)}
                      ${B(l!=null,()=>p`<div class="file-size">${this._formatFileSize(l)}</div>`)}
                      <div class="file-actions">
                        ${B(this.downloadEnabled&&a.url,()=>p`
                          ...
                          `)}
                        ${B(this.deleteEnabled&&!this.disabled,()=>p`
