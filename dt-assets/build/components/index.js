var DtWebComponents=function(x){"use strict";var Pn=Object.defineProperty;var In=(x,q,W)=>q in x?Pn(x,q,{enumerable:!0,configurable:!0,writable:!0,value:W}):x[q]=W;var Xe=(x,q,W)=>In(x,typeof q!="symbol"?q+"":q,W);/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const E=ut(class extends ht{constructor(o){var e;if(super(o),o.type!==ct.ATTRIBUTE||o.name!=="class"||((e=o.strings)==null?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(o){return" "+Object.keys(o).filter(e=>o[e]).join(" ")+" "}update(o,[e]){var i,s;if(this.st===void 0){this.st=new Set,o.strings!==void 0&&(this.nt=new Set(o.strings.join(" ").split(/\s/).filter(a=>a!=="")));for(const a in e)e[a]&&!((i=this.nt)!=null&&i.has(a))&&this.st.add(a);return this.render(e)}const t=o.element.classList;for(const a of this.st)a in e||(t.remove(a),this.st.delete(a));for(const a in e){const r=!!e[a];r===this.st.has(a)||(s=this.nt)!=null&&s.has(a)||(r?(t.add(a),this.st.add(a)):(t.remove(a),this.st.delete(a)))}return U}});/**
 * @license
 ...
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const B=o=>o??O;class D extends R{static get formAssociated(){return!0}static get styles(){return[$`
        .input-group {
          position: relative;
        }
    ...
    `}renderIconInvalid(){return this.touched&&this.invalid?f`<div class="${E(this._errorClasses())}">
          <dt-icon
        ...
        </div> `:null}renderIconLoading(){return this.loading?f`<dt-spinner class="icon-overlay"></dt-spinner>`:null}renderIconSaved(){return this.saved?f`<dt-checkmark
          class="icon-overlay success fade-out"
        ></dt-checkmark>`:null}renderError(){return this.error?f`<div class="${E(this._errorClasses())}">
 ...
 */const ls=(o,e,t)=>{const i=new Map;for(let s=e;s<=t;s++)i.set(o[s],s);return i},Oe=ut(class extends ht{constructor(o){if(super(o),o.type!==ct.CHILD)throw Error("repeat() can only be used in text expressions")}dt(o,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const s=[],a=[];let r=0;for(const n of o)s[r]=i?i(n,r):r,a[r]=t(n,r),r++;return{values:a,keys:s}}render(o,e,t){return this.dt(o,e,t).values}update(o,[e,t,i]){const s=ja(o),{values:a,keys:r}=this.dt(e,t,i);if(!Array.isArray(s))return this.ut=r,a;const n=this.ut??(this.ut=[]),l=[];let c,b,g=0,v=s.length-1,y=0,w=a.length-1;for(;g<=v&&y<=w;)if(s[g]===null)g++;else if(s[v]===null)v--;else if(n[g]===r[y])l[y]=ne(s[g],a[y]),g++,y++;else if(n[v]===r[w])l[w]=ne(s[v],a[w]),v--,w--;else if(n[g]===r[w])l[w]=ne(s[g],a[w]),Ee(o,l[w+1],s[g]),g++,w--;else if(n[v]===r[y])l[y]=ne(s[v],a[y]),Ee(o,s[g],s[v]),v--,y++;else if(c===void 0&&(c=ls(r,y,w),b=ls(n,g,v)),c.has(n[g]))if(c.has(n[v])){const L=b.get(r[y]),N=L!==void 0?s[L]:null;if(N===null){const M=Ee(o,s[g]);ne(M,a[y]),l[y]=M}else l[y]=ne(N,a[y]),Ee(o,s[g],N),s[L]=null;y++}else jt(s[v]),v--;else jt(s[g]),g++;for(;y<=w;){const L=Ee(o,l[w+1]);ne(L,a[y]),l[y++]=L}for(;g<=v;){const L=s[g++];L!==null&&jt(L)}return this.ut=r,Ma(o,l),U}}),Da=o=>class extends o{constructor(){super(),this.activeIndex=-1,this.filteredOptions=[],this.detectTap=!1}static get properties(){return{...super.properties,value:{type:Array,reflect:!0},query:{type:String,state:!0},options:{type:Array},filteredOptions:{type:Array,state:!0},open:{type:Boolean,state:!0},canUpdate:{type:Boolean,state:!0},activeIndex:{type:Number,state:!0},containerHeight:{type:Number,state:!0},loading:{type:Boolean}}}willUpdate(e){if(super.willUpdate(e),e&&!this.containerHeight&&this.shadowRoot.children&&this.shadowRoot.children.length){const t=this.shadowRoot.querySelector(".input-group");t&&(this.containerHeight=t.offsetHeight)}}updated(){this._scrollOptionListToActive();const e=this.shadowRoot.querySelector(".input-group");!e.style.getPropertyValue("--container-width")&&e.clientWidth>0&&e.style.setProperty("--container-width",`${e.clientWidth}px`)}_select(){console.error("Must implement `_select(value)` function"),this._clearSearch()}static _focusInput(e){e.target===e.currentTarget&&e.target.getElementsByTagName("input")[0].focus()}_inputFocusIn(e){(!e.relatedTarget||!["BUTTON","LI"].includes(e.relatedTarget.nodeName))&&(this.open=!0,this.activeIndex=-1)}_inputFocusOut(e){(!e.relatedTarget||!["BUTTON","LI"].includes(e.relatedTarget.nodeName))&&(this.open=!1,this.canUpdate=!0)}_inputKeyDown(e){}_inputKeyUp(e){switch(e.keyCode||e.which){case 38:this.open=!0,this._listHighlightPrevious();break;case 40:this.open=!0,this._listHighlightNext();break;case 9:this.activeIndex<0?this.open=!1:e.preventDefault(),this._keyboardSelectOption();break;case 13:this._keyboardSelectOption();break;case 27:this.open=!1,this.activeIndex=-1;break;default:this.open=!0,this.query=e.target.value;break}}_scrollOptionListToActive(){const e=this.shadowRoot.querySelector(".option-list"),t=this.shadowRoot.querySelector("button.active");if(e&&t){const i=t.offsetTop,s=t.offsetTop+t.clientHeight,a=e.scrollTop,r=e.scrollTop+e.clientHeight;s>r?e.scrollTo({top:s-e.clientHeight,behavior:"smooth"}):i<a&&e.scrollTo({top:i,behavior:"smooth"})}}_touchStart(e){e.target&&(this.detectTap=!1)}_touchMove(e){e.target&&(this.detectTap=!0)}_touchEnd(e){this.detectTap||(e.target&&e.target.value&&this._clickOption(e),this.detectTap=!1)}_keyboardSelectOption(){this.activeIndex>-1&&(this.activeIndex+1>this.filteredOptions.length?this._select(this.query):this._select(this.filteredOptions[this.activeIndex].id))}_clickOption(e){e.target&&e.target.value&&this._select(e.target.value)}_clickAddNew(e){var t;e.target&&this._select((t=e.target.dataset)==null?void 0:t.label)}_clearSearch(){const e=this.shadowRoot.querySelector("input");e&&(e.value="")}_listHighlightNext(){this.allowAdd?this.activeIndex=Math.min(this.filteredOptions.length,this.activeIndex+1):this.activeIndex=Math.min(this.filteredOptions.length-1,this.activeIndex+1)}_listHighlightPrevious(){this.activeIndex=Math.max(0,this.activeIndex-1)}_renderOption(e,t){return f`
    ...
    `}_baseRenderOptions(){return this.filteredOptions.length?Oe(this.filteredOptions,e=>e.id,(e,t)=>this._renderOption(e,t)):this.loading?f`<li><div>${T("Loading options...")}</div></li>`:f`<li><div>${T("No Data Available")}</div></li>`}_renderOptions(){let e=this._baseRenderOptions();return this.allowAdd&&this.query&&(Array.isArray(e)||(e=[e]),e.push(f`<li tabindex="-1">
        <button
    ...
    `}static get properties(){return{key:{type:String},active:{type:Boolean,reflect:!0},disabled:{type:Boolean},missingIcon:{type:String}}}render(){var r;const e=(r=window==null?void 0:window.wpApiShare)==null?void 0:r.template_dir,{metric:t,active:i,disabled:s,missingIcon:a=`${e}/dt-assets/images/groups/missing.svg`}=this;return f`<div
      class=${E({"health-item":!0,"health-item--active":i,"health-item--disabled":s})}
      title="${t.description}"
    ...
    `}}window.customElements.define("dt-toggle",ds);class cs extends Ge{static get styles(){return[...super.styles,$`
      ...
      <div class="health-circle__wrapper input-group">
        ...
        >
          <div
            class=${E({"health-circle":!0,"health-circle--committed":this.isCommited,"health-circle--disabled":this.disabled})}
          >
    ...
    `}handleIconClick(e){const{key:t,active:i}=e.detail;i?this._select(t):this._remove(e)}async handleToggleChange(e){const{field:t,newValue:i}=e.detail;i?this._select(t):this._remove(e)}}window.customElements.define("dt-church-health-circle",cs);class Te extends Ge{static get properties(){return{...super.properties,allowAdd:{type:Boolean}}}static get styles(){return[...super.styles,$`
        .selected-option a,
    ...
    `}}window.customElements.define("dt-tags",Te);class us extends Te{static get styles(){return[...super.styles,$`
        .selected-option a {
    ...
    `}}window.customElements.define("dt-connection",us);class hs extends Te{static get styles(){return[...super.styles,$`
        .selected-option a {
          border-inline-start: solid 3px transparent;
        }
    ...
    `}}window.customElements.define("dt-copy-text",ps);class Dt extends D{static get styles(){return[...super.styles,$`
      ...
      <div class="input-group">
        <div class="${E(this.fieldContainerClasses)}">
          <input
            id="${this.id}"
            class="${E(this.classes)}"
            type="date"
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*We(o,e){if(o!==void 0){let t=0;for(const i of o)yield e(i,t++)}}class bs extends Te{static get properties(){return{...super.properties,filters:{type:Array}}}static get styles(){return[...super.styles,$`
        .input-group {
          display: flex;
        }
    ...
    `}}window.customElements.define("dt-modal",gs);class ms extends R{static get properties(){return{...super.properties,title:{type:String},isOpen:{type:Boolean},canEdit:{type:Boolean,state:!0},metadata:{type:Object},center:{type:Array},mapboxToken:{type:String,attribute:"mapbox-token"}}}static get styles(){return[$`
      ...
      >
        ...
        ${this.canEdit?f`<div slot="close-button">${T("Save")}</div>`:null}
      </dt-modal>

      <link href='https://api.mapbox.com/mapbox-gl-js/v2.11.0/mapbox-gl.css' rel='stylesheet' />
    `}}window.customElements.define("dt-map-modal",ms);class qa extends R{static get properties(){return{id:{type:String,reflect:!0},placeholder:{type:String},mapboxToken:{type:String,attribute:"mapbox-token"},googleToken:{type:String,attribute:"google-token"},validationMessage:{type:String},metadata:{type:Object},disabled:{type:Boolean},open:{type:Boolean,state:!0},query:{type:String,state:!0},activeIndex:{type:Number,state:!0},containerHeight:{type:Number,state:!0},loading:{type:Boolean},saved:{type:Boolean},error:{type:String},invalid:{type:Boolean},filteredOptions:{type:Array,state:!0}}}static get styles(){return[$`
        :host {
    ...
    `}_renderOptions(){const e=[];return this.filteredOptions.length?e.push(...this.filteredOptions.map((t,i)=>this._renderOption(t,i))):this.loading?e.push(f`<li><div>${T("Loading...")}</div></li>`):e.push(f`<li><div>${T("No Data Available")}</div></li>`),e.push(this._renderOption({value:this.query,label:this.query},(this.filteredOptions||[]).length,f`<strong>${T("Use")}: "${this.query}"</strong>`)),e}get classes(){return{"field-container":!0,invalid:this.invalid}}render(){var s,a,r,n;const e={display:this.open?"block":"none",top:this.containerHeight?`${this.containerHeight}px`:"2.5rem"},t=!!((s=this.metadata)!=null&&s.label),i=((a=this.metadata)==null?void 0:a.lat)&&((r=this.metadata)==null?void 0:r.lng);return f`
      <div class="input-group">
        ...
        ${this.loading?f`<dt-spinner
            ...
            ></dt-spinner>`:null}
        ${this.saved?f`<dt-checkmark
              class="icon-overlay success ${i?"selected":""}"
            ></dt-checkmark>`:null}
      </div>
      ...
      ></dt-map-modal>
    `}}window.customElements.define("dt-location-map-item",qa);class vs extends D{static get properties(){return{...super.properties,placeholder:{type:String},value:{type:Array,reflect:!0},locations:{type:Array,state:!0},open:{type:Boolean,state:!0},limit:{type:Number,attribute:"limit"},onchange:{type:String},mapboxToken:{type:String,attribute:"mapbox-token"},googleToken:{type:String,attribute:"google-token"}}}static get styles(){return[...super.styles,$`
        :host {
          font-family: Helvetica, Arial, sans-serif;
        }
        .input-group {
    ...
    `}render(){return[...this.value||[]],f`
      ${this.labelTemplate()}
      <div class="input-group">
        ${Oe(this.locations||[],e=>e.id,(e,t)=>this.renderItem(e,t))}
 ...
 */function Fa(o,e,t){return o?e(o):t==null?void 0:t(o)}class $s extends zt{static get styles(){return[...super.styles,$`
    ...
    `}_renderInputFields(){return(!this.value||!this.value.length)&&(this.value=[{verified:!1,value:"",tempKey:Date.now().toString()}]),f`
      ${Oe((this.value??[]).filter(e=>!e.delete),e=>e.id,e=>this._inputFieldTemplate(e,this.value.length))}
    ...
    `}static get properties(){return{postType:{type:String},postTypeLabel:{type:String},posttypesettings:{type:Object,attribute:!0},posts:{type:Array},total:{type:Number},columns:{type:Array},sortedBy:{type:String},loading:{type:Boolean,default:!0},offset:{type:Number},showArchived:{type:Boolean,default:!1},showFieldsSelector:{type:Boolean,default:!1},showBulkEditSelector:{type:Boolean,default:!1},nonce:{type:String},payload:{type:Object},favorite:{type:Boolean},initialLoadPost:{type:Boolean,default:!1},loadMore:{type:Boolean,default:!1},headerClick:{type:Boolean,default:!1}}}constructor(){super(),this.sortedBy="name",this.payload={sort:this.sortedBy,overall_status:["-closed"],fields_to_return:this.sortedColumns},this.initalLoadPost=!1,this.initalLoadPost||(this.posts=[],this.limit=100)}firstUpdated(){this.postTypeSettings=window.post_type_fields,this.sortedColumns=this.columns.includes("favorite")?["favorite",...this.columns.filter(e=>e!=="favorite")]:this.columns,this.style.setProperty("--number-of-columns",this.columns.length-1)}async _getPosts(e){const t=await new CustomEvent("dt:get-data",{bubbles:!0,detail:{field:this.name,postType:this.postType,query:e,onSuccess:i=>{this.initalLoadPost&&this.loadMore&&(this.posts=[...this.posts,...i],this.postsLength=this.posts.length,this.total=i.length,this.loadMore=!1),this.initalLoadPost||(this.posts=[...i],this.offset=this.posts.length,this.initalLoadPost=!0,this.total=i.length),this.headerClick&&(this.posts=i,this.offset=this.posts.length,this.headerClick=!1),this.total=i.length},onError:i=>{console.warn(i)}}});this.dispatchEvent(t)}_headerClick(e){const t=e.target.dataset.id;this.sortedBy===t?t.startsWith("-")?this.sortedBy=t.replace("-",""):this.sortedBy=`-${t}`:this.sortedBy=t,this.payload={sort:this.sortedBy,overall_status:["-closed"],limit:this.limit,fields_to_return:this.columns},this.headerClick=!0,this._getPosts(this.payload)}static _rowClick(e){window.open(e,"_self")}_bulkEdit(){this.showBulkEditSelector=!this.showBulkEditSelector}_fieldsEdit(){this.showFieldsSelector=!this.showFieldsSelector}_toggleShowArchived(){if(this.showArchived=!this.showArchived,this.headerClick=!0,this.showArchived){const{overall_status:e,offset:t,...i}=this.payload;this.payload=i}else this.payload.overall_status=["-closed"];this._getPosts(this.payload)}_sortArrowsClass(e){return this.sortedBy===e?"sortedBy":""}_sortArrowsToggle(e){return this.sortedBy!==`-${e}`?`-${e}`:e}_headerTemplate(){return this.postTypeSettings?f`
      ...
      />`:null}_fieldsListTemplate(){return Oe(Object.keys(this.postTypeSettings).sort((e,t)=>{const i=this.postTypeSettings[e].name.toUpperCase(),s=this.postTypeSettings[t].name.toUpperCase();return i<s?-1:i>s?1:0}),e=>e,e=>this.postTypeSettings[e].hidden?null:f`<li class="list-field-picker-item">
            <label>
              <input
                type="checkbox"
                id="${e}"
      ...
      >
        ...
        <div class="list_action_section_header">
          <p style="font-weight:bold">
            ${T(u`Select all the ${this.postType} you want to update from the list, and update them below`)}
          </p>
          <button
            class="close-button list-action-close-button"
            aria-label="Close modal"
        ...
        <div class="header">
          <div class="section-header">
            <span
              ...
              >${T(u`${this.postTypeLabel?this.postTypeLabel:this.postType} List`)}</span
            >
          </div>
          <span class="filter-result-text"
            >${T(u`Showing ${this.total} of ${this.total}`)}</span
          >
    ...
    `}}window.customElements.define("dt-list",Ss);class As extends R{static get styles(){return $`
      :host {
