 ...
 */const ue=o=>o??E;class ys extends D{static get styles(){return[...super.styles,S`
    ...
    `}}window.customElements.define("dt-number",ys);class _s extends D{static get styles(){return[...super.styles,S`
        :host {
          position: relative;
        }
    ...
    `}}window.customElements.define("dt-single-select",_s);class zt extends D{static get styles(){return[...super.styles,S`
        input {
          color: var(--dt-form-text-color, #000);
          appearance: none;
    ...
    `}}window.customElements.define("dt-textarea",ws);class $s extends D{static get styles(){return[...super.styles,S`
        :host {
          display: inline-block;
        }
