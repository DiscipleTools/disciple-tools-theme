  ...
  class extends o {
    ...
    static get properties() {
      return {
        ...
        color: { type: String, state: !0 },
        onchange: { type: String },
      };
    }
    updateColor() {
      if (this.value && this.options) {
        const e = this.options.filter((e) => e.id === this.value);
        e && e.length && (this.color = e[0].color);
      }
    }
    isColorSelect() {
      return (this.options || []).reduce((e, t) => e || t.color, !1);
    }
    willUpdate(e) {
      super.willUpdate(e), e.has('value') && this.updateColor();
    }
    _change(e) {
