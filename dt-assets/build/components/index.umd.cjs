 ...
 */const le=s=>s??O;class M extends N{static get formAssociated(){return!0}static get styles(){return[...super.styles,x`
    ...
    `}renderIconInvalid(){return this.touched&&this.invalid?c`<div class="${T(this._errorClasses())}">
          <dt-icon
        ...
        ></dt-checkmark>`:null}renderError(){return this.error?c`<div class="${T(this._errorClasses())}">
 ...
 */const co=(s,e,t)=>{const i=new Map;for(let o=e;o<=t;o++)i.set(s[o],o);return i},q=ut(class extends ht{constructor(s){if(super(s),s.type!==ct.CHILD)throw Error("repeat() can only be used in text expressions")}dt(s,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const o=[],a=[];let n=0;for(const r of s)o[n]=i?i(r,n):n,a[n]=t(r,n),n++;return{values:a,keys:o}}render(s,e,t){return this.dt(s,e,t).values}update(s,[e,t,i]){const o=Da(s),{values:a,keys:n}=this.dt(e,t,i);if(!Array.isArray(o))return this.ut=n,a;const r=this.ut??(this.ut=[]),l=[];let d,h,p=0,g=o.length-1,y=0,w=a.length-1;for(;p<=g&&y<=w;)if(o[p]===null)p++;else if(o[g]===null)g--;else if(r[p]===n[y])l[y]=de(o[p],a[y]),p++,y++;else if(r[g]===n[w])l[w]=de(o[g],a[w]),g--,w--;else if(r[p]===n[w])l[w]=de(o[p],a[w]),Oe(s,l[w+1],o[p]),p++,w--;else if(r[g]===n[y])l[y]=de(o[g],a[y]),Oe(s,o[p],o[g]),g--,y++;else if(d===void 0&&(d=co(n,y,w),h=co(r,p,g)),d.has(r[p]))if(d.has(r[g])){const E=h.get(n[y]),z=E!==void 0?o[E]:null;if(z===null){const j=Oe(s,o[p]);de(j,a[y]),l[y]=j}else l[y]=de(z,a[y]),Oe(s,o[p],z),o[E]=null;y++}else Mt(o[g]),g--;else Mt(o[p]),p++;for(;y<=w;){const E=Oe(s,l[w+1]);de(E,a[y]),l[y++]=E}for(;p<=g;){const E=o[p++];E!==null&&Mt(E)}return this.ut=n,ja(s,l),B}}),Fa=s=>class extends s{constructor(){super(),this.activeIndex=-1,this.filteredOptions=[],this.detectTap=!1}static get properties(){return{...super.properties,value:{type:Array,reflect:!0},query:{type:String,state:!0},options:{type:Array},filteredOptions:{type:Array,state:!0},open:{type:Boolean,state:!0},canUpdate:{type:Boolean,state:!0},activeIndex:{type:Number,state:!0},containerHeight:{type:Number,state:!0},loading:{type:Boolean},showAbove:{type:Boolean,state:!0}}}willUpdate(e){if(super.willUpdate(e),e&&!this.containerHeight&&this.shadowRoot.children&&this.shadowRoot.children.length){const t=this.shadowRoot.querySelector(".input-group");t&&(this.containerHeight=t.offsetHeight)}}updated(e){super.updated&&super.updated(e),this._scrollOptionListToActive();const t=this.shadowRoot.querySelector(".input-group");t&&!t.style.getPropertyValue("--container-width")&&t.clientWidth>0&&t.style.setProperty("--container-width",`${t.clientWidth}px`),e&&e.has("open")&&this.open&&this._checkPosition()}_checkPosition(){const e=this.shadowRoot.querySelector(".input-group");if(e){const t=e.getBoundingClientRect(),o=window.innerHeight-t.bottom,a=t.top;o<150&&a>o?this.showAbove=!0:this.showAbove=!1}}get optionListStyles(){const e={display:this.open?"block":"none"};return this.showAbove?(e.bottom=this.containerHeight?`${this.containerHeight}px`:"2.5rem",e.top="auto"):(e.top=this.containerHeight?`${this.containerHeight}px`:"2.5rem",e.bottom="auto"),e}_select(){console.error("Must implement `_select(value)` function"),this._clearSearch()}static _focusInput(e){e.target===e.currentTarget&&e.target.getElementsByTagName("input")[0].focus()}_inputFocusIn(e){(!e.relatedTarget||!["BUTTON","LI"].includes(e.relatedTarget.nodeName))&&(this.open=!0,this.activeIndex=-1)}_inputFocusOut(e){(!e.relatedTarget||!["BUTTON","LI"].includes(e.relatedTarget.nodeName))&&(this.open=!1,this.canUpdate=!0)}_inputKeyDown(e){}_inputKeyUp(e){switch(e.keyCode||e.which){case 38:this.open=!0,this._listHighlightPrevious();break;case 40:this.open=!0,this._listHighlightNext();break;case 9:this.activeIndex<0?this.open=!1:e.preventDefault(),this._keyboardSelectOption();break;case 13:this._keyboardSelectOption();break;case 27:this.open=!1,this.activeIndex=-1;break;default:this.open=!0,this.query=e.target.value;break}}_scrollOptionListToActive(){const e=this.shadowRoot.querySelector(".option-list"),t=this.shadowRoot.querySelector("button.active");if(e&&t){const i=t.offsetTop,o=t.offsetTop+t.clientHeight,a=e.scrollTop,n=e.scrollTop+e.clientHeight;o>n?e.scrollTo({top:o-e.clientHeight,behavior:"smooth"}):i<a&&e.scrollTo({top:i,behavior:"smooth"})}}_touchStart(e){e.target&&(this.detectTap=!1)}_touchMove(e){e.target&&(this.detectTap=!0)}_touchEnd(e){this.detectTap||(e.target&&e.target.value&&this._clickOption(e),this.detectTap=!1)}_keyboardSelectOption(){this.activeIndex>-1&&(this.activeIndex+1>this.filteredOptions.length?this._select(this.query):this._select(this.filteredOptions[this.activeIndex].id))}_clickOption(e){e.target&&e.target.value&&this._select(e.target.value)}_clickAddNew(e){var t;e.target&&this._select((t=e.target.dataset)==null?void 0:t.label)}_clearSearch(){const e=this.shadowRoot.querySelector("input");e&&(e.value="")}_listHighlightNext(){this.allowAdd?this.activeIndex=Math.min(this.filteredOptions.length,this.activeIndex+1):this.activeIndex=Math.min(this.filteredOptions.length-1,this.activeIndex+1)}_listHighlightPrevious(){this.activeIndex=Math.max(0,this.activeIndex-1)}_renderOption(e,t){return c`
      ...
      `}_baseRenderOptions(){return this.filteredOptions.length?q(this.filteredOptions,e=>e.id,(e,t)=>this._renderOption(e,t)):this.loading?c`<li><div>${R("Loading options...")}</div></li>`:c`<li><div>${R("No Data Available")}</div></li>`}_renderOptions(){let e=this._baseRenderOptions();return this.allowAdd&&this.query&&(Array.isArray(e)||(e=[e]),e.push(c`<li tabindex="-1">
          ...
          </li>`)),e}};class Ze extends Fa(M){static get styles(){return[...super.styles,x`
        :host {
          position: relative;
    ...
    `}}window.customElements.define("dt-toggle",uo);class ho extends Ze{static get styles(){return[...super.styles,x`
      ...
      <div class="health-circle__wrapper input-group">
        ...
        >
          <div
            class=${T({"health-circle":!0,"health-circle--committed":this.isCommited,"health-circle--disabled":this.disabled,"health-circle--readonly":this.readonly})}
          >
 ...
 */function*Ra(s,e){if(s!==void 0){let t=0;for(const i of s)yield e(i,t++)}}class go extends Ce{static get properties(){return{...super.properties,filters:{type:Array}}}static get styles(){return[...super.styles,x`
    ...
    `}}window.customElements.define("dt-single-select",$o);class Dt extends M{static get styles(){return[...super.styles,x`
        input {
    ...
    `}}window.customElements.define("dt-text",Dt);class xo extends M{static get styles(){return[...super.styles,x`
        textarea {
          color: var(
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function U(s,e,t){return s?e(s):t==null?void 0:t(s)}class Ft extends Dt{static get styles(){return[...super.styles,x`
        :host {
          display: block;
        }
        input {
    ...
    `}}window.customElements.define("dt-multi-text",Ft);class ko extends Ft{static get styles(){return[...super.styles,x`
        .icon-btn {
          background-color: transparent;
          border: none;
          cursor: pointer;
    ...
    `}_validateRequired(){const{value:e}=this;this.required&&(!e||e.every(t=>!t||t.charAt(0)==="-"))?(this.invalid=!0,this.internals.setValidity({valueMissing:!0},this.requiredMessage||"This field is required",this._field)):(this.invalid=!1,this.internals.setValidity({}))}get classes(){return{"button-group":!0,invalid:this.touched&&this.invalid}}render(){return c`
      ...
      <div
        ...
        part="input-group"
      >
        <div class="${T(this.classes)}" part="button-group">
