 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const I=ut(class extends ht{constructor(o){var e;if(super(o),o.type!==ct.ATTRIBUTE||o.name!=="class"||((e=o.strings)==null?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(o){return" "+Object.keys(o).filter(e=>o[e]).join(" ")+" "}update(o,[e]){var i,s;if(this.st===void 0){this.st=new Set,o.strings!==void 0&&(this.nt=new Set(o.strings.join(" ").split(/\s/).filter(a=>a!=="")));for(const a in e)e[a]&&!((i=this.nt)!=null&&i.has(a))&&this.st.add(a);return this.render(e)}const t=o.element.classList;for(const a of this.st)a in e||(t.remove(a),this.st.delete(a));for(const a in e){const r=!!e[a];r===this.st.has(a)||(s=this.nt)!=null&&s.has(a)||(r?(t.add(a),this.st.add(a)):(t.remove(a),this.st.delete(a)))}return V}});/**
 * @license
 ...
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const yi="important",jo=" !"+yi,oe=ut(class extends ht{constructor(o){var e;if(super(o),o.type!==ct.ATTRIBUTE||o.name!=="style"||((e=o.strings)==null?void 0:e.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(o){return Object.keys(o).reduce((e,t)=>{const i=o[t];return i==null?e:e+`${t=t.includes("-")?t:t.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${i};`},"")}update(o,[e]){const{style:t}=o.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(e)),this.render(e);for(const i of this.ft)e[i]==null&&(this.ft.delete(i),i.includes("-")?t.removeProperty(i):t[i]=null);for(const i in e){const s=e[i];if(s!=null){this.ft.add(i);const a=typeof s=="string"&&s.endsWith(jo);i.includes("-")||a?t.setProperty(i,a?s.slice(0,-11):s,a?yi:""):t[i]=s}}return V}});class wi extends N{static get styles(){return S`
      :host {
        display: block;
    ...
    `;return c`
      <dialog
        id=""
        class="dt-modal dt-modal--width ${I(this.headerClass||{})}"
      ...
      <button
        class="button small opener ${I(this.buttonClass||{})}"
        data-open=""
        aria-label="Open reveal"
        type="button"
        @click="${this._openModal}"
        style=${oe(this.buttonStyle||{})}
      >
    ...
    `}_redirectToHref(e){let t=e;/^https?:\/\//i.test(t)||(t=`http://${t}`),window.open(t,"_blank")}_openDialog(e){const t=e.replace(/\s/g,"-").toLowerCase();document.querySelector(`#${t}`).shadowRoot.querySelector("dialog").showModal(),document.querySelector("body").style.overflow="hidden"}_handleHover(){const e=this.shadowRoot.querySelector("ul");e.style.display="block"}_handleMouseLeave(){const e=this.shadowRoot.querySelector("ul");e.style.display="none"}}window.customElements.define("dt-dropdown",_i);class zo extends N{static get styles(){return S`
      root {
        display: block;
      }
      .health-item img {
    ...
    `}static get properties(){return{key:{type:String},metric:{type:Object},group:{type:Object},active:{type:Boolean,reflect:!0},missingIcon:{type:String},handleSave:{type:Function}}}render(){const{metric:e,active:t,missingIcon:i=`${window.wpApiShare.template_dir}/dt-assets/images/groups/missing.svg`}=this;return c`<div
      class=${I({"health-item":!0,"health-item--active":t})}
      title="${e.description}"
      @click="${this._handleClick}"
    >
      <img src="${e.icon?e.icon:i}" />
    </div>`}async _handleClick(){if(!this.handleSave)return;const e=!this.active;this.active=e;const t={health_metrics:{values:[{value:this.key,delete:!e}]}};try{await this.handleSave(this.group.ID,t)}catch(i){console.error(i);return}e?this.group.health_metrics.push(this.key):this.group.health_metrics.pop(this.key)}}window.customElements.define("dt-church-health-icon",zo);class $i extends N{static get styles(){return S`
    ...
    `}static get properties(){return{groupId:{type:Number},group:{type:Object,reflect:!1},settings:{type:Object,reflect:!1},errorMessage:{type:String,attribute:!1},missingIcon:{type:String},handleSave:{type:Function}}}get metrics(){const e=this.settings||[];return Object.values(e).length?Object.entries(e).filter(([i,s])=>i!=="church_commitment"):[]}get isCommited(){return!this.group||!this.group.health_metrics?!1:this.group.health_metrics.includes("church_commitment")}connectedCallback(){super.connectedCallback(),this.fetch()}adoptedCallback(){this.distributeItems()}updated(){this.distributeItems()}async fetch(){try{const e=[this.fetchSettings(),this.fetchGroup()];let[t,i]=await Promise.all(e);this.settings=t,this.post=i,t||(this.errorMessage="Error loading settings"),i||(this.errorMessage="Error loading group")}catch(e){console.error(e)}}fetchGroup(){if(this.group)return Promise.resolve(this.group);fetch(`/wp-json/dt-posts/v2/groups/${this.groupId}`).then(e=>e.json())}fetchSettings(){return this.settings?Promise.resolve(this.settings):fetch("/wp-json/dt-posts/v2/groups/settings").then(e=>e.json())}findMetric(e){const t=this.metrics.find(i=>i.key===e);return t?t.value:null}render(){if(!this.group||!this.metrics.length)return c`<dt-spinner></dt-spinner>`;const e=this.group.health_metrics||[];return this.errorMessage&&c`<dt-alert type="error">${this.errorMessage}</dt-alert>`,c`
      <div class="health-circle__wrapper">
        <div class="health-circle__container">
          <div
            class=${I({"health-circle":!0,"health-circle--committed":this.isCommited})}
          >
    ...
    `}}window.customElements.define("dt-label",xi);class D extends N{static get formAssociated(){return!0}static get styles(){return[S`
        .input-group {
          position: relative;
        }
 ...
 */const Si=(o,e,t)=>{const i=new Map;for(let s=e;s<=t;s++)i.set(o[s],s);return i},_e=ut(class extends ht{constructor(o){if(super(o),o.type!==ct.CHILD)throw Error("repeat() can only be used in text expressions")}dt(o,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const s=[],a=[];let r=0;for(const n of o)s[r]=i?i(n,r):r,a[r]=t(n,r),r++;return{values:a,keys:s}}render(o,e,t){return this.dt(o,e,t).values}update(o,[e,t,i]){const s=qo(o),{values:a,keys:r}=this.dt(e,t,i);if(!Array.isArray(s))return this.ut=r,a;const n=this.ut??(this.ut=[]),l=[];let u,b,g=0,v=s.length-1,y=0,$=a.length-1;for(;g<=v&&y<=$;)if(s[g]===null)g++;else if(s[v]===null)v--;else if(n[g]===r[y])l[y]=ae(s[g],a[y]),g++,y++;else if(n[v]===r[$])l[$]=ae(s[v],a[$]),v--,$--;else if(n[g]===r[$])l[$]=ae(s[g],a[$]),we(o,l[$+1],s[g]),g++,$--;else if(n[v]===r[y])l[y]=ae(s[v],a[y]),we(o,s[g],s[v]),v--,y++;else if(u===void 0&&(u=Si(r,y,$),b=Si(n,g,v)),u.has(n[g]))if(u.has(n[v])){const C=b.get(r[y]),q=C!==void 0?s[C]:null;if(q===null){const j=we(o,s[g]);ae(j,a[y]),l[y]=j}else l[y]=ae(q,a[y]),we(o,s[g],q),s[C]=null;y++}else mt(s[v]),v--;else mt(s[g]),g++;for(;y<=$;){const C=we(o,l[$+1]);ae(C,a[y]),l[y++]=C}for(;g<=v;){const C=s[g++];C!==null&&mt(C)}return this.ut=r,No(o,l),V}}),Fo=o=>class extends o{constructor(){super(),this.activeIndex=-1,this.filteredOptions=[],this.detectTap=!1}static get properties(){return{...super.properties,value:{type:Array,reflect:!0},query:{type:String,state:!0},options:{type:Array},filteredOptions:{type:Array,state:!0},open:{type:Boolean,state:!0},canUpdate:{type:Boolean,state:!0},activeIndex:{type:Number,state:!0},containerHeight:{type:Number,state:!0},loading:{type:Boolean}}}willUpdate(e){if(super.willUpdate(e),e&&!this.containerHeight&&this.shadowRoot.children&&this.shadowRoot.children.length){const t=this.shadowRoot.querySelector(".input-group");t&&(this.containerHeight=t.offsetHeight)}}updated(){this._scrollOptionListToActive();const e=this.shadowRoot.querySelector(".input-group");!e.style.getPropertyValue("--container-width")&&e.clientWidth>0&&e.style.setProperty("--container-width",`${e.clientWidth}px`)}_select(){console.error("Must implement `_select(value)` function")}static _focusInput(e){e.target===e.currentTarget&&e.target.getElementsByTagName("input")[0].focus()}_inputFocusIn(e){(!e.relatedTarget||!["BUTTON","LI"].includes(e.relatedTarget.nodeName))&&(this.open=!0,this.activeIndex=-1)}_inputFocusOut(e){(!e.relatedTarget||!["BUTTON","LI"].includes(e.relatedTarget.nodeName))&&(this.open=!1,this.canUpdate=!0)}_inputKeyDown(e){}_inputKeyUp(e){switch(e.keyCode||e.which){case 8:e.target.value===""?this.value=this.value.slice(0,-1):this.open=!0;break;case 38:this.open=!0,this._listHighlightPrevious();break;case 40:this.open=!0,this._listHighlightNext();break;case 9:this.activeIndex<0?this.open=!1:e.preventDefault(),this._keyboardSelectOption();break;case 13:this._keyboardSelectOption();break;case 27:this.open=!1,this.activeIndex=-1;break;default:this.open=!0,this.query=e.target.value;break}}_scrollOptionListToActive(){const e=this.shadowRoot.querySelector(".option-list"),t=this.shadowRoot.querySelector("button.active");if(e&&t){const i=t.offsetTop,s=t.offsetTop+t.clientHeight,a=e.scrollTop,r=e.scrollTop+e.clientHeight;s>r?e.scrollTo({top:s-e.clientHeight,behavior:"smooth"}):i<a&&e.scrollTo({top:i,behavior:"smooth"})}}_touchStart(e){e.target&&(this.detectTap=!1)}_touchMove(e){e.target&&(this.detectTap=!0)}_touchEnd(e){this.detectTap||(e.target&&e.target.value&&this._clickOption(e),this.detectTap=!1)}_keyboardSelectOption(){this.activeIndex>-1&&(this.activeIndex+1>this.filteredOptions.length?this._select(this.query):this._select(this.filteredOptions[this.activeIndex].id),this._clearSearch())}_clickOption(e){e.target&&e.target.value&&(this._select(e.target.value),this._clearSearch())}_clickAddNew(e){var t;e.target&&(this._select((t=e.target.dataset)==null?void 0:t.label),this._clearSearch())}_clearSearch(){const e=this.shadowRoot.querySelector("input");e&&(e.value="")}_listHighlightNext(){this.allowAdd?this.activeIndex=Math.min(this.filteredOptions.length,this.activeIndex+1):this.activeIndex=Math.min(this.filteredOptions.length-1,this.activeIndex+1)}_listHighlightPrevious(){this.activeIndex=Math.max(0,this.activeIndex-1)}_renderOption(e,t){return c`
    ...
    `}_baseRenderOptions(){return this.filteredOptions.length?_e(this.filteredOptions,e=>e.id,(e,t)=>this._renderOption(e,t)):this.loading?c`<li><div>${A("Loading options...")}</div></li>`:c`<li><div>${A("No Data Available")}</div></li>`}_renderOptions(){let e=this._baseRenderOptions();return this.allowAdd&&this.query&&(Array.isArray(e)||(e=[e]),e.push(c`<li tabindex="-1">
        <button
      ...
      </li>`)),e}};class Uo extends F{static get styles(){return S`
      @keyframes spin {
        0% {
    ...
    `}}window.customElements.define("dt-spinner",Uo);class Vo extends F{static get styles(){return S`
      @keyframes fadeOut {
        0% {
          opacity: 1;
        }
    ...
    `}}window.customElements.define("dt-checkmark",Vo);class vt extends Fo(D){static get styles(){return[...super.styles,S`
        :host {
          position: relative;
      ...
      <div class="input-group ${this.disabled?"disabled":""}">
        ...
        <ul class="option-list" style=${oe(e)}>
          ${this._renderOptions()}
        </ul>
...
`}}window.customElements.define("dt-multi-select",vt);class $e extends vt{static get properties(){return{...super.properties,allowAdd:{type:Boolean}}}static get styles(){return[...super.styles,S`
    ...
    `}_validateRequired(){const{value:e}=this;this.required&&(!e||e.every(t=>!t||typeof t=="string"&&t.charAt(0)==="-"))?(this.invalid=!0,this.internals.setValidity({valueMissing:!0},this.requiredMessage||"This field is required",this._field)):(this.invalid=!1,this.internals.setValidity({}))}_renderSelectedOptions(){const e=this.options||this.allOptions;return(this.value||[]).filter(t=>!t.startsWith("-")).map(t=>{var a;let i=t;if(e){const r=e.filter(n=>n===t||n.id===t);r.length&&(i=r[0].label||r[0].id||t)}let s;if(!s&&((a=window==null?void 0:window.SHAREDFUNCTIONS)!=null&&a.createCustomFilter)){const r=window.SHAREDFUNCTIONS.createCustomFilter(this.name,[t]),n=this.label||this.name,l=[{id:`${this.name}_${t}`,name:`${n}: ${t}`}];s=window.SHAREDFUNCTIONS.create_url_for_list_query(this.postType,r,l)}return c`
        ...
        `})}}window.customElements.define("dt-tags",$e);class Ti extends $e{static get styles(){return[...super.styles,S`
        .selected-option a {
    ...
    `}}window.customElements.define("dt-connection",Ti);class Ei extends $e{static get styles(){return[...super.styles,S`
        .selected-option a {
          border-inline-start: solid 3px transparent;
        }
    ...
    `}}window.customElements.define("dt-users-connection",Ei);class Ai extends N{static get styles(){return S`
      :root {
        font-size: inherit;
    ...
    `}static get properties(){return{value:{type:String},success:{type:Boolean},error:{type:Boolean}}}get inputStyles(){return this.success?{"--dt-text-border-color":"var(--copy-text-success-color, var(--success-color))","--dt-form-text-color":"var( --copy-text-success-color, var(--success-color))",color:"var( --copy-text-success-color, var(--success-color))"}:this.error?{"---dt-text-border-color":"var(--copy-text-alert-color, var(--alert-color))","--dt-form-text-color":"var(--copy-text-alert-color, var(--alert-color))"}:{}}get icon(){return this.success?"ic:round-check":"ic:round-content-copy"}async copy(){try{this.success=!1,this.error=!1,await navigator.clipboard.writeText(this.value),this.success=!0,this.error=!1}catch(e){console.log(e),this.success=!1,this.error=!0}}render(){return c`
      <div class="copy-text" style=${oe(this.inputStyles)}>
        <dt-text
    ...
    `}}window.customElements.define("dt-copy-text",Ai);class Oi extends D{static get styles(){return[...super.styles,S`
        input {
          color: var(--dt-form-text-color, #000);
          appearance: none;
    ...
    `}}window.customElements.define("dt-date",Oi);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*Ne(o,e){if(o!==void 0){let t=0;for(const i of o)yield e(i,t++)}}class Ci extends $e{static get properties(){return{...super.properties,filters:{type:Array},mapboxKey:{type:String},dtMapbox:{type:Object}}}static get styles(){return[...super.styles,S`
        .input-group {
          display: flex;
        }
...
* @license MIT
* @version 1.0.2
*/const Li=Object.freeze({left:0,top:0,width:16,height:16}),qe=Object.freeze({rotate:0,vFlip:!1,hFlip:!1}),xe=Object.freeze({...Li,...qe}),yt=Object.freeze({...xe,body:"",hidden:!1}),Go=Object.freeze({width:null,height:null}),Pi=Object.freeze({...Go,...qe});function Wo(o,e=0){const t=o.replace(/^-?[0-9.]*/,"");function i(s){for(;s<0;)s+=4;return s%4}if(t===""){const s=parseInt(o);return isNaN(s)?0:i(s)}else if(t!==o){let s=0;switch(t){case"%":s=25;break;case"deg":s=90}if(s){let a=parseFloat(o.slice(0,o.length-t.length));return isNaN(a)?0:(a=a/s,a%1===0?i(a):0)}}return e}const Ko=/[\s,]+/;function Zo(o,e){e.split(Ko).forEach(t=>{switch(t.trim()){case"horizontal":o.hFlip=!0;break;case"vertical":o.vFlip=!0;break}})}const Ii={...Pi,preserveAspectRatio:""};function Mi(o){const e={...Ii},t=(i,s)=>o.getAttribute(i)||s;return e.width=t("width",null),e.height=t("height",null),e.rotate=Wo(t("rotate","")),Zo(e,t("flip","")),e.preserveAspectRatio=t("preserveAspectRatio",t("preserveaspectratio","")),e}function Jo(o,e){for(const t in Ii)if(o[t]!==e[t])return!0;return!1}const ke=/^[a-z0-9]+(-[a-z0-9]+)*$/,Se=(o,e,t,i="")=>{const s=o.split(":");if(o.slice(0,1)==="@"){if(s.length<2||s.length>3)return null;i=s.shift().slice(1)}if(s.length>3||!s.length)return null;if(s.length>1){const n=s.pop(),l=s.pop(),u={provider:s.length>0?s[0]:i,prefix:l,name:n};return e&&!Fe(u)?null:u}const a=s[0],r=a.split("-");if(r.length>1){const n={provider:i,prefix:r.shift(),name:r.join("-")};return e&&!Fe(n)?null:n}if(t&&i===""){const n={provider:i,prefix:"",name:a};return e&&!Fe(n,t)?null:n}return null},Fe=(o,e)=>o?!!((o.provider===""||o.provider.match(ke))&&(e&&o.prefix===""||o.prefix.match(ke))&&o.name.match(ke)):!1;function Qo(o,e){const t={};!o.hFlip!=!e.hFlip&&(t.hFlip=!0),!o.vFlip!=!e.vFlip&&(t.vFlip=!0);const i=((o.rotate||0)+(e.rotate||0))%4;return i&&(t.rotate=i),t}function ji(o,e){const t=Qo(o,e);for(const i in yt)i in qe?i in o&&!(i in t)&&(t[i]=qe[i]):i in e?t[i]=e[i]:i in o&&(t[i]=o[i]);return t}function Xo(o,e){const t=o.icons,i=o.aliases||Object.create(null),s=Object.create(null);function a(r){if(t[r])return s[r]=[];if(!(r in s)){s[r]=null;const n=i[r]&&i[r].parent,l=n&&a(n);l&&(s[r]=[n].concat(l))}return s[r]}return Object.keys(t).concat(Object.keys(i)).forEach(a),s}function Yo(o,e,t){const i=o.icons,s=o.aliases||Object.create(null);let a={};function r(n){a=ji(i[n]||s[n],a)}return r(e),t.forEach(r),ji(o,a)}function zi(o,e){const t=[];if(typeof o!="object"||typeof o.icons!="object")return t;o.not_found instanceof Array&&o.not_found.forEach(s=>{e(s,null),t.push(s)});const i=Xo(o);for(const s in i){const a=i[s];a&&(e(s,Yo(o,s,a)),t.push(s))}return t}const ea={provider:"",aliases:{},not_found:{},...Li};function wt(o,e){for(const t in e)if(t in o&&typeof o[t]!=typeof e[t])return!1;return!0}function Di(o){if(typeof o!="object"||o===null)return null;const e=o;if(typeof e.prefix!="string"||!o.icons||typeof o.icons!="object"||!wt(o,ea))return null;const t=e.icons;for(const s in t){const a=t[s];if(!s.match(ke)||typeof a.body!="string"||!wt(a,yt))return null}const i=e.aliases||Object.create(null);for(const s in i){const a=i[s],r=a.parent;if(!s.match(ke)||typeof r!="string"||!t[r]&&!i[r]||!wt(a,yt))return null}return e}const Ue=Object.create(null);function ta(o,e){return{provider:o,prefix:e,icons:Object.create(null),missing:new Set}}function Q(o,e){const t=Ue[o]||(Ue[o]=Object.create(null));return t[e]||(t[e]=ta(o,e))}function _t(o,e){return Di(e)?zi(e,(t,i)=>{i?o.icons[t]=i:o.missing.add(t)}):[]}function ia(o,e,t){try{if(typeof t.body=="string")return o.icons[e]={...t},!0}catch{}return!1}function sa(o,e){let t=[];return(typeof o=="string"?[o]:Object.keys(Ue)).forEach(s=>{(typeof s=="string"&&typeof e=="string"?[e]:Object.keys(Ue[s]||{})).forEach(r=>{const n=Q(s,r);t=t.concat(Object.keys(n.icons).map(l=>(s!==""?"@"+s+":":"")+r+":"+l))})}),t}let Te=!1;function Ri(o){return typeof o=="boolean"&&(Te=o),Te}function Ee(o){const e=typeof o=="string"?Se(o,!0,Te):o;if(e){const t=Q(e.provider,e.prefix),i=e.name;return t.icons[i]||(t.missing.has(i)?null:void 0)}}function Ni(o,e){const t=Se(o,!0,Te);if(!t)return!1;const i=Q(t.provider,t.prefix);return ia(i,t.name,e)}function qi(o,e){if(typeof o!="object")return!1;if(typeof e!="string"&&(e=o.provider||""),Te&&!e&&!o.prefix){let s=!1;return Di(o)&&(o.prefix="",zi(o,(a,r)=>{r&&Ni(a,r)&&(s=!0)})),s}const t=o.prefix;if(!Fe({provider:e,prefix:t,name:"a"}))return!1;const i=Q(e,t);return!!_t(i,o)}function oa(o){return!!Ee(o)}function aa(o){const e=Ee(o);return e?{...xe,...e}:null}function ra(o){const e={loaded:[],missing:[],pending:[]},t=Object.create(null);o.sort((s,a)=>s.provider!==a.provider?s.provider.localeCompare(a.provider):s.prefix!==a.prefix?s.prefix.localeCompare(a.prefix):s.name.localeCompare(a.name));let i={provider:"",prefix:"",name:""};return o.forEach(s=>{if(i.name===s.name&&i.prefix===s.prefix&&i.provider===s.provider)return;i=s;const a=s.provider,r=s.prefix,n=s.name,l=t[a]||(t[a]=Object.create(null)),u=l[r]||(l[r]=Q(a,r));let b;n in u.icons?b=e.loaded:r===""||u.missing.has(n)?b=e.missing:b=e.pending;const g={provider:a,prefix:r,name:n};b.push(g)}),e}function Fi(o,e){o.forEach(t=>{const i=t.loaderCallbacks;i&&(t.loaderCallbacks=i.filter(s=>s.id!==e))})}function na(o){o.pendingCallbacksFlag||(o.pendingCallbacksFlag=!0,setTimeout(()=>{o.pendingCallbacksFlag=!1;const e=o.loaderCallbacks?o.loaderCallbacks.slice(0):[];if(!e.length)return;let t=!1;const i=o.provider,s=o.prefix;e.forEach(a=>{const r=a.icons,n=r.pending.length;r.pending=r.pending.filter(l=>{if(l.prefix!==s)return!0;const u=l.name;if(o.icons[u])r.loaded.push({provider:i,prefix:s,name:u});else if(o.missing.has(u))r.missing.push({provider:i,prefix:s,name:u});else return t=!0,!0;return!1}),r.pending.length!==n&&(t||Fi([o],a.id),a.callback(r.loaded.slice(0),r.missing.slice(0),r.pending.slice(0),a.abort))})}))}let la=0;function da(o,e,t){const i=la++,s=Fi.bind(null,t,i);if(!e.pending.length)return s;const a={id:i,icons:e,callback:o,abort:s};return t.forEach(r=>{(r.loaderCallbacks||(r.loaderCallbacks=[])).push(a)}),s}const $t=Object.create(null);function Ui(o,e){$t[o]=e}function xt(o){return $t[o]||$t[""]}function ca(o,e=!0,t=!1){const i=[];return o.forEach(s=>{const a=typeof s=="string"?Se(s,e,t):s;a&&i.push(a)}),i}var ua={resources:[],index:0,timeout:2e3,rotate:750,random:!1,dataAfterTimeout:!1};function ha(o,e,t,i){const s=o.resources.length,a=o.random?Math.floor(Math.random()*s):o.index;let r;if(o.random){let T=o.resources.slice(0);for(r=[];T.length>1;){const R=Math.floor(Math.random()*T.length);r.push(T[R]),T=T.slice(0,R).concat(T.slice(R+1))}r=r.concat(T)}else r=o.resources.slice(a).concat(o.resources.slice(0,a));const n=Date.now();let l="pending",u=0,b,g=null,v=[],y=[];typeof i=="function"&&y.push(i);function $(){g&&(clearTimeout(g),g=null)}function C(){l==="pending"&&(l="aborted"),$(),v.forEach(T=>{T.status==="pending"&&(T.status="aborted")}),v=[]}function q(T,R){R&&(y=[]),typeof T=="function"&&y.push(T)}function j(){return{startTime:n,payload:e,status:l,queriesSent:u,queriesPending:v.length,subscribe:q,abort:C}}function L(){l="failed",y.forEach(T=>{T(void 0,b)})}function Ce(){v.forEach(T=>{T.status==="pending"&&(T.status="aborted")}),v=[]}function Ze(T,R,ne){const Y=R!=="success";switch(v=v.filter(M=>M!==T),l){case"pending":break;case"failed":if(Y||!o.dataAfterTimeout)return;break;default:return}if(R==="abort"){b=ne,L();return}if(Y){b=ne,v.length||(r.length?X():L());return}if($(),Ce(),!o.random){const M=o.resources.indexOf(T.resource);M!==-1&&M!==o.index&&(o.index=M)}l="completed",y.forEach(M=>{M(ne)})}function X(){if(l!=="pending")return;$();const T=r.shift();if(T===void 0){if(v.length){g=setTimeout(()=>{$(),l==="pending"&&(Ce(),L())},o.timeout);return}L();return}const R={status:"pending",resource:T,callback:(ne,Y)=>{Ze(R,ne,Y)}};v.push(R),u++,g=setTimeout(X,o.rotate),t(T,e,R.callback)}return setTimeout(X),j}function Vi(o){const e={...ua,...o};let t=[];function i(){t=t.filter(n=>n().status==="pending")}function s(n,l,u){const b=ha(e,n,l,(g,v)=>{i(),u&&u(g,v)});return t.push(b),b}function a(n){return t.find(l=>n(l))||null}return{query:s,find:a,setIndex:n=>{e.index=n},getIndex:()=>e.index,cleanup:i}}function kt(o){let e;if(typeof o.resources=="string")e=[o.resources];else if(e=o.resources,!(e instanceof Array)||!e.length)return null;return{resources:e,path:o.path||"/",maxURL:o.maxURL||500,rotate:o.rotate||750,timeout:o.timeout||5e3,random:o.random===!0,index:o.index||0,dataAfterTimeout:o.dataAfterTimeout!==!1}}const Ve=Object.create(null),Ae=["https://api.simplesvg.com","https://api.unisvg.com"],Be=[];for(;Ae.length>0;)Ae.length===1||Math.random()>.5?Be.push(Ae.shift()):Be.push(Ae.pop());Ve[""]=kt({resources:["https://api.iconify.design"].concat(Be)});function Bi(o,e){const t=kt(e);return t===null?!1:(Ve[o]=t,!0)}function He(o){return Ve[o]}function pa(){return Object.keys(Ve)}function Hi(){}const St=Object.create(null);function fa(o){if(!St[o]){const e=He(o);if(!e)return;const t=Vi(e),i={config:e,redundancy:t};St[o]=i}return St[o]}function Gi(o,e,t){let i,s;if(typeof o=="string"){const a=xt(o);if(!a)return t(void 0,424),Hi;s=a.send;const r=fa(o);r&&(i=r.redundancy)}else{const a=kt(o);if(a){i=Vi(a);const r=o.resources?o.resources[0]:"",n=xt(r);n&&(s=n.send)}}return!i||!s?(t(void 0,424),Hi):i.query(e,s,t)().abort}const Wi="iconify2",Oe="iconify",Ki=Oe+"-count",Zi=Oe+"-version",Ji=36e5,ba=168;function Tt(o,e){try{return o.getItem(e)}catch{}}function Et(o,e,t){try{return o.setItem(e,t),!0}catch{}}function Qi(o,e){try{o.removeItem(e)}catch{}}function At(o,e){return Et(o,Ki,e.toString())}function Ot(o){return parseInt(Tt(o,Ki))||0}const re={local:!0,session:!0},Xi={local:new Set,session:new Set};let Ct=!1;function ga(o){Ct=o}let Ge=typeof window>"u"?{}:window;function Yi(o){const e=o+"Storage";try{if(Ge&&Ge[e]&&typeof Ge[e].length=="number")return Ge[e]}catch{}re[o]=!1}function es(o,e){const t=Yi(o);if(!t)return;const i=Tt(t,Zi);if(i!==Wi){if(i){const n=Ot(t);for(let l=0;l<n;l++)Qi(t,Oe+l.toString())}Et(t,Zi,Wi),At(t,0);return}const s=Math.floor(Date.now()/Ji)-ba,a=n=>{const l=Oe+n.toString(),u=Tt(t,l);if(typeof u=="string"){try{const b=JSON.parse(u);if(typeof b=="object"&&typeof b.cached=="number"&&b.cached>s&&typeof b.provider=="string"&&typeof b.data=="object"&&typeof b.data.prefix=="string"&&e(b,n))return!0}catch{}Qi(t,l)}};let r=Ot(t);for(let n=r-1;n>=0;n--)a(n)||(n===r-1?(r--,At(t,r)):Xi[o].add(n))}function ts(){if(!Ct){ga(!0);for(const o in re)es(o,e=>{const t=e.data,i=e.provider,s=t.prefix,a=Q(i,s);if(!_t(a,t).length)return!1;const r=t.lastModified||-1;return a.lastModifiedCached=a.lastModifiedCached?Math.min(a.lastModifiedCached,r):r,!0})}}function ma(o,e){const t=o.lastModifiedCached;if(t&&t>=e)return t===e;if(o.lastModifiedCached=e,t)for(const i in re)es(i,s=>{const a=s.data;return s.provider!==o.provider||a.prefix!==o.prefix||a.lastModified===e});return!0}function va(o,e){Ct||ts();function t(i){let s;if(!re[i]||!(s=Yi(i)))return;const a=Xi[i];let r;if(a.size)a.delete(r=Array.from(a).shift());else if(r=Ot(s),!At(s,r+1))return;const n={cached:Math.floor(Date.now()/Ji),provider:o.provider,data:e};return Et(s,Oe+r.toString(),JSON.stringify(n))}e.lastModified&&!ma(o,e.lastModified)||Object.keys(e.icons).length&&(e.not_found&&(e=Object.assign({},e),delete e.not_found),t("local")||t("session"))}function is(){}function ya(o){o.iconsLoaderFlag||(o.iconsLoaderFlag=!0,setTimeout(()=>{o.iconsLoaderFlag=!1,na(o)}))}function wa(o,e){o.iconsToLoad?o.iconsToLoad=o.iconsToLoad.concat(e).sort():o.iconsToLoad=e,o.iconsQueueFlag||(o.iconsQueueFlag=!0,setTimeout(()=>{o.iconsQueueFlag=!1;const{provider:t,prefix:i}=o,s=o.iconsToLoad;delete o.iconsToLoad;let a;if(!s||!(a=xt(t)))return;a.prepare(t,i,s).forEach(n=>{Gi(t,n,l=>{if(typeof l!="object")n.icons.forEach(u=>{o.missing.add(u)});else try{const u=_t(o,l);if(!u.length)return;const b=o.pendingIcons;b&&u.forEach(g=>{b.delete(g)}),va(o,l)}catch(u){console.error(u)}ya(o)})})}))}const Lt=(o,e)=>{const t=ca(o,!0,Ri()),i=ra(t);if(!i.pending.length){let l=!0;return e&&setTimeout(()=>{l&&e(i.loaded,i.missing,i.pending,is)}),()=>{l=!1}}const s=Object.create(null),a=[];let r,n;return i.pending.forEach(l=>{const{provider:u,prefix:b}=l;if(b===n&&u===r)return;r=u,n=b,a.push(Q(u,b));const g=s[u]||(s[u]=Object.create(null));g[b]||(g[b]=[])}),i.pending.forEach(l=>{const{provider:u,prefix:b,name:g}=l,v=Q(u,b),y=v.pendingIcons||(v.pendingIcons=new Set);y.has(g)||(y.add(g),s[u][b].push(g))}),a.forEach(l=>{const{provider:u,prefix:b}=l;s[u][b].length&&wa(l,s[u][b])}),e?da(e,i,a):is},_a=o=>new Promise((e,t)=>{const i=typeof o=="string"?Se(o,!0):o;if(!i){t(o);return}Lt([i||o],s=>{if(s.length&&i){const a=Ee(i);if(a){e({...xe,...a});return}}t(o)})});function $a(o){try{const e=typeof o=="string"?JSON.parse(o):o;if(typeof e.body=="string")return{...e}}catch{}}function xa(o,e){const t=typeof o=="string"?Se(o,!0,!0):null;if(!t){const a=$a(o);return{value:o,data:a}}const i=Ee(t);if(i!==void 0||!t.prefix)return{value:o,name:t,data:i};const s=Lt([t],()=>e(o,t,Ee(t)));return{value:o,name:t,loading:s}}function Pt(o){return o.hasAttribute("inline")}let ss=!1;try{ss=navigator.vendor.indexOf("Apple")===0}catch{}function ka(o,e){switch(e){case"svg":case"bg":case"mask":return e}return e!=="style"&&(ss||o.indexOf("<a")===-1)?"svg":o.indexOf("currentColor")===-1?"bg":"mask"}const Sa=/(-?[0-9.]*[0-9]+[0-9.]*)/g,Ta=/^-?[0-9.]*[0-9]+[0-9.]*$/g;function It(o,e,t){if(e===1)return o;if(t=t||100,typeof o=="number")return Math.ceil(o*e*t)/t;if(typeof o!="string")return o;const i=o.split(Sa);if(i===null||!i.length)return o;const s=[];let a=i.shift(),r=Ta.test(a);for(;;){if(r){const n=parseFloat(a);isNaN(n)?s.push(a):s.push(Math.ceil(n*e*t)/t)}else s.push(a);if(a=i.shift(),a===void 0)return s.join("");r=!r}}function os(o,e){const t={...xe,...o},i={...Pi,...e},s={left:t.left,top:t.top,width:t.width,height:t.height};let a=t.body;[t,i].forEach(y=>{const $=[],C=y.hFlip,q=y.vFlip;let j=y.rotate;C?q?j+=2:($.push("translate("+(s.width+s.left).toString()+" "+(0-s.top).toString()+")"),$.push("scale(-1 1)"),s.top=s.left=0):q&&($.push("translate("+(0-s.left).toString()+" "+(s.height+s.top).toString()+")"),$.push("scale(1 -1)"),s.top=s.left=0);let L;switch(j<0&&(j-=Math.floor(j/4)*4),j=j%4,j){case 1:L=s.height/2+s.top,$.unshift("rotate(90 "+L.toString()+" "+L.toString()+")");break;case 2:$.unshift("rotate(180 "+(s.width/2+s.left).toString()+" "+(s.height/2+s.top).toString()+")");break;case 3:L=s.width/2+s.left,$.unshift("rotate(-90 "+L.toString()+" "+L.toString()+")");break}j%2===1&&(s.left!==s.top&&(L=s.left,s.left=s.top,s.top=L),s.width!==s.height&&(L=s.width,s.width=s.height,s.height=L)),$.length&&(a='<g transform="'+$.join(" ")+'">'+a+"</g>")});const r=i.width,n=i.height,l=s.width,u=s.height;let b,g;return r===null?(g=n===null?"1em":n==="auto"?u:n,b=It(g,l/u)):(b=r==="auto"?l:r,g=n===null?It(b,u/l):n==="auto"?u:n),{attributes:{width:b.toString(),height:g.toString(),viewBox:s.left.toString()+" "+s.top.toString()+" "+l.toString()+" "+u.toString()},body:a}}let We=(()=>{let o;try{if(o=fetch,typeof o=="function")return o}catch{}})();function Ea(o){We=o}function Aa(){return We}function Oa(o,e){const t=He(o);if(!t)return 0;let i;if(!t.maxURL)i=0;else{let s=0;t.resources.forEach(r=>{s=Math.max(s,r.length)});const a=e+".json?icons=";i=t.maxURL-s-t.path.length-a.length}return i}function Ca(o){return o===404}const La=(o,e,t)=>{const i=[],s=Oa(o,e),a="icons";let r={type:a,provider:o,prefix:e,icons:[]},n=0;return t.forEach((l,u)=>{n+=l.length+1,n>=s&&u>0&&(i.push(r),r={type:a,provider:o,prefix:e,icons:[]},n=l.length),r.icons.push(l)}),i.push(r),i};function Pa(o){if(typeof o=="string"){const e=He(o);if(e)return e.path}return"/"}const Ia={prepare:La,send:(o,e,t)=>{if(!We){t("abort",424);return}let i=Pa(e.provider);switch(e.type){case"icons":{const a=e.prefix,n=e.icons.join(","),l=new URLSearchParams({icons:n});i+=a+".json?"+l.toString();break}case"custom":{const a=e.uri;i+=a.slice(0,1)==="/"?a.slice(1):a;break}default:t("abort",400);return}let s=503;We(o+i).then(a=>{const r=a.status;if(r!==200){setTimeout(()=>{t(Ca(r)?"abort":"next",r)});return}return s=501,a.json()}).then(a=>{if(typeof a!="object"||a===null){setTimeout(()=>{a===404?t("abort",a):t("next",s)});return}setTimeout(()=>{t("success",a)})}).catch(()=>{t("next",s)})}};function as(o,e){switch(o){case"local":case"session":re[o]=e;break;case"all":for(const t in re)re[t]=e;break}}function rs(){Ui("",Ia),Ri(!0);let o;try{o=window}catch{}if(o){if(ts(),o.IconifyPreload!==void 0){const t=o.IconifyPreload,i="Invalid IconifyPreload syntax.";typeof t=="object"&&t!==null&&(t instanceof Array?t:[t]).forEach(s=>{try{(typeof s!="object"||s===null||s instanceof Array||typeof s.icons!="object"||typeof s.prefix!="string"||!qi(s))&&console.error(i)}catch{console.error(i)}})}if(o.IconifyProviders!==void 0){const t=o.IconifyProviders;if(typeof t=="object"&&t!==null)for(const i in t){const s="IconifyProviders["+i+"] is invalid.";try{const a=t[i];if(typeof a!="object"||!a||a.resources===void 0)continue;Bi(i,a)||console.error(s)}catch{console.error(s)}}}}return{enableCache:t=>as(t,!0),disableCache:t=>as(t,!1),iconExists:oa,getIcon:aa,listIcons:sa,addIcon:Ni,addCollection:qi,calculateSize:It,buildIcon:os,loadIcons:Lt,loadIcon:_a,addAPIProvider:Bi,_api:{getAPIConfig:He,setAPIModule:Ui,sendAPIQuery:Gi,setFetch:Ea,getFetch:Aa,listAPIProviders:pa}}}function ns(o,e){let t=o.indexOf("xlink:")===-1?"":' xmlns:xlink="http://www.w3.org/1999/xlink"';for(const i in e)t+=" "+i+'="'+e[i]+'"';return'<svg xmlns="http://www.w3.org/2000/svg"'+t+">"+o+"</svg>"}function Ma(o){return o.replace(/"/g,"'").replace(/%/g,"%25").replace(/#/g,"%23").replace(/</g,"%3C").replace(/>/g,"%3E").replace(/\s+/g," ")}function ja(o){return'url("data:image/svg+xml,'+Ma(o)+'")'}const Mt={"background-color":"currentColor"},ls={"background-color":"transparent"},ds={image:"var(--svg)",repeat:"no-repeat",size:"100% 100%"},cs={"-webkit-mask":Mt,mask:Mt,background:ls};for(const o in cs){const e=cs[o];for(const t in ds)e[o+"-"+t]=ds[t]}function us(o){return o+(o.match(/^[-0-9.]+$/)?"px":"")}function za(o,e,t){const i=document.createElement("span");let s=o.body;s.indexOf("<a")!==-1&&(s+="<!-- "+Date.now()+" -->");const a=o.attributes,r=ns(s,{...a,width:e.width+"",height:e.height+""}),n=ja(r),l=i.style,u={"--svg":n,width:us(a.width),height:us(a.height),...t?Mt:ls};for(const b in u)l.setProperty(b,u[b]);return i}function Da(o){const e=document.createElement("span");return e.innerHTML=ns(o.body,o.attributes),e.firstChild}function hs(o,e){const t=e.icon.data,i=e.customisations,s=os(t,i);i.preserveAspectRatio&&(s.attributes.preserveAspectRatio=i.preserveAspectRatio);const a=e.renderedMode;let r;switch(a){case"svg":r=Da(s);break;default:r=za(s,{...xe,...t},a==="mask")}const n=Array.from(o.childNodes).find(l=>{const u=l.tagName&&l.tagName.toUpperCase();return u==="SPAN"||u==="SVG"});n?r.tagName==="SPAN"&&n.tagName===r.tagName?n.setAttribute("style",r.getAttribute("style")):o.replaceChild(r,n):o.appendChild(r)}const jt="data-style";function ps(o,e){let t=Array.from(o.childNodes).find(i=>i.hasAttribute&&i.hasAttribute(jt));t||(t=document.createElement("style"),t.setAttribute(jt,jt),o.appendChild(t)),t.textContent=":host{display:inline-block;vertical-align:"+(e?"-0.125em":"0")+"}span,svg{display:block}"}function fs(o,e,t){const i=t&&(t.rendered?t:t.lastRender);return{rendered:!1,inline:e,icon:o,lastRender:i}}function Ra(o="iconify-icon"){let e,t;try{e=window.customElements,t=window.HTMLElement}catch{return}if(!e||!t)return;const i=e.get(o);if(i)return i;const s=["icon","mode","inline","width","height","rotate","flip"],a=class extends t{constructor(){super();Ye(this,"_shadowRoot");Ye(this,"_state");Ye(this,"_checkQueued",!1);const l=this._shadowRoot=this.attachShadow({mode:"open"}),u=Pt(this);ps(l,u),this._state=fs({value:""},u),this._queueCheck()}static get observedAttributes(){return s.slice(0)}attributeChangedCallback(l){if(l==="inline"){const u=Pt(this),b=this._state;u!==b.inline&&(b.inline=u,ps(this._shadowRoot,u))}else this._queueCheck()}get icon(){const l=this.getAttribute("icon");if(l&&l.slice(0,1)==="{")try{return JSON.parse(l)}catch{}return l}set icon(l){typeof l=="object"&&(l=JSON.stringify(l)),this.setAttribute("icon",l)}get inline(){return Pt(this)}set inline(l){this.setAttribute("inline",l?"true":null)}restartAnimation(){const l=this._state;if(l.rendered){const u=this._shadowRoot;if(l.renderedMode==="svg")try{u.lastChild.setCurrentTime(0);return}catch{}hs(u,l)}}get status(){const l=this._state;return l.rendered?"rendered":l.icon.data===null?"failed":"loading"}_queueCheck(){this._checkQueued||(this._checkQueued=!0,setTimeout(()=>{this._check()}))}_check(){if(!this._checkQueued)return;this._checkQueued=!1;const l=this._state,u=this.getAttribute("icon");if(u!==l.icon.value){this._iconChanged(u);return}if(!l.rendered)return;const b=this.getAttribute("mode"),g=Mi(this);(l.attrMode!==b||Jo(l.customisations,g))&&this._renderIcon(l.icon,g,b)}_iconChanged(l){const u=xa(l,(b,g,v)=>{const y=this._state;if(y.rendered||this.getAttribute("icon")!==b)return;const $={value:b,name:g,data:v};$.data?this._gotIconData($):y.icon=$});u.data?this._gotIconData(u):this._state=fs(u,this._state.inline,this._state)}_gotIconData(l){this._checkQueued=!1,this._renderIcon(l,Mi(this),this.getAttribute("mode"))}_renderIcon(l,u,b){const g=ka(l.data.body,b),v=this._state.inline;hs(this._shadowRoot,this._state={rendered:!0,icon:l,inline:v,customisations:u,attrMode:b,renderedMode:g})}};s.forEach(n=>{n in a.prototype||Object.defineProperty(a.prototype,n,{get:function(){return this.getAttribute(n)},set:function(l){this.setAttribute(n,l)}})});const r=rs();for(const n in r)a[n]=a.prototype[n]=r[n];return e.define(o,a),a}const Na=Ra()||rs(),{enableCache:Nn,disableCache:qn,iconExists:Fn,getIcon:Un,listIcons:Vn,addIcon:Bn,addCollection:Hn,calculateSize:Gn,buildIcon:Wn,loadIcons:Kn,loadIcon:Zn,addAPIProvider:Jn,_api:Qn}=Na;class bs extends N{static get styles(){return S`
      :root, .icon-container {
        font-size: inherit;
        color: inherit;
        display: inline-flex;
    ...
    `}}window.customElements.define("dt-icon",bs);class gs extends N{static get properties(){return{...super.properties,title:{type:String},isOpen:{type:Boolean},canEdit:{type:Boolean,state:!0},metadata:{type:Object},center:{type:Array},mapboxToken:{type:String,attribute:"mapbox-token"}}}static get styles(){return[S`
        .map {
          width: 100%;
          min-width: 50vw;
          min-height: 50dvb;
...
`}}window.customElements.define("dt-location-map-item",qa);class ms extends D{static get properties(){return{...super.properties,placeholder:{type:String},value:{type:Array,reflect:!0},locations:{type:Array,state:!0},open:{type:Boolean,state:!0},limit:{type:Number,attribute:"limit"},onchange:{type:String},mapboxToken:{type:String,attribute:"mapbox-token"},googleToken:{type:String,attribute:"google-token"}}}static get styles(){return[...super.styles,S`
        :host {
          font-family: Helvetica, Arial, sans-serif;
        }
        .input-group {
 ...
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ue=o=>o??E;class vs extends D{static get styles(){return[...super.styles,S`
        input {
          color: var(--dt-form-text-color, #000);
          appearance: none;
          background-color: var(--dt-form-background-color, #fff);
      ...
      />
    `}}window.customElements.define("dt-number",vs);class ys extends D{static get styles(){return[...super.styles,S`
        :host {
          position: relative;
        }
    ...
    `}}window.customElements.define("dt-exclamation-circle",Fa);class zt extends D{static get styles(){return[...super.styles,S`
        input {
          color: var(--dt-form-text-color, #000);
          appearance: none;
    ...
    `}}window.customElements.define("dt-text",zt);class ws extends D{static get styles(){return[...super.styles,S`
        textarea {
    ...
    `}}window.customElements.define("dt-textarea",ws);class _s extends D{static get styles(){return[...super.styles,S`
        :host {
          display: inline-block;
        }
 ...
 */function Ua(o,e,t){return o?e(o):t==null?void 0:t(o)}class $s extends zt{static get styles(){return[...super.styles,S`
    ...
    `}}window.customElements.define("dt-multi-text",$s);class xs extends D{static get styles(){return[...super.styles,S`
        :host {
          margin-bottom: 5px;
    ...
    `}}window.customElements.define("dt-multi-select-button-group",xs);class ks extends N{static get styles(){return S`
      :host {
        display: block;
      }
    ...
    `;return c`
      <div role="alert" class=${I(this.classes)}>
        <div>
          <slot></slot>
        </div>
        ${this.dismissable?c`
    ...
    `}}window.customElements.define("dt-alert",ks);class Ss extends N{static get styles(){return S`
      :host {
        --number-of-columns: 7;
    ...
    `}static get properties(){return{postType:{type:String},postTypeLabel:{type:String},posttypesettings:{type:Object,attribute:!0},posts:{type:Array},total:{type:Number},columns:{type:Array},sortedBy:{type:String},loading:{type:Boolean,default:!0},offset:{type:Number},showArchived:{type:Boolean,default:!1},showFieldsSelector:{type:Boolean,default:!1},showBulkEditSelector:{type:Boolean,default:!1},nonce:{type:String},payload:{type:Object},favorite:{type:Boolean},initialLoadPost:{type:Boolean,default:!1},loadMore:{type:Boolean,default:!1},headerClick:{type:Boolean,default:!1}}}constructor(){super(),this.sortedBy="name",this.payload={sort:this.sortedBy,overall_status:["-closed"],fields_to_return:this.sortedColumns},this.initalLoadPost=!1,this.initalLoadPost||(this.posts=[],this.limit=100)}firstUpdated(){this.postTypeSettings=window.post_type_fields,this.sortedColumns=this.columns.includes("favorite")?["favorite",...this.columns.filter(e=>e!=="favorite")]:this.columns,this.style.setProperty("--number-of-columns",this.columns.length-1)}async _getPosts(e){const t=await new CustomEvent("dt:get-data",{bubbles:!0,detail:{field:this.name,postType:this.postType,query:e,onSuccess:i=>{this.initalLoadPost&&this.loadMore&&(this.posts=[...this.posts,...i],this.postsLength=this.posts.length,this.total=i.length,this.loadMore=!1),this.initalLoadPost||(this.posts=[...i],this.offset=this.posts.length,this.initalLoadPost=!0,this.total=i.length),this.headerClick&&(this.posts=i,this.offset=this.posts.length,this.headerClick=!1),this.total=i.length},onError:i=>{console.warn(i)}}});this.dispatchEvent(t)}_headerClick(e){const t=e.target.dataset.id;this.sortedBy===t?t.startsWith("-")?this.sortedBy=t.replace("-",""):this.sortedBy=`-${t}`:this.sortedBy=t,this.payload={sort:this.sortedBy,overall_status:["-closed"],limit:this.limit,fields_to_return:this.columns},this.headerClick=!0,this._getPosts(this.payload)}static _rowClick(e){window.open(e,"_self")}_bulkEdit(){this.showBulkEditSelector=!this.showBulkEditSelector}_fieldsEdit(){this.showFieldsSelector=!this.showFieldsSelector}_toggleShowArchived(){if(this.showArchived=!this.showArchived,this.headerClick=!0,this.showArchived){const{overall_status:e,offset:t,...i}=this.payload;this.payload=i}else this.payload.overall_status=["-closed"];this._getPosts(this.payload)}_sortArrowsClass(e){return this.sortedBy===e?"sortedBy":""}_sortArrowsToggle(e){return this.sortedBy!==`-${e}`?`-${e}`:e}_headerTemplate(){return this.postTypeSettings?c`
        <thead>
          <tr>
            ...
            ${Ne(this.sortedColumns,e=>{const t=e==="favorite";return c`<th
                class="all"
      ...
      `:null}_rowTemplate(){if(this.posts&&Array.isArray(this.posts)){const e=this.posts.map((t,i)=>this.showArchived||!this.showArchived&&t.overall_status!=="closed"?c`
            ...
            `:null).filter(t=>t!==null);return e.length>0?e:c`<p>No contacts available</p>`}return null}formatDate(e){const t=new Date(e);return new Intl.DateTimeFormat("en-US",{month:"long",day:"numeric",year:"numeric"}).format(t)}_cellTemplate(e){return Ne(this.sortedColumns,t=>{if(["text","textarea","number"].includes(this.postTypeSettings[t].type))return c` <td
          dir="auto"
        ...
        >
          ...
          >
            ...
            >
              <svg
                class="${I({"icon-star":!0,selected:e.favorite})}"
                height="15"
                viewBox="0 0 32 32"
              >
                <path
      ...
      />`:null}_fieldsListTemplate(){return _e(Object.keys(this.postTypeSettings).sort((e,t)=>{const i=this.postTypeSettings[e].name.toUpperCase(),s=this.postTypeSettings[t].name.toUpperCase();return i<s?-1:i>s?1:0}),e=>e,e=>this.postTypeSettings[e].hidden?null:c`<li class="list-field-picker-item">
            <label>
              <input
                type="checkbox"
                id="${e}"
    ...
    `,i=c`<svg height='100px' width='100px'  fill="#000000" xmlns:x="http://ns.adobe.com/Extensibility/1.0/" xmlns:i="http://ns.adobe.com/AdobeIllustrator/10.0/" xmlns:graph="http://ns.adobe.com/Graphs/1.0/" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 100 100" style="enable-background:new 0 0 100 100;" xml:space="preserve"><g><g i:extraneous="self"><g><path d="M94.4,63c0-5.7-3.6-10.5-8.6-12.5V7.3c0-2.7-2.2-4.8-4.8-4.8c-2.7,0-4.8,2.2-4.8,4.8v43.2c-5,1.9-8.6,6.8-8.6,12.5     s3.6,10.5,8.6,12.5v17.2c0,2.7,2.2,4.8,4.8,4.8c2.7,0,4.8-2.2,4.8-4.8V75.5C90.9,73.6,94.4,68.7,94.4,63z M81,66.7     c-2,0-3.7-1.7-3.7-3.7c0-2,1.7-3.7,3.7-3.7s3.7,1.7,3.7,3.7C84.7,65.1,83.1,66.7,81,66.7z"></path><path d="M54.8,24.5V7.3c0-2.7-2.2-4.8-4.8-4.8c-2.7,0-4.8,2.2-4.8,4.8v17.2c-5,1.9-8.6,6.8-8.6,12.5s3.6,10.5,8.6,12.5v43.2     c0,2.7,2.2,4.8,4.8,4.8c2.7,0,4.8-2.2,4.8-4.8V49.5c5-1.9,8.6-6.8,8.6-12.5S59.8,26.5,54.8,24.5z M50,40.7c-2,0-3.7-1.7-3.7-3.7     c0-2,1.7-3.7,3.7-3.7c2,0,3.7,1.7,3.7,3.7C53.7,39.1,52,40.7,50,40.7z"></path><path d="M23.8,50.5V7.3c0-2.7-2.2-4.8-4.8-4.8c-2.7,0-4.8,2.2-4.8,4.8v43.2c-5,1.9-8.6,6.8-8.6,12.5s3.6,10.5,8.6,12.5v17.2     c0,2.7,2.2,4.8,4.8,4.8c2.7,0,4.8-2.2,4.8-4.8V75.5c5-1.9,8.6-6.8,8.6-12.5S28.8,52.5,23.8,50.5z M19,66.7c-2,0-3.7-1.7-3.7-3.7     c0-2,1.7-3.7,3.7-3.7c2,0,3.7,1.7,3.7,3.7C22.7,65.1,21,66.7,19,66.7z"></path></g></g></g></svg>`;return c`
      <div class="section">
        ...
        <table class="table-contacts ${I(e)}">
    ...
    `}}window.customElements.define("dt-list",Ss);class Ts extends N{static get styles(){return S`
      :host {
