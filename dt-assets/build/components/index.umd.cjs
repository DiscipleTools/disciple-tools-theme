 ...
 */function Y(o,e,t){return o?e(o):t==null?void 0:t(o)}class xs extends Ft{static get styles(){return[...super.styles,x`
    ...
    `}}customElements.define("dt-file-upload",Ss);class Es extends N{static get styles(){return x`
      :host {
        display: block;
      }
