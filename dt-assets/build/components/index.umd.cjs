(function(_,P){typeof exports=="object"&&typeof module<"u"?P(exports):typeof define=="function"&&define.amd?define(["exports"],P):(_=typeof globalThis<"u"?globalThis:_||self,P(_.DtWebComponents={}))})(this,function(_){"use strict";var Mr=Object.defineProperty;var jr=(_,P,W)=>P in _?Mr(_,P,{enumerable:!0,configurable:!0,writable:!0,value:W}):_[P]=W;var Me=(_,P,W)=>jr(_,typeof P!="symbol"?P+"":P,W);/**
 * @license
 ...
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const q=o=>o??A;class j extends R{static get formAssociated(){return!0}static get styles(){return[x`
        .input-group {
          position: relative;
        }
 ...
 */const ds=(o,e,t)=>{const i=new Map;for(let s=e;s<=t;s++)i.set(o[s],s);return i},de=ht(class extends pt{constructor(o){if(super(o),o.type!==ut.CHILD)throw Error("repeat() can only be used in text expressions")}dt(o,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const s=[],a=[];let n=0;for(const r of o)s[n]=i?i(r,n):n,a[n]=t(r,n),n++;return{values:a,keys:s}}render(o,e,t){return this.dt(o,e,t).values}update(o,[e,t,i]){const s=Fa(o),{values:a,keys:n}=this.dt(e,t,i);if(!Array.isArray(s))return this.ut=n,a;const r=this.ut??(this.ut=[]),l=[];let d,h,g=0,m=s.length-1,y=0,w=a.length-1;for(;g<=m&&y<=w;)if(s[g]===null)g++;else if(s[m]===null)m--;else if(r[g]===n[y])l[y]=le(s[g],a[y]),g++,y++;else if(r[m]===n[w])l[w]=le(s[m],a[w]),m--,w--;else if(r[g]===n[w])l[w]=le(s[g],a[w]),Oe(o,l[w+1],s[g]),g++,w--;else if(r[m]===n[y])l[y]=le(s[m],a[y]),Oe(o,s[g],s[m]),m--,y++;else if(d===void 0&&(d=ds(n,y,w),h=ds(r,g,m)),d.has(r[g]))if(d.has(r[m])){const L=h.get(n[y]),N=L!==void 0?s[L]:null;if(N===null){const z=Oe(o,s[g]);le(z,a[y]),l[y]=z}else l[y]=le(N,a[y]),Oe(o,s[g],N),s[L]=null;y++}else zt(s[m]),m--;else zt(s[g]),g++;for(;y<=w;){const L=Oe(o,l[w+1]);le(L,a[y]),l[y++]=L}for(;g<=m;){const L=s[g++];L!==null&&zt(L)}return this.ut=n,za(o,l),V}}),Da=o=>class extends o{constructor(){super(),this.activeIndex=-1,this.filteredOptions=[],this.detectTap=!1}static get properties(){return{...super.properties,value:{type:Array,reflect:!0},query:{type:String,state:!0},options:{type:Array},filteredOptions:{type:Array,state:!0},open:{type:Boolean,state:!0},canUpdate:{type:Boolean,state:!0},activeIndex:{type:Number,state:!0},containerHeight:{type:Number,state:!0},loading:{type:Boolean}}}willUpdate(e){if(super.willUpdate(e),e&&!this.containerHeight&&this.shadowRoot.children&&this.shadowRoot.children.length){const t=this.shadowRoot.querySelector(".input-group");t&&(this.containerHeight=t.offsetHeight)}}updated(){this._scrollOptionListToActive();const e=this.shadowRoot.querySelector(".input-group");!e.style.getPropertyValue("--container-width")&&e.clientWidth>0&&e.style.setProperty("--container-width",`${e.clientWidth}px`)}_select(){console.error("Must implement `_select(value)` function"),this._clearSearch()}static _focusInput(e){e.target===e.currentTarget&&e.target.getElementsByTagName("input")[0].focus()}_inputFocusIn(e){(!e.relatedTarget||!["BUTTON","LI"].includes(e.relatedTarget.nodeName))&&(this.open=!0,this.activeIndex=-1)}_inputFocusOut(e){(!e.relatedTarget||!["BUTTON","LI"].includes(e.relatedTarget.nodeName))&&(this.open=!1,this.canUpdate=!0)}_inputKeyDown(e){}_inputKeyUp(e){switch(e.keyCode||e.which){case 38:this.open=!0,this._listHighlightPrevious();break;case 40:this.open=!0,this._listHighlightNext();break;case 9:this.activeIndex<0?this.open=!1:e.preventDefault(),this._keyboardSelectOption();break;case 13:this._keyboardSelectOption();break;case 27:this.open=!1,this.activeIndex=-1;break;default:this.open=!0,this.query=e.target.value;break}}_scrollOptionListToActive(){const e=this.shadowRoot.querySelector(".option-list"),t=this.shadowRoot.querySelector("button.active");if(e&&t){const i=t.offsetTop,s=t.offsetTop+t.clientHeight,a=e.scrollTop,n=e.scrollTop+e.clientHeight;s>n?e.scrollTo({top:s-e.clientHeight,behavior:"smooth"}):i<a&&e.scrollTo({top:i,behavior:"smooth"})}}_touchStart(e){e.target&&(this.detectTap=!1)}_touchMove(e){e.target&&(this.detectTap=!0)}_touchEnd(e){this.detectTap||(e.target&&e.target.value&&this._clickOption(e),this.detectTap=!1)}_keyboardSelectOption(){this.activeIndex>-1&&(this.activeIndex+1>this.filteredOptions.length?this._select(this.query):this._select(this.filteredOptions[this.activeIndex].id))}_clickOption(e){e.target&&e.target.value&&this._select(e.target.value)}_clickAddNew(e){var t;e.target&&this._select((t=e.target.dataset)==null?void 0:t.label)}_clearSearch(){const e=this.shadowRoot.querySelector("input");e&&(e.value="")}_listHighlightNext(){this.allowAdd?this.activeIndex=Math.min(this.filteredOptions.length,this.activeIndex+1):this.activeIndex=Math.min(this.filteredOptions.length-1,this.activeIndex+1)}_listHighlightPrevious(){this.activeIndex=Math.max(0,this.activeIndex-1)}_renderOption(e,t){return u`
    ...
    `}_baseRenderOptions(){return this.filteredOptions.length?de(this.filteredOptions,e=>e.id,(e,t)=>this._renderOption(e,t)):this.loading?u`<li><div>${O("Loading options...")}</div></li>`:u`<li><div>${O("No Data Available")}</div></li>`}_renderOptions(){let e=this._baseRenderOptions();return this.allowAdd&&this.query&&(Array.isArray(e)||(e=[e]),e.push(u`<li tabindex="-1">
      ...
      </li>`)),e}};class Ze extends Da(j){static get styles(){return[...super.styles,x`
        :host {
          position: relative;
    ...
    `}}window.customElements.define("dt-copy-text",fs);class Ft extends j{static get styles(){return[...super.styles,x`
        input {
          color: var(--dt-form-text-color, #000);
          appearance: none;
 ...
 */function*Je(o,e){if(o!==void 0){let t=0;for(const i of o)yield e(i,t++)}}class gs extends Ce{static get properties(){return{...super.properties,filters:{type:Array}}}static get styles(){return[...super.styles,x`
    ...
    `}}window.customElements.define("dt-location-map",ys);class ws extends j{static get styles(){return[...super.styles,x`
        input {
          color: var(--dt-form-text-color, #000);
          appearance: none;
          background-color: var(--dt-form-background-color, #fff);
    ...
    `}}window.customElements.define("dt-number",ws);class _s extends j{static get styles(){return[...super.styles,x`
        :host {
          position: relative;
        }
    ...
    `}}window.customElements.define("dt-single-select",_s);class Dt extends j{static get styles(){return[...super.styles,x`
        input {
          color: var(--dt-form-text-color, #000);
          appearance: none;
    ...
    `}}window.customElements.define("dt-text",Dt);class $s extends j{static get styles(){return[...super.styles,x`
        textarea {
 ...
 */function Y(o,e,t){return o?e(o):t==null?void 0:t(o)}class xs extends Dt{static get styles(){return[...super.styles,x`
    ...
    `}}window.customElements.define("dt-alert",Es);class Ts extends R{static get styles(){return x`
      :host {
        --number-of-columns: 7;
    ...
    `}}window.customElements.define("dt-list",Ts);class As extends R{static get styles(){return x`
      :host {
