...
*/const $i=Object.freeze({left:0,top:0,width:16,height:16}),qe=Object.freeze({rotate:0,vFlip:!1,hFlip:!1}),$e=Object.freeze({...$i,...qe}),gt=Object.freeze({...$e,body:"",hidden:!1}),Ds=Object.freeze({width:null,height:null}),xi=Object.freeze({...Ds,...qe});function zs(s,e=0){const t=s.replace(/^-?[0-9.]*/,"");function i(o){for(;o<0;)o+=4;return o%4}if(t===""){const o=parseInt(s);return isNaN(o)?0:i(o)}else if(t!==s){let o=0;switch(t){case"%":o=25;break;case"deg":o=90}if(o){let a=parseFloat(s.slice(0,s.length-t.length));return isNaN(a)?0:(a=a/o,a%1===0?i(a):0)}}return e}const Rs=/[\s,]+/;function Ns(s,e){e.split(Rs).forEach(t=>{switch(t.trim()){case"horizontal":s.hFlip=!0;break;case"vertical":s.vFlip=!0;break}})}const ki={...xi,preserveAspectRatio:""};function Si(s){const e={...ki},t=(i,o)=>s.getAttribute(i)||o;return e.width=t("width",null),e.height=t("height",null),e.rotate=zs(t("rotate","")),Ns(e,t("flip","")),e.preserveAspectRatio=t("preserveAspectRatio",t("preserveaspectratio","")),e}function qs(s,e){for(const t in ki)if(s[t]!==e[t])return!0;return!1}const xe=/^[a-z0-9]+(-[a-z0-9]+)*$/,ke=(s,e,t,i="")=>{const o=s.split(":");if(s.slice(0,1)==="@"){if(o.length<2||o.length>3)return null;i=o.shift().slice(1)}if(o.length>3||!o.length)return null;if(o.length>1){const r=o.pop(),l=o.pop(),d={provider:o.length>0?o[0]:i,prefix:l,name:r};return e&&!Ue(d)?null:d}const a=o[0],n=a.split("-");if(n.length>1){const r={provider:i,prefix:n.shift(),name:n.join("-")};return e&&!Ue(r)?null:r}if(t&&i===""){const r={provider:i,prefix:"",name:a};return e&&!Ue(r,t)?null:r}return null},Ue=(s,e)=>s?!!((s.provider===""||s.provider.match(xe))&&(e&&s.prefix===""||s.prefix.match(xe))&&s.name.match(xe)):!1;function Us(s,e){const t={};!s.hFlip!=!e.hFlip&&(t.hFlip=!0),!s.vFlip!=!e.vFlip&&(t.vFlip=!0);const i=((s.rotate||0)+(e.rotate||0))%4;return i&&(t.rotate=i),t}function Ei(s,e){const t=Us(s,e);for(const i in gt)i in qe?i in s&&!(i in t)&&(t[i]=qe[i]):i in e?t[i]=e[i]:i in s&&(t[i]=s[i]);return t}function Vs(s,e){const t=s.icons,i=s.aliases||Object.create(null),o=Object.create(null);function a(n){if(t[n])return o[n]=[];if(!(n in o)){o[n]=null;const r=i[n]&&i[n].parent,l=r&&a(r);l&&(o[n]=[r].concat(l))}return o[n]}return Object.keys(t).concat(Object.keys(i)).forEach(a),o}function Bs(s,e,t){const i=s.icons,o=s.aliases||Object.create(null);let a={};function n(r){a=Ei(i[r]||o[r],a)}return n(e),t.forEach(n),Ei(s,a)}function Ai(s,e){const t=[];if(typeof s!="object"||typeof s.icons!="object")return t;s.not_found instanceof Array&&s.not_found.forEach(o=>{e(o,null),t.push(o)});const i=Vs(s);for(const o in i){const a=i[o];a&&(e(o,Bs(s,o,a)),t.push(o))}return t}const Hs={provider:"",aliases:{},not_found:{},...$i};function vt(s,e){for(const t in e)if(t in s&&typeof s[t]!=typeof e[t])return!1;return!0}function Oi(s){if(typeof s!="object"||s===null)return null;const e=s;if(typeof e.prefix!="string"||!s.icons||typeof s.icons!="object"||!vt(s,Hs))return null;const t=e.icons;for(const o in t){const a=t[o];if(!o.match(xe)||typeof a.body!="string"||!vt(a,gt))return null}const i=e.aliases||Object.create(null);for(const o in i){const a=i[o],n=a.parent;if(!o.match(xe)||typeof n!="string"||!t[n]&&!i[n]||!vt(a,gt))return null}return e}const Ve=Object.create(null);function Ks(s,e){return{provider:s,prefix:e,icons:Object.create(null),missing:new Set}}function Y(s,e){const t=Ve[s]||(Ve[s]=Object.create(null));return t[e]||(t[e]=Ks(s,e))}function yt(s,e){return Oi(e)?Ai(e,(t,i)=>{i?s.icons[t]=i:s.missing.add(t)}):[]}function Gs(s,e,t){try{if(typeof t.body=="string")return s.icons[e]={...t},!0}catch{}return!1}function Ws(s,e){let t=[];return(typeof s=="string"?[s]:Object.keys(Ve)).forEach(o=>{(typeof o=="string"&&typeof e=="string"?[e]:Object.keys(Ve[o]||{})).forEach(n=>{const r=Y(o,n);t=t.concat(Object.keys(r.icons).map(l=>(o!==""?"@"+o+":":"")+n+":"+l))})}),t}let Se=!1;function Ti(s){return typeof s=="boolean"&&(Se=s),Se}function Ee(s){const e=typeof s=="string"?ke(s,!0,Se):s;if(e){const t=Y(e.provider,e.prefix),i=e.name;return t.icons[i]||(t.missing.has(i)?null:void 0)}}function Ci(s,e){const t=ke(s,!0,Se);if(!t)return!1;const i=Y(t.provider,t.prefix);return Gs(i,t.name,e)}function Ii(s,e){if(typeof s!="object")return!1;if(typeof e!="string"&&(e=s.provider||""),Se&&!e&&!s.prefix){let o=!1;return Oi(s)&&(s.prefix="",Ai(s,(a,n)=>{n&&Ci(a,n)&&(o=!0)})),o}const t=s.prefix;if(!Ue({provider:e,prefix:t,name:"a"}))return!1;const i=Y(e,t);return!!yt(i,s)}function Zs(s){return!!Ee(s)}function Js(s){const e=Ee(s);return e?{...$e,...e}:null}function Qs(s){const e={loaded:[],missing:[],pending:[]},t=Object.create(null);s.sort((o,a)=>o.provider!==a.provider?o.provider.localeCompare(a.provider):o.prefix!==a.prefix?o.prefix.localeCompare(a.prefix):o.name.localeCompare(a.name));let i={provider:"",prefix:"",name:""};return s.forEach(o=>{if(i.name===o.name&&i.prefix===o.prefix&&i.provider===o.provider)return;i=o;const a=o.provider,n=o.prefix,r=o.name,l=t[a]||(t[a]=Object.create(null)),d=l[n]||(l[n]=Y(a,n));let h;r in d.icons?h=e.loaded:n===""||d.missing.has(r)?h=e.missing:h=e.pending;const p={provider:a,prefix:n,name:r};h.push(p)}),e}function Li(s,e){s.forEach(t=>{const i=t.loaderCallbacks;i&&(t.loaderCallbacks=i.filter(o=>o.id!==e))})}function Xs(s){s.pendingCallbacksFlag||(s.pendingCallbacksFlag=!0,setTimeout(()=>{s.pendingCallbacksFlag=!1;const e=s.loaderCallbacks?s.loaderCallbacks.slice(0):[];if(!e.length)return;let t=!1;const i=s.provider,o=s.prefix;e.forEach(a=>{const n=a.icons,r=n.pending.length;n.pending=n.pending.filter(l=>{if(l.prefix!==o)return!0;const d=l.name;if(s.icons[d])n.loaded.push({provider:i,prefix:o,name:d});else if(s.missing.has(d))n.missing.push({provider:i,prefix:o,name:d});else return t=!0,!0;return!1}),n.pending.length!==r&&(t||Li([s],a.id),a.callback(n.loaded.slice(0),n.missing.slice(0),n.pending.slice(0),a.abort))})}))}let Ys=0;function ea(s,e,t){const i=Ys++,o=Li.bind(null,t,i);if(!e.pending.length)return o;const a={id:i,icons:e,callback:s,abort:o};return t.forEach(n=>{(n.loaderCallbacks||(n.loaderCallbacks=[])).push(a)}),o}const wt=Object.create(null);function Pi(s,e){wt[s]=e}function _t(s){return wt[s]||wt[""]}function ta(s,e=!0,t=!1){const i=[];return s.forEach(o=>{const a=typeof o=="string"?ke(o,e,t):o;a&&i.push(a)}),i}var ia={resources:[],index:0,timeout:2e3,rotate:750,random:!1,dataAfterTimeout:!1};function oa(s,e,t,i){const o=s.resources.length,a=s.random?Math.floor(Math.random()*o):s.index;let n;if(s.random){let A=s.resources.slice(0);for(n=[];A.length>1;){const D=Math.floor(Math.random()*A.length);n.push(A[D]),A=A.slice(0,D).concat(A.slice(D+1))}n=n.concat(A)}else n=s.resources.slice(a).concat(s.resources.slice(0,a));const r=Date.now();let l="pending",d=0,h,p=null,g=[],y=[];typeof i=="function"&&y.push(i);function w(){p&&(clearTimeout(p),p=null)}function E(){l==="pending"&&(l="aborted"),w(),g.forEach(A=>{A.status==="pending"&&(A.status="aborted")}),g=[]}function z(A,D){D&&(y=[]),typeof A=="function"&&y.push(A)}function j(){return{startTime:r,payload:e,status:l,queriesSent:d,queriesPending:g.length,subscribe:z,abort:E}}function I(){l="failed",y.forEach(A=>{A(void 0,h)})}function Le(){g.forEach(A=>{A.status==="pending"&&(A.status="aborted")}),g=[]}function Je(A,D,ce){const te=D!=="success";switch(g=g.filter(P=>P!==A),l){case"pending":break;case"failed":if(te||!s.dataAfterTimeout)return;break;default:return}if(D==="abort"){h=ce,I();return}if(te){h=ce,g.length||(n.length?ee():I());return}if(w(),Le(),!s.random){const P=s.resources.indexOf(A.resource);P!==-1&&P!==s.index&&(s.index=P)}l="completed",y.forEach(P=>{P(ce)})}function ee(){if(l!=="pending")return;w();const A=n.shift();if(A===void 0){if(g.length){p=setTimeout(()=>{w(),l==="pending"&&(Le(),I())},s.timeout);return}I();return}const D={status:"pending",resource:A,callback:(ce,te)=>{Je(D,ce,te)}};g.push(D),d++,p=setTimeout(ee,s.rotate),t(A,e,D.callback)}return setTimeout(ee),j}function Mi(s){const e={...ia,...s};let t=[];function i(){t=t.filter(r=>r().status==="pending")}function o(r,l,d){const h=oa(e,r,l,(p,g)=>{i(),d&&d(p,g)});return t.push(h),h}function a(r){return t.find(l=>r(l))||null}return{query:o,find:a,setIndex:r=>{e.index=r},getIndex:()=>e.index,cleanup:i}}function $t(s){let e;if(typeof s.resources=="string")e=[s.resources];else if(e=s.resources,!(e instanceof Array)||!e.length)return null;return{resources:e,path:s.path||"/",maxURL:s.maxURL||500,rotate:s.rotate||750,timeout:s.timeout||5e3,random:s.random===!0,index:s.index||0,dataAfterTimeout:s.dataAfterTimeout!==!1}}const Be=Object.create(null),Ae=["https://api.simplesvg.com","https://api.unisvg.com"],He=[];for(;Ae.length>0;)Ae.length===1||Math.random()>.5?He.push(Ae.shift()):He.push(Ae.pop());Be[""]=$t({resources:["https://api.iconify.design"].concat(He)});function ji(s,e){const t=$t(e);return t===null?!1:(Be[s]=t,!0)}function Ke(s){return Be[s]}function sa(){return Object.keys(Be)}function Fi(){}const xt=Object.create(null);function aa(s){if(!xt[s]){const e=Ke(s);if(!e)return;const t=Mi(e),i={config:e,redundancy:t};xt[s]=i}return xt[s]}function Di(s,e,t){let i,o;if(typeof s=="string"){const a=_t(s);if(!a)return t(void 0,424),Fi;o=a.send;const n=aa(s);n&&(i=n.redundancy)}else{const a=$t(s);if(a){i=Mi(a);const n=s.resources?s.resources[0]:"",r=_t(n);r&&(o=r.send)}}return!i||!o?(t(void 0,424),Fi):i.query(e,o,t)().abort}const zi="iconify2",Oe="iconify",Ri=Oe+"-count",Ni=Oe+"-version",qi=36e5,na=168;function kt(s,e){try{return s.getItem(e)}catch{}}function St(s,e,t){try{return s.setItem(e,t),!0}catch{}}function Ui(s,e){try{s.removeItem(e)}catch{}}function Et(s,e){return St(s,Ri,e.toString())}function At(s){return parseInt(kt(s,Ri))||0}const re={local:!0,session:!0},Vi={local:new Set,session:new Set};let Ot=!1;function ra(s){Ot=s}let Ge=typeof window>"u"?{}:window;function Bi(s){const e=s+"Storage";try{if(Ge&&Ge[e]&&typeof Ge[e].length=="number")return Ge[e]}catch{}re[s]=!1}function Hi(s,e){const t=Bi(s);if(!t)return;const i=kt(t,Ni);if(i!==zi){if(i){const r=At(t);for(let l=0;l<r;l++)Ui(t,Oe+l.toString())}St(t,Ni,zi),Et(t,0);return}const o=Math.floor(Date.now()/qi)-na,a=r=>{const l=Oe+r.toString(),d=kt(t,l);if(typeof d=="string"){try{const h=JSON.parse(d);if(typeof h=="object"&&typeof h.cached=="number"&&h.cached>o&&typeof h.provider=="string"&&typeof h.data=="object"&&typeof h.data.prefix=="string"&&e(h,r))return!0}catch{}Ui(t,l)}};let n=At(t);for(let r=n-1;r>=0;r--)a(r)||(r===n-1?(n--,Et(t,n)):Vi[s].add(r))}function Ki(){if(!Ot){ra(!0);for(const s in re)Hi(s,e=>{const t=e.data,i=e.provider,o=t.prefix,a=Y(i,o);if(!yt(a,t).length)return!1;const n=t.lastModified||-1;return a.lastModifiedCached=a.lastModifiedCached?Math.min(a.lastModifiedCached,n):n,!0})}}function la(s,e){const t=s.lastModifiedCached;if(t&&t>=e)return t===e;if(s.lastModifiedCached=e,t)for(const i in re)Hi(i,o=>{const a=o.data;return o.provider!==s.provider||a.prefix!==s.prefix||a.lastModified===e});return!0}function da(s,e){Ot||Ki();function t(i){let o;if(!re[i]||!(o=Bi(i)))return;const a=Vi[i];let n;if(a.size)a.delete(n=Array.from(a).shift());else if(n=At(o),!Et(o,n+1))return;const r={cached:Math.floor(Date.now()/qi),provider:s.provider,data:e};return St(o,Oe+n.toString(),JSON.stringify(r))}e.lastModified&&!la(s,e.lastModified)||Object.keys(e.icons).length&&(e.not_found&&(e=Object.assign({},e),delete e.not_found),t("local")||t("session"))}function Gi(){}function ca(s){s.iconsLoaderFlag||(s.iconsLoaderFlag=!0,setTimeout(()=>{s.iconsLoaderFlag=!1,Xs(s)}))}function ua(s,e){s.iconsToLoad?s.iconsToLoad=s.iconsToLoad.concat(e).sort():s.iconsToLoad=e,s.iconsQueueFlag||(s.iconsQueueFlag=!0,setTimeout(()=>{s.iconsQueueFlag=!1;const{provider:t,prefix:i}=s,o=s.iconsToLoad;delete s.iconsToLoad;let a;if(!o||!(a=_t(t)))return;a.prepare(t,i,o).forEach(r=>{Di(t,r,l=>{if(typeof l!="object")r.icons.forEach(d=>{s.missing.add(d)});else try{const d=yt(s,l);if(!d.length)return;const h=s.pendingIcons;h&&d.forEach(p=>{h.delete(p)}),da(s,l)}catch(d){console.error(d)}ca(s)})})}))}const Tt=(s,e)=>{const t=ta(s,!0,Ti()),i=Qs(t);if(!i.pending.length){let l=!0;return e&&setTimeout(()=>{l&&e(i.loaded,i.missing,i.pending,Gi)}),()=>{l=!1}}const o=Object.create(null),a=[];let n,r;return i.pending.forEach(l=>{const{provider:d,prefix:h}=l;if(h===r&&d===n)return;n=d,r=h,a.push(Y(d,h));const p=o[d]||(o[d]=Object.create(null));p[h]||(p[h]=[])}),i.pending.forEach(l=>{const{provider:d,prefix:h,name:p}=l,g=Y(d,h),y=g.pendingIcons||(g.pendingIcons=new Set);y.has(p)||(y.add(p),o[d][h].push(p))}),a.forEach(l=>{const{provider:d,prefix:h}=l;o[d][h].length&&ua(l,o[d][h])}),e?ea(e,i,a):Gi},ha=s=>new Promise((e,t)=>{const i=typeof s=="string"?ke(s,!0):s;if(!i){t(s);return}Tt([i||s],o=>{if(o.length&&i){const a=Ee(i);if(a){e({...$e,...a});return}}t(s)})});function pa(s){try{const e=typeof s=="string"?JSON.parse(s):s;if(typeof e.body=="string")return{...e}}catch{}}function fa(s,e){const t=typeof s=="string"?ke(s,!0,!0):null;if(!t){const a=pa(s);return{value:s,data:a}}const i=Ee(t);if(i!==void 0||!t.prefix)return{value:s,name:t,data:i};const o=Tt([t],()=>e(s,t,Ee(t)));return{value:s,name:t,loading:o}}function Ct(s){return s.hasAttribute("inline")}let Wi=!1;try{Wi=navigator.vendor.indexOf("Apple")===0}catch{}function ba(s,e){switch(e){case"svg":case"bg":case"mask":return e}return e!=="style"&&(Wi||s.indexOf("<a")===-1)?"svg":s.indexOf("currentColor")===-1?"bg":"mask"}const ma=/(-?[0-9.]*[0-9]+[0-9.]*)/g,ga=/^-?[0-9.]*[0-9]+[0-9.]*$/g;function It(s,e,t){if(e===1)return s;if(t=t||100,typeof s=="number")return Math.ceil(s*e*t)/t;if(typeof s!="string")return s;const i=s.split(ma);if(i===null||!i.length)return s;const o=[];let a=i.shift(),n=ga.test(a);for(;;){if(n){const r=parseFloat(a);isNaN(r)?o.push(a):o.push(Math.ceil(r*e*t)/t)}else o.push(a);if(a=i.shift(),a===void 0)return o.join("");n=!n}}function Zi(s,e){const t={...$e,...s},i={...xi,...e},o={left:t.left,top:t.top,width:t.width,height:t.height};let a=t.body;[t,i].forEach(y=>{const w=[],E=y.hFlip,z=y.vFlip;let j=y.rotate;E?z?j+=2:(w.push("translate("+(o.width+o.left).toString()+" "+(0-o.top).toString()+")"),w.push("scale(-1 1)"),o.top=o.left=0):z&&(w.push("translate("+(0-o.left).toString()+" "+(o.height+o.top).toString()+")"),w.push("scale(1 -1)"),o.top=o.left=0);let I;switch(j<0&&(j-=Math.floor(j/4)*4),j=j%4,j){case 1:I=o.height/2+o.top,w.unshift("rotate(90 "+I.toString()+" "+I.toString()+")");break;case 2:w.unshift("rotate(180 "+(o.width/2+o.left).toString()+" "+(o.height/2+o.top).toString()+")");break;case 3:I=o.width/2+o.left,w.unshift("rotate(-90 "+I.toString()+" "+I.toString()+")");break}j%2===1&&(o.left!==o.top&&(I=o.left,o.left=o.top,o.top=I),o.width!==o.height&&(I=o.width,o.width=o.height,o.height=I)),w.length&&(a='<g transform="'+w.join(" ")+'">'+a+"</g>")});const n=i.width,r=i.height,l=o.width,d=o.height;let h,p;return n===null?(p=r===null?"1em":r==="auto"?d:r,h=It(p,l/d)):(h=n==="auto"?l:n,p=r===null?It(h,d/l):r==="auto"?d:r),{attributes:{width:h.toString(),height:p.toString(),viewBox:o.left.toString()+" "+o.top.toString()+" "+l.toString()+" "+d.toString()},body:a}}let We=(()=>{let s;try{if(s=fetch,typeof s=="function")return s}catch{}})();function va(s){We=s}function ya(){return We}function wa(s,e){const t=Ke(s);if(!t)return 0;let i;if(!t.maxURL)i=0;else{let o=0;t.resources.forEach(n=>{o=Math.max(o,n.length)});const a=e+".json?icons=";i=t.maxURL-o-t.path.length-a.length}return i}function _a(s){return s===404}const $a=(s,e,t)=>{const i=[],o=wa(s,e),a="icons";let n={type:a,provider:s,prefix:e,icons:[]},r=0;return t.forEach((l,d)=>{r+=l.length+1,r>=o&&d>0&&(i.push(n),n={type:a,provider:s,prefix:e,icons:[]},r=l.length),n.icons.push(l)}),i.push(n),i};function xa(s){if(typeof s=="string"){const e=Ke(s);if(e)return e.path}return"/"}const ka={prepare:$a,send:(s,e,t)=>{if(!We){t("abort",424);return}let i=xa(e.provider);switch(e.type){case"icons":{const a=e.prefix,r=e.icons.join(","),l=new URLSearchParams({icons:r});i+=a+".json?"+l.toString();break}case"custom":{const a=e.uri;i+=a.slice(0,1)==="/"?a.slice(1):a;break}default:t("abort",400);return}let o=503;We(s+i).then(a=>{const n=a.status;if(n!==200){setTimeout(()=>{t(_a(n)?"abort":"next",n)});return}return o=501,a.json()}).then(a=>{if(typeof a!="object"||a===null){setTimeout(()=>{a===404?t("abort",a):t("next",o)});return}setTimeout(()=>{t("success",a)})}).catch(()=>{t("next",o)})}};function Ji(s,e){switch(s){case"local":case"session":re[s]=e;break;case"all":for(const t in re)re[t]=e;break}}function Qi(){Pi("",ka),Ti(!0);let s;try{s=window}catch{}if(s){if(Ki(),s.IconifyPreload!==void 0){const t=s.IconifyPreload,i="Invalid IconifyPreload syntax.";typeof t=="object"&&t!==null&&(t instanceof Array?t:[t]).forEach(o=>{try{(typeof o!="object"||o===null||o instanceof Array||typeof o.icons!="object"||typeof o.prefix!="string"||!Ii(o))&&console.error(i)}catch{console.error(i)}})}if(s.IconifyProviders!==void 0){const t=s.IconifyProviders;if(typeof t=="object"&&t!==null)for(const i in t){const o="IconifyProviders["+i+"] is invalid.";try{const a=t[i];if(typeof a!="object"||!a||a.resources===void 0)continue;ji(i,a)||console.error(o)}catch{console.error(o)}}}}return{enableCache:t=>Ji(t,!0),disableCache:t=>Ji(t,!1),iconExists:Zs,getIcon:Js,listIcons:Ws,addIcon:Ci,addCollection:Ii,calculateSize:It,buildIcon:Zi,loadIcons:Tt,loadIcon:ha,addAPIProvider:ji,_api:{getAPIConfig:Ke,setAPIModule:Pi,sendAPIQuery:Di,setFetch:va,getFetch:ya,listAPIProviders:sa}}}function Xi(s,e){let t=s.indexOf("xlink:")===-1?"":' xmlns:xlink="http://www.w3.org/1999/xlink"';for(const i in e)t+=" "+i+'="'+e[i]+'"';return'<svg xmlns="http://www.w3.org/2000/svg"'+t+">"+s+"</svg>"}function Sa(s){return s.replace(/"/g,"'").replace(/%/g,"%25").replace(/#/g,"%23").replace(/</g,"%3C").replace(/>/g,"%3E").replace(/\s+/g," ")}function Ea(s){return'url("data:image/svg+xml,'+Sa(s)+'")'}const Lt={"background-color":"currentColor"},Yi={"background-color":"transparent"},eo={image:"var(--svg)",repeat:"no-repeat",size:"100% 100%"},to={"-webkit-mask":Lt,mask:Lt,background:Yi};for(const s in to){const e=to[s];for(const t in eo)e[s+"-"+t]=eo[t]}function io(s){return s+(s.match(/^[-0-9.]+$/)?"px":"")}function Aa(s,e,t){const i=document.createElement("span");let o=s.body;o.indexOf("<a")!==-1&&(o+="<!-- "+Date.now()+" -->");const a=s.attributes,n=Xi(o,{...a,width:e.width+"",height:e.height+""}),r=Ea(n),l=i.style,d={"--svg":r,width:io(a.width),height:io(a.height),...t?Lt:Yi};for(const h in d)l.setProperty(h,d[h]);return i}function Oa(s){const e=document.createElement("span");return e.innerHTML=Xi(s.body,s.attributes),e.firstChild}function oo(s,e){const t=e.icon.data,i=e.customisations,o=Zi(t,i);i.preserveAspectRatio&&(o.attributes.preserveAspectRatio=i.preserveAspectRatio);const a=e.renderedMode;let n;switch(a){case"svg":n=Oa(o);break;default:n=Aa(o,{...$e,...t},a==="mask")}const r=Array.from(s.childNodes).find(l=>{const d=l.tagName&&l.tagName.toUpperCase();return d==="SPAN"||d==="SVG"});r?n.tagName==="SPAN"&&r.tagName===n.tagName?r.setAttribute("style",n.getAttribute("style")):s.replaceChild(n,r):s.appendChild(n)}const Pt="data-style";function so(s,e){let t=Array.from(s.childNodes).find(i=>i.hasAttribute&&i.hasAttribute(Pt));t||(t=document.createElement("style"),t.setAttribute(Pt,Pt),s.appendChild(t)),t.textContent=":host{display:inline-block;vertical-align:"+(e?"-0.125em":"0")+"}span,svg{display:block}"}function ao(s,e,t){const i=t&&(t.rendered?t:t.lastRender);return{rendered:!1,inline:e,icon:s,lastRender:i}}function Ta(s="iconify-icon"){let e,t;try{e=window.customElements,t=window.HTMLElement}catch{return}if(!e||!t)return;const i=e.get(s);if(i)return i;const o=["icon","mode","inline","width","height","rotate","flip"],a=class extends t{constructor(){super();Me(this,"_shadowRoot");Me(this,"_state");Me(this,"_checkQueued",!1);const l=this._shadowRoot=this.attachShadow({mode:"open"}),d=Ct(this);so(l,d),this._state=ao({value:""},d),this._queueCheck()}static get observedAttributes(){return o.slice(0)}attributeChangedCallback(l){if(l==="inline"){const d=Ct(this),h=this._state;d!==h.inline&&(h.inline=d,so(this._shadowRoot,d))}else this._queueCheck()}get icon(){const l=this.getAttribute("icon");if(l&&l.slice(0,1)==="{")try{return JSON.parse(l)}catch{}return l}set icon(l){typeof l=="object"&&(l=JSON.stringify(l)),this.setAttribute("icon",l)}get inline(){return Ct(this)}set inline(l){this.setAttribute("inline",l?"true":null)}restartAnimation(){const l=this._state;if(l.rendered){const d=this._shadowRoot;if(l.renderedMode==="svg")try{d.lastChild.setCurrentTime(0);return}catch{}oo(d,l)}}get status(){const l=this._state;return l.rendered?"rendered":l.icon.data===null?"failed":"loading"}_queueCheck(){this._checkQueued||(this._checkQueued=!0,setTimeout(()=>{this._check()}))}_check(){if(!this._checkQueued)return;this._checkQueued=!1;const l=this._state,d=this.getAttribute("icon");if(d!==l.icon.value){this._iconChanged(d);return}if(!l.rendered)return;const h=this.getAttribute("mode"),p=Si(this);(l.attrMode!==h||qs(l.customisations,p))&&this._renderIcon(l.icon,p,h)}_iconChanged(l){const d=fa(l,(h,p,g)=>{const y=this._state;if(y.rendered||this.getAttribute("icon")!==h)return;const w={value:h,name:p,data:g};w.data?this._gotIconData(w):y.icon=w});d.data?this._gotIconData(d):this._state=ao(d,this._state.inline,this._state)}_gotIconData(l){this._checkQueued=!1,this._renderIcon(l,Si(this),this.getAttribute("mode"))}_renderIcon(l,d,h){const p=ba(l.data.body,h),g=this._state.inline;oo(this._shadowRoot,this._state={rendered:!0,icon:l,inline:g,customisations:d,attrMode:h,renderedMode:p})}};o.forEach(r=>{r in a.prototype||Object.defineProperty(a.prototype,r,{get:function(){return this.getAttribute(r)},set:function(l){this.setAttribute(r,l)}})});const n=Qi();for(const r in n)a[r]=a.prototype[r]=n[r];return e.define(s,a),a}const Ca=Ta()||Qi(),{enableCache:Nr,disableCache:qr,iconExists:Ur,getIcon:Vr,listIcons:Br,addIcon:Hr,addCollection:Kr,calculateSize:Gr,buildIcon:Wr,loadIcons:Zr,loadIcon:Jr,addAPIProvider:Qr,_api:Xr}=Ca;class no extends N{static get styles(){return x`
    ...
    `}}window.customElements.define("dt-icon",no);class ro extends N{static get styles(){return x`
      :host {
    ...
    `}}window.customElements.define("dt-label",ro);class Ia extends ae{static get styles(){return x`
      @keyframes spin {
        0% {
 ...
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const le=s=>s??T;class M extends N{static get formAssociated(){return!0}static get styles(){return[...super.styles,x`
        .readonly-btn {
          background-color: transparent;
          border: none;
          cursor: pointer;
 ...
 */const co=(s,e,t)=>{const i=new Map;for(let o=e;o<=t;o++)i.set(s[o],o);return i},q=ut(class extends ht{constructor(s){if(super(s),s.type!==ct.CHILD)throw Error("repeat() can only be used in text expressions")}dt(s,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const o=[],a=[];let n=0;for(const r of s)o[n]=i?i(r,n):n,a[n]=t(r,n),n++;return{values:a,keys:o}}render(s,e,t){return this.dt(s,e,t).values}update(s,[e,t,i]){const o=Fa(s),{values:a,keys:n}=this.dt(e,t,i);if(!Array.isArray(o))return this.ut=n,a;const r=this.ut??(this.ut=[]),l=[];let d,h,p=0,g=o.length-1,y=0,w=a.length-1;for(;p<=g&&y<=w;)if(o[p]===null)p++;else if(o[g]===null)g--;else if(r[p]===n[y])l[y]=de(o[p],a[y]),p++,y++;else if(r[g]===n[w])l[w]=de(o[g],a[w]),g--,w--;else if(r[p]===n[w])l[w]=de(o[p],a[w]),Te(s,l[w+1],o[p]),p++,w--;else if(r[g]===n[y])l[y]=de(o[g],a[y]),Te(s,o[p],o[g]),g--,y++;else if(d===void 0&&(d=co(n,y,w),h=co(r,p,g)),d.has(r[p]))if(d.has(r[g])){const E=h.get(n[y]),z=E!==void 0?o[E]:null;if(z===null){const j=Te(s,o[p]);de(j,a[y]),l[y]=j}else l[y]=de(z,a[y]),Te(s,o[p],z),o[E]=null;y++}else Mt(o[g]),g--;else Mt(o[p]),p++;for(;y<=w;){const E=Te(s,l[w+1]);de(E,a[y]),l[y++]=E}for(;p<=g;){const E=o[p++];E!==null&&Mt(E)}return this.ut=n,ja(s,l),B}}),Da=s=>class extends s{constructor(){super(),this.activeIndex=-1,this.filteredOptions=[],this.detectTap=!1}static get properties(){return{...super.properties,value:{type:Array,reflect:!0},query:{type:String,state:!0},options:{type:Array},filteredOptions:{type:Array,state:!0},open:{type:Boolean,state:!0},canUpdate:{type:Boolean,state:!0},activeIndex:{type:Number,state:!0},containerHeight:{type:Number,state:!0},loading:{type:Boolean},showAbove:{type:Boolean,state:!0}}}willUpdate(e){if(super.willUpdate(e),e&&!this.containerHeight&&this.shadowRoot.children&&this.shadowRoot.children.length){const t=this.shadowRoot.querySelector(".input-group");t&&(this.containerHeight=t.offsetHeight)}}updated(e){super.updated&&super.updated(e),this._scrollOptionListToActive();const t=this.shadowRoot.querySelector(".input-group");t&&!t.style.getPropertyValue("--container-width")&&t.clientWidth>0&&t.style.setProperty("--container-width",`${t.clientWidth}px`),e&&e.has("open")&&this.open&&this._checkPosition()}_checkPosition(){const e=this.shadowRoot.querySelector(".input-group");if(e){const t=e.getBoundingClientRect(),o=window.innerHeight-t.bottom,a=t.top;o<150&&a>o?this.showAbove=!0:this.showAbove=!1}}get optionListStyles(){const e={display:this.open?"block":"none"};return this.showAbove?(e.bottom=this.containerHeight?`${this.containerHeight}px`:"2.5rem",e.top="auto"):(e.top=this.containerHeight?`${this.containerHeight}px`:"2.5rem",e.bottom="auto"),e}_select(){console.error("Must implement `_select(value)` function"),this._clearSearch()}static _focusInput(e){e.target===e.currentTarget&&e.target.getElementsByTagName("input")[0].focus()}_inputFocusIn(e){(!e.relatedTarget||!["BUTTON","LI"].includes(e.relatedTarget.nodeName))&&(this.open=!0,this.activeIndex=-1)}_inputFocusOut(e){(!e.relatedTarget||!["BUTTON","LI"].includes(e.relatedTarget.nodeName))&&(this.open=!1,this.canUpdate=!0)}_inputKeyDown(e){}_inputKeyUp(e){switch(e.keyCode||e.which){case 38:this.open=!0,this._listHighlightPrevious();break;case 40:this.open=!0,this._listHighlightNext();break;case 9:this.activeIndex<0?this.open=!1:e.preventDefault(),this._keyboardSelectOption();break;case 13:this._keyboardSelectOption();break;case 27:this.open=!1,this.activeIndex=-1;break;default:this.open=!0,this.query=e.target.value;break}}_scrollOptionListToActive(){const e=this.shadowRoot.querySelector(".option-list"),t=this.shadowRoot.querySelector("button.active");if(e&&t){const i=t.offsetTop,o=t.offsetTop+t.clientHeight,a=e.scrollTop,n=e.scrollTop+e.clientHeight;o>n?e.scrollTo({top:o-e.clientHeight,behavior:"smooth"}):i<a&&e.scrollTo({top:i,behavior:"smooth"})}}_touchStart(e){e.target&&(this.detectTap=!1)}_touchMove(e){e.target&&(this.detectTap=!0)}_touchEnd(e){this.detectTap||(e.target&&e.target.value&&this._clickOption(e),this.detectTap=!1)}_keyboardSelectOption(){this.activeIndex>-1&&(this.activeIndex+1>this.filteredOptions.length?this._select(this.query):this._select(this.filteredOptions[this.activeIndex].id))}_clickOption(e){e.target&&e.target.value&&this._select(e.target.value)}_clickAddNew(e){var t;e.target&&this._select((t=e.target.dataset)==null?void 0:t.label)}_clearSearch(){const e=this.shadowRoot.querySelector("input");e&&(e.value="")}_listHighlightNext(){this.allowAdd?this.activeIndex=Math.min(this.filteredOptions.length,this.activeIndex+1):this.activeIndex=Math.min(this.filteredOptions.length-1,this.activeIndex+1)}_listHighlightPrevious(){this.activeIndex=Math.max(0,this.activeIndex-1)}_renderOption(e,t){return c`
      ...
      `}_baseRenderOptions(){return this.filteredOptions.length?q(this.filteredOptions,e=>e.id,(e,t)=>this._renderOption(e,t)):this.loading?c`<li><div>${R("Loading options...")}</div></li>`:c`<li><div>${R("No Data Available")}</div></li>`}_renderOptions(){let e=this._baseRenderOptions();return this.allowAdd&&this.query&&(Array.isArray(e)||(e=[e]),e.push(c`<li tabindex="-1">
          ...
          </li>`)),e}};class Ze extends Da(M){static get styles(){return[...super.styles,x`
        :host {
          position: relative;
    ...
    `}}window.customElements.define("dt-multi-select",Ze);class za extends N{static get styles(){return x`
      root {
        display: block;
      }
      .health-item {
    ...
    >
      ${this.renderIcon()}
    </div>`}async _handleClick(e){if(this.disabled)return;const t=!this.active;this.active=t;const i=new CustomEvent("change",{detail:{key:this.key,active:t}});this.dispatchEvent(i)}}window.customElements.define("dt-church-health-icon",za);class uo extends M{static get styles(){return[...super.styles,x`
        .root {
          display: block;
        }
 ...
 */function*Ra(s,e){if(s!==void 0){let t=0;for(const i of s)yield e(i,t++)}}class go extends Ce{static get properties(){return{...super.properties,filters:{type:Array}}}static get styles(){return[...super.styles,x`
    ...
    `}}window.customElements.define("dt-location",go);class vo extends N{static get styles(){return x`
      :host {
        display: block;
        font-family: var(--font-family);
      }
    ...
    `}renderIconSaved(e){return this.saved&&(this.savedTimeout&&clearTimeout(this.savedTimeout),this.savedTimeout=setTimeout(()=>{this.savedTimeout=null,this.saved=!1},5e3)),this.saved?c`<dt-checkmark
        ...
        ></dt-checkmark>`:null}}window.customElements.define("dt-location-map-item",Na);class wo extends M{static get properties(){return{...super.properties,placeholder:{type:String},value:{type:Array},locations:{type:Array,state:!0},open:{type:Boolean,state:!0},limit:{type:Number,attribute:"limit"},mapboxToken:{type:String,attribute:"mapbox-token"},googleToken:{type:String,attribute:"google-token"},activeItem:{type:String,state:!0}}}static get styles(){return[...super.styles,x`
        :host {
          font-family: Helvetica, Arial, sans-serif;
        }
        .input-group {
    ...
    `}}window.customElements.define("dt-location-map",wo);class _o extends M{static get styles(){return[...super.styles,x`
        input {
          color: var(
    ...
    `}}window.customElements.define("dt-number",_o);class $o extends M{static get styles(){return[...super.styles,x`
        :host {
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function U(s,e,t){return s?e(s):t==null?void 0:t(s)}class Dt extends Ft{static get styles(){return[...super.styles,x`
        :host {
          display: block;
        }
        input {
    ...
    `}}window.customElements.define("dt-multi-text",Dt);class ko extends Dt{static get styles(){return[...super.styles,x`
        .icon-btn {
          background-color: transparent;
          border: none;
          cursor: pointer;
    ...
    `}}window.customElements.define("dt-alert",Ao);class Oo extends N{static get styles(){return x`
      :host {
