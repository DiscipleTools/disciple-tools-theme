 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function B(s,e,t){return s?e(s):t==null?void 0:t(s)}class xo extends zt{static get styles(){return[...super.styles,x`
        :host {
          display: block;
        }
        input {
