...
\f\r"'\`<>=]|("|')|))|$)`,"g"),ei=/'/g,ti=/"/g,ii=/^(?:script|style|textarea|title)$/i,Xs=o=>(e,...t)=>({_$litType$:o,strings:e,values:t}),u=Xs(1),U=Symbol.for("lit-noChange"),E=Symbol.for("lit-nothing"),si=new WeakMap,se=te.createTreeWalker(te,129);function oi(o,e){if(!tt(o)||!o.hasOwnProperty("raw"))throw Error("invalid template strings array");return Zt!==void 0?Zt.createHTML(e):e}const eo=(o,e)=>{const t=o.length-1,i=[];let s,a=e===2?"<svg>":e===3?"<math>":"",r=me;for(let l=0;l<t;l++){const n=o[l];let c,b,g=-1,v=0;for(;v<n.length&&(r.lastIndex=v,b=r.exec(n),b!==null);)v=r.lastIndex,r===me?b[1]==="!--"?r=Yt:b[1]!==void 0?r=Xt:b[2]!==void 0?(ii.test(b[2])&&(s=RegExp("</"+b[2],"g")),r=ie):b[3]!==void 0&&(r=ie):r===ie?b[0]===">"?(r=s??me,g=-1):b[1]===void 0?g=-2:(g=r.lastIndex-b[2].length,c=b[1],r=b[3]===void 0?ie:b[3]==='"'?ti:ei):r===ti||r===ei?r=ie:r===Yt||r===Xt?r=me:(r=ie,s=void 0);const y=r===ie&&o[l+1].startsWith("/>")?" ":"";a+=r===me?n+Qs:g>=0?(i.push(c),n.slice(0,g)+Jt+n.slice(g)+J+y):n+J+(g===-2?l:y)}return[oi(o,a+(o[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),i]};class ve{constructor({strings:e,_$litType$:t},i){let s;this.parts=[];let a=0,r=0;const l=e.length-1,n=this.parts,[c,b]=eo(e,t);if(this.el=ve.createElement(c,i),se.currentNode=this.el.content,t===2||t===3){const g=this.el.content.firstChild;g.replaceWith(...g.childNodes)}for(;(s=se.nextNode())!==null&&n.length<l;){if(s.nodeType===1){if(s.hasAttributes())for(const g of s.getAttributeNames())if(g.endsWith(Jt)){const v=b[r++],y=s.getAttribute(g).split(J),w=/([.?@])?(.*)/.exec(v);n.push({type:1,index:a,name:w[2],strings:y,ctor:w[1]==="."?io:w[1]==="?"?so:w[1]==="@"?oo:Ie}),s.removeAttribute(g)}else g.startsWith(J)&&(n.push({type:6,index:a}),s.removeAttribute(g));if(ii.test(s.tagName)){const g=s.textContent.split(J),v=g.length-1;if(v>0){s.textContent=Pe?Pe.emptyScript:"";for(let y=0;y<v;y++)s.append(g[y],be()),se.nextNode(),n.push({type:2,index:++a});s.append(g[v],be())}}}else if(s.nodeType===8)if(s.data===Qt)n.push({type:2,index:a});else{let g=-1;for(;(g=s.data.indexOf(J,g+1))!==-1;)n.push({type:7,index:a}),g+=J.length-1}a++}}static createElement(e,t){const i=te.createElement("template");return i.innerHTML=e,i}}function le(o,e,t=o,i){var r,l;if(e===U)return e;let s=i!==void 0?(r=t._$Co)==null?void 0:r[i]:t._$Cl;const a=ge(e)?void 0:e._$litDirective$;return(s==null?void 0:s.constructor)!==a&&((l=s==null?void 0:s._$AO)==null||l.call(s,!1),a===void 0?s=void 0:(s=new a(o),s._$AT(o,t,i)),i!==void 0?(t._$Co??(t._$Co=[]))[i]=s:t._$Cl=s),s!==void 0&&(e=le(o,s._$AS(o,e.values),s,i)),e}let to=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:i}=this._$AD,s=((e==null?void 0:e.creationScope)??te).importNode(t,!0);se.currentNode=s;let a=se.nextNode(),r=0,l=0,n=i[0];for(;n!==void 0;){if(r===n.index){let c;n.type===2?c=new de(a,a.nextSibling,this,e):n.type===1?c=new n.ctor(a,n.name,n.strings,this,e):n.type===6&&(c=new ao(a,this,e)),this._$AV.push(c),n=i[++l]}r!==(n==null?void 0:n.index)&&(a=se.nextNode(),r++)}return se.currentNode=te,s}p(e){let t=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}};class de{get _$AU(){var e;return((e=this._$AM)==null?void 0:e._$AU)??this._$Cv}constructor(e,t,i,s){this.type=2,this._$AH=E,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=s,this._$Cv=(s==null?void 0:s.isConnected)??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=le(this,e,t),ge(e)?e===E||e==null||e===""?(this._$AH!==E&&this._$AR(),this._$AH=E):e!==this._$AH&&e!==U&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Ys(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==E&&ge(this._$AH)?this._$AA.nextSibling.data=e:this.T(te.createTextNode(e)),this._$AH=e}$(e){var a;const{values:t,_$litType$:i}=e,s=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=ve.createElement(oi(i.h,i.h[0]),this.options)),i);if(((a=this._$AH)==null?void 0:a._$AD)===s)this._$AH.p(t);else{const r=new to(s,this),l=r.u(this.options);r.p(t),this.T(l),this._$AH=r}}_$AC(e){let t=si.get(e.strings);return t===void 0&&si.set(e.strings,t=new ve(e)),t}k(e){tt(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,s=0;for(const a of e)s===t.length?t.push(i=new de(this.O(be()),this.O(be()),this,this.options)):i=t[s],i._$AI(a),s++;s<t.length&&(this._$AR(i&&i._$AB.nextSibling,s),t.length=s)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)==null?void 0:i.call(this,!1,!0,t);e&&e!==this._$AB;){const s=e.nextSibling;e.remove(),e=s}}setConnected(e){var t;this._$AM===void 0&&(this._$Cv=e,(t=this._$AP)==null||t.call(this,e))}}class Ie{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,s,a){this.type=1,this._$AH=E,this._$AN=void 0,this.element=e,this.name=t,this._$AM=s,this.options=a,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=E}_$AI(e,t=this,i,s){const a=this.strings;let r=!1;if(a===void 0)e=le(this,e,t,0),r=!ge(e)||e!==this._$AH&&e!==U,r&&(this._$AH=e);else{const l=e;let n,c;for(e=a[0],n=0;n<a.length-1;n++)c=le(this,l[i+n],t,n),c===U&&(c=this._$AH[n]),r||(r=!ge(c)||c!==this._$AH[n]),c===E?e=E:e!==E&&(e+=(c??"")+a[n+1]),this._$AH[n]=c}r&&!s&&this.j(e)}j(e){e===E?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class io extends Ie{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===E?void 0:e}}class so extends Ie{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==E)}}class oo extends Ie{constructor(e,t,i,s,a){super(e,t,i,s,a),this.type=5}_$AI(e,t=this){if((e=le(this,e,t,0)??E)===U)return;const i=this._$AH,s=e===E&&i!==E||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,a=e!==E&&(i===E||s);s&&this.element.removeEventListener(this.name,this,i),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t;typeof this._$AH=="function"?this._$AH.call(((t=this.options)==null?void 0:t.host)??this.element,e):this._$AH.handleEvent(e)}}class ao{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){le(this,e)}}const ro={I:de},st=fe.litHtmlPolyfillSupport;st==null||st(ve,de),(fe.litHtmlVersions??(fe.litHtmlVersions=[])).push("3.2.1");const no=(o,e,t)=>{const i=(t==null?void 0:t.renderBefore)??e;let s=i._$litPart$;if(s===void 0){const a=(t==null?void 0:t.renderBefore)??null;i._$litPart$=s=new de(e.insertBefore(be(),a),a,void 0,t??{})}return s._$AI(o),s};/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const B=[];for(let o=0;o<256;o++)B[o]=(o>>4&15).toString(16)+(o&15).toString(16);function $o(o){let e=0,t=8997,i=0,s=33826,a=0,r=40164,l=0,n=52210;for(let c=0;c<o.length;c++)t^=o.charCodeAt(c),e=t*435,i=s*435,a=r*435,l=n*435,a+=t<<8,l+=s<<8,i+=e>>>16,t=e&65535,a+=i>>>16,s=i&65535,n=l+(a>>>16)&65535,r=a&65535;return B[n>>8]+B[n&255]+B[r>>8]+B[r&255]+B[s>>8]+B[s&255]+B[t>>8]+B[t&255]}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const wi="important",Do=" !"+wi,H=ct(class extends ut{constructor(o){var e;if(super(o),o.type!==dt.ATTRIBUTE||o.name!=="style"||((e=o.strings)==null?void 0:e.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(o){return Object.keys(o).reduce((e,t)=>{const i=o[t];return i==null?e:e+`${t=t.includes("-")?t:t.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${i};`},"")}update(o,[e]){const{style:t}=o.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(e)),this.render(e);for(const i of this.ft)e[i]==null&&(this.ft.delete(i),i.includes("-")?t.removeProperty(i):t[i]=null);for(const i in e){const s=e[i];if(s!=null){this.ft.add(i);const a=typeof s=="string"&&s.endsWith(Do);i.includes("-")||a?t.setProperty(i,a?s.slice(0,-11):s,a?wi:""):t[i]=s}}return U}});class _i extends q{static get styles(){return S`
    ...
    `}static get properties(){return{options:{type:Array},label:{type:String},isModal:{type:Boolean},buttonStyle:{type:Object},default:{type:Boolean},context:{type:String}}}get classes(){const e={"dt-dropdown":!0},t=`dt-dropdown--${this.context}`;return e[t]=!0,e}render(){return u`
    <div class="dropdown">
    <button
    ...
    `}_redirectToHref(e){let t=e;/^https?:\/\//i.test(t)||(t=`http://${t}`),window.open(t,"_blank")}_openDialog(e){const t=e.replace(/\s/g,"-").toLowerCase();document.querySelector(`#${t}`).shadowRoot.querySelector("dialog").showModal(),document.querySelector("body").style.overflow="hidden"}_handleHover(){const e=this.shadowRoot.querySelector("ul");e.style.display="block"}_handleMouseLeave(){const e=this.shadowRoot.querySelector("ul");e.style.display="none"}}window.customElements.define("dt-dropdown",$i);class zo extends q{static get styles(){return S`
      root {
        display: block;
      }
      .health-item img {
    ...
    `}static get properties(){return{key:{type:String},metric:{type:Object},group:{type:Object},active:{type:Boolean,reflect:!0},missingIcon:{type:String},handleSave:{type:Function}}}render(){const{metric:e,active:t,missingIcon:i=`${window.wpApiShare.template_dir}/dt-assets/images/groups/missing.svg`}=this;return u`<div
      class=${A({"health-item":!0,"health-item--active":t})}
      title="${e.description}"
      @click="${this._handleClick}"
    >
      <img src="${e.icon?e.icon:i}" />
    </div>`}async _handleClick(){if(!this.handleSave)return;const e=!this.active;this.active=e;const t={health_metrics:{values:[{value:this.key,delete:!e}]}};try{await this.handleSave(this.group.ID,t)}catch(i){console.error(i);return}e?this.group.health_metrics.push(this.key):this.group.health_metrics.pop(this.key)}}window.customElements.define("dt-church-health-icon",zo);class xi extends q{static get styles(){return S`
        ...
        <div class="health-circle__container">
          ...
          >
            <div class="health-circle__grid">
              ${this.metrics.map(([t,i],s)=>u`<dt-church-health-icon
                    key="${t}"
                    .group="${this.group}"
                    .metric=${i}
...
*/const ki=Object.freeze({left:0,top:0,width:16,height:16}),Re=Object.freeze({rotate:0,vFlip:!1,hFlip:!1}),we=Object.freeze({...ki,...Re}),mt=Object.freeze({...we,body:"",hidden:!1}),Ro=Object.freeze({width:null,height:null}),Si=Object.freeze({...Ro,...Re});function qo(o,e=0){const t=o.replace(/^-?[0-9.]*/,"");function i(s){for(;s<0;)s+=4;return s%4}if(t===""){const s=parseInt(o);return isNaN(s)?0:i(s)}else if(t!==o){let s=0;switch(t){case"%":s=25;break;case"deg":s=90}if(s){let a=parseFloat(o.slice(0,o.length-t.length));return isNaN(a)?0:(a=a/s,a%1===0?i(a):0)}}return e}const No=/[\s,]+/;function Fo(o,e){e.split(No).forEach(t=>{switch(t.trim()){case"horizontal":o.hFlip=!0;break;case"vertical":o.vFlip=!0;break}})}const Ti={...Si,preserveAspectRatio:""};function Ai(o){const e={...Ti},t=(i,s)=>o.getAttribute(i)||s;return e.width=t("width",null),e.height=t("height",null),e.rotate=qo(t("rotate","")),Fo(e,t("flip","")),e.preserveAspectRatio=t("preserveAspectRatio",t("preserveaspectratio","")),e}function Uo(o,e){for(const t in Ti)if(o[t]!==e[t])return!0;return!1}const _e=/^[a-z0-9]+(-[a-z0-9]+)*$/,$e=(o,e,t,i="")=>{const s=o.split(":");if(o.slice(0,1)==="@"){if(s.length<2||s.length>3)return null;i=s.shift().slice(1)}if(s.length>3||!s.length)return null;if(s.length>1){const l=s.pop(),n=s.pop(),c={provider:s.length>0?s[0]:i,prefix:n,name:l};return e&&!qe(c)?null:c}const a=s[0],r=a.split("-");if(r.length>1){const l={provider:i,prefix:r.shift(),name:r.join("-")};return e&&!qe(l)?null:l}if(t&&i===""){const l={provider:i,prefix:"",name:a};return e&&!qe(l,t)?null:l}return null},qe=(o,e)=>o?!!((o.provider===""||o.provider.match(_e))&&(e&&o.prefix===""||o.prefix.match(_e))&&o.name.match(_e)):!1;function Vo(o,e){const t={};!o.hFlip!=!e.hFlip&&(t.hFlip=!0),!o.vFlip!=!e.vFlip&&(t.vFlip=!0);const i=((o.rotate||0)+(e.rotate||0))%4;return i&&(t.rotate=i),t}function Ei(o,e){const t=Vo(o,e);for(const i in mt)i in Re?i in o&&!(i in t)&&(t[i]=Re[i]):i in e?t[i]=e[i]:i in o&&(t[i]=o[i]);return t}function Bo(o,e){const t=o.icons,i=o.aliases||Object.create(null),s=Object.create(null);function a(r){if(t[r])return s[r]=[];if(!(r in s)){s[r]=null;const l=i[r]&&i[r].parent,n=l&&a(l);n&&(s[r]=[l].concat(n))}return s[r]}return Object.keys(t).concat(Object.keys(i)).forEach(a),s}function Ho(o,e,t){const i=o.icons,s=o.aliases||Object.create(null);let a={};function r(l){a=Ei(i[l]||s[l],a)}return r(e),t.forEach(r),Ei(o,a)}function Oi(o,e){const t=[];if(typeof o!="object"||typeof o.icons!="object")return t;o.not_found instanceof Array&&o.not_found.forEach(s=>{e(s,null),t.push(s)});const i=Bo(o);for(const s in i){const a=i[s];a&&(e(s,Ho(o,s,a)),t.push(s))}return t}const Go={provider:"",aliases:{},not_found:{},...ki};function vt(o,e){for(const t in e)if(t in o&&typeof o[t]!=typeof e[t])return!1;return!0}function Ci(o){if(typeof o!="object"||o===null)return null;const e=o;if(typeof e.prefix!="string"||!o.icons||typeof o.icons!="object"||!vt(o,Go))return null;const t=e.icons;for(const s in t){const a=t[s];if(!s.match(_e)||typeof a.body!="string"||!vt(a,mt))return null}const i=e.aliases||Object.create(null);for(const s in i){const a=i[s],r=a.parent;if(!s.match(_e)||typeof r!="string"||!t[r]&&!i[r]||!vt(a,mt))return null}return e}const Ne=Object.create(null);function Wo(o,e){return{provider:o,prefix:e,icons:Object.create(null),missing:new Set}}function Y(o,e){const t=Ne[o]||(Ne[o]=Object.create(null));return t[e]||(t[e]=Wo(o,e))}function yt(o,e){return Ci(e)?Oi(e,(t,i)=>{i?o.icons[t]=i:o.missing.add(t)}):[]}function Ko(o,e,t){try{if(typeof t.body=="string")return o.icons[e]={...t},!0}catch{}return!1}function Zo(o,e){let t=[];return(typeof o=="string"?[o]:Object.keys(Ne)).forEach(s=>{(typeof s=="string"&&typeof e=="string"?[e]:Object.keys(Ne[s]||{})).forEach(r=>{const l=Y(s,r);t=t.concat(Object.keys(l.icons).map(n=>(s!==""?"@"+s+":":"")+r+":"+n))})}),t}let xe=!1;function Li(o){return typeof o=="boolean"&&(xe=o),xe}function ke(o){const e=typeof o=="string"?$e(o,!0,xe):o;if(e){const t=Y(e.provider,e.prefix),i=e.name;return t.icons[i]||(t.missing.has(i)?null:void 0)}}function Pi(o,e){const t=$e(o,!0,xe);if(!t)return!1;const i=Y(t.provider,t.prefix);return Ko(i,t.name,e)}function Ii(o,e){if(typeof o!="object")return!1;if(typeof e!="string"&&(e=o.provider||""),xe&&!e&&!o.prefix){let s=!1;return Ci(o)&&(o.prefix="",Oi(o,(a,r)=>{r&&Pi(a,r)&&(s=!0)})),s}const t=o.prefix;if(!qe({provider:e,prefix:t,name:"a"}))return!1;const i=Y(e,t);return!!yt(i,o)}function Jo(o){return!!ke(o)}function Qo(o){const e=ke(o);return e?{...we,...e}:null}function Yo(o){const e={loaded:[],missing:[],pending:[]},t=Object.create(null);o.sort((s,a)=>s.provider!==a.provider?s.provider.localeCompare(a.provider):s.prefix!==a.prefix?s.prefix.localeCompare(a.prefix):s.name.localeCompare(a.name));let i={provider:"",prefix:"",name:""};return o.forEach(s=>{if(i.name===s.name&&i.prefix===s.prefix&&i.provider===s.provider)return;i=s;const a=s.provider,r=s.prefix,l=s.name,n=t[a]||(t[a]=Object.create(null)),c=n[r]||(n[r]=Y(a,r));let b;l in c.icons?b=e.loaded:r===""||c.missing.has(l)?b=e.missing:b=e.pending;const g={provider:a,prefix:r,name:l};b.push(g)}),e}function Mi(o,e){o.forEach(t=>{const i=t.loaderCallbacks;i&&(t.loaderCallbacks=i.filter(s=>s.id!==e))})}function Xo(o){o.pendingCallbacksFlag||(o.pendingCallbacksFlag=!0,setTimeout(()=>{o.pendingCallbacksFlag=!1;const e=o.loaderCallbacks?o.loaderCallbacks.slice(0):[];if(!e.length)return;let t=!1;const i=o.provider,s=o.prefix;e.forEach(a=>{const r=a.icons,l=r.pending.length;r.pending=r.pending.filter(n=>{if(n.prefix!==s)return!0;const c=n.name;if(o.icons[c])r.loaded.push({provider:i,prefix:s,name:c});else if(o.missing.has(c))r.missing.push({provider:i,prefix:s,name:c});else return t=!0,!0;return!1}),r.pending.length!==l&&(t||Mi([o],a.id),a.callback(r.loaded.slice(0),r.missing.slice(0),r.pending.slice(0),a.abort))})}))}let ea=0;function ta(o,e,t){const i=ea++,s=Mi.bind(null,t,i);if(!e.pending.length)return s;const a={id:i,icons:e,callback:o,abort:s};return t.forEach(r=>{(r.loaderCallbacks||(r.loaderCallbacks=[])).push(a)}),s}const wt=Object.create(null);function ji(o,e){wt[o]=e}function _t(o){return wt[o]||wt[""]}function ia(o,e=!0,t=!1){const i=[];return o.forEach(s=>{const a=typeof s=="string"?$e(s,e,t):s;a&&i.push(a)}),i}var sa={resources:[],index:0,timeout:2e3,rotate:750,random:!1,dataAfterTimeout:!1};function oa(o,e,t,i){const s=o.resources.length,a=o.random?Math.floor(Math.random()*s):o.index;let r;if(o.random){let T=o.resources.slice(0);for(r=[];T.length>1;){const R=Math.floor(Math.random()*T.length);r.push(T[R]),T=T.slice(0,R).concat(T.slice(R+1))}r=r.concat(T)}else r=o.resources.slice(a).concat(o.resources.slice(0,a));const l=Date.now();let n="pending",c=0,b,g=null,v=[],y=[];typeof i=="function"&&y.push(i);function w(){g&&(clearTimeout(g),g=null)}function L(){n==="pending"&&(n="aborted"),w(),v.forEach(T=>{T.status==="pending"&&(T.status="aborted")}),v=[]}function N(T,R){R&&(y=[]),typeof T=="function"&&y.push(T)}function j(){return{startTime:l,payload:e,status:n,queriesSent:c,queriesPending:v.length,subscribe:N,abort:L}}function P(){n="failed",y.forEach(T=>{T(void 0,b)})}function Ce(){v.forEach(T=>{T.status==="pending"&&(T.status="aborted")}),v=[]}function Ke(T,R,ne){const ee=R!=="success";switch(v=v.filter(M=>M!==T),n){case"pending":break;case"failed":if(ee||!o.dataAfterTimeout)return;break;default:return}if(R==="abort"){b=ne,P();return}if(ee){b=ne,v.length||(r.length?X():P());return}if(w(),Ce(),!o.random){const M=o.resources.indexOf(T.resource);M!==-1&&M!==o.index&&(o.index=M)}n="completed",y.forEach(M=>{M(ne)})}function X(){if(n!=="pending")return;w();const T=r.shift();if(T===void 0){if(v.length){g=setTimeout(()=>{w(),n==="pending"&&(Ce(),P())},o.timeout);return}P();return}const R={status:"pending",resource:T,callback:(ne,ee)=>{Ke(R,ne,ee)}};v.push(R),c++,g=setTimeout(X,o.rotate),t(T,e,R.callback)}return setTimeout(X),j}function Di(o){const e={...sa,...o};let t=[];function i(){t=t.filter(l=>l().status==="pending")}function s(l,n,c){const b=oa(e,l,n,(g,v)=>{i(),c&&c(g,v)});return t.push(b),b}function a(l){return t.find(n=>l(n))||null}return{query:s,find:a,setIndex:l=>{e.index=l},getIndex:()=>e.index,cleanup:i}}function $t(o){let e;if(typeof o.resources=="string")e=[o.resources];else if(e=o.resources,!(e instanceof Array)||!e.length)return null;return{resources:e,path:o.path||"/",maxURL:o.maxURL||500,rotate:o.rotate||750,timeout:o.timeout||5e3,random:o.random===!0,index:o.index||0,dataAfterTimeout:o.dataAfterTimeout!==!1}}const Fe=Object.create(null),Se=["https://api.simplesvg.com","https://api.unisvg.com"],Ue=[];for(;Se.length>0;)Se.length===1||Math.random()>.5?Ue.push(Se.shift()):Ue.push(Se.pop());Fe[""]=$t({resources:["https://api.iconify.design"].concat(Ue)});function zi(o,e){const t=$t(e);return t===null?!1:(Fe[o]=t,!0)}function Ve(o){return Fe[o]}function aa(){return Object.keys(Fe)}function Ri(){}const xt=Object.create(null);function ra(o){if(!xt[o]){const e=Ve(o);if(!e)return;const t=Di(e),i={config:e,redundancy:t};xt[o]=i}return xt[o]}function qi(o,e,t){let i,s;if(typeof o=="string"){const a=_t(o);if(!a)return t(void 0,424),Ri;s=a.send;const r=ra(o);r&&(i=r.redundancy)}else{const a=$t(o);if(a){i=Di(a);const r=o.resources?o.resources[0]:"",l=_t(r);l&&(s=l.send)}}return!i||!s?(t(void 0,424),Ri):i.query(e,s,t)().abort}const Ni="iconify2",Te="iconify",Fi=Te+"-count",Ui=Te+"-version",Vi=36e5,na=168;function kt(o,e){try{return o.getItem(e)}catch{}}function St(o,e,t){try{return o.setItem(e,t),!0}catch{}}function Bi(o,e){try{o.removeItem(e)}catch{}}function Tt(o,e){return St(o,Fi,e.toString())}function At(o){return parseInt(kt(o,Fi))||0}const ae={local:!0,session:!0},Hi={local:new Set,session:new Set};let Et=!1;function la(o){Et=o}let Be=typeof window>"u"?{}:window;function Gi(o){const e=o+"Storage";try{if(Be&&Be[e]&&typeof Be[e].length=="number")return Be[e]}catch{}ae[o]=!1}function Wi(o,e){const t=Gi(o);if(!t)return;const i=kt(t,Ui);if(i!==Ni){if(i){const l=At(t);for(let n=0;n<l;n++)Bi(t,Te+n.toString())}St(t,Ui,Ni),Tt(t,0);return}const s=Math.floor(Date.now()/Vi)-na,a=l=>{const n=Te+l.toString(),c=kt(t,n);if(typeof c=="string"){try{const b=JSON.parse(c);if(typeof b=="object"&&typeof b.cached=="number"&&b.cached>s&&typeof b.provider=="string"&&typeof b.data=="object"&&typeof b.data.prefix=="string"&&e(b,l))return!0}catch{}Bi(t,n)}};let r=At(t);for(let l=r-1;l>=0;l--)a(l)||(l===r-1?(r--,Tt(t,r)):Hi[o].add(l))}function Ki(){if(!Et){la(!0);for(const o in ae)Wi(o,e=>{const t=e.data,i=e.provider,s=t.prefix,a=Y(i,s);if(!yt(a,t).length)return!1;const r=t.lastModified||-1;return a.lastModifiedCached=a.lastModifiedCached?Math.min(a.lastModifiedCached,r):r,!0})}}function da(o,e){const t=o.lastModifiedCached;if(t&&t>=e)return t===e;if(o.lastModifiedCached=e,t)for(const i in ae)Wi(i,s=>{const a=s.data;return s.provider!==o.provider||a.prefix!==o.prefix||a.lastModified===e});return!0}function ca(o,e){Et||Ki();function t(i){let s;if(!ae[i]||!(s=Gi(i)))return;const a=Hi[i];let r;if(a.size)a.delete(r=Array.from(a).shift());else if(r=At(s),!Tt(s,r+1))return;const l={cached:Math.floor(Date.now()/Vi),provider:o.provider,data:e};return St(s,Te+r.toString(),JSON.stringify(l))}e.lastModified&&!da(o,e.lastModified)||Object.keys(e.icons).length&&(e.not_found&&(e=Object.assign({},e),delete e.not_found),t("local")||t("session"))}function Zi(){}function ua(o){o.iconsLoaderFlag||(o.iconsLoaderFlag=!0,setTimeout(()=>{o.iconsLoaderFlag=!1,Xo(o)}))}function ha(o,e){o.iconsToLoad?o.iconsToLoad=o.iconsToLoad.concat(e).sort():o.iconsToLoad=e,o.iconsQueueFlag||(o.iconsQueueFlag=!0,setTimeout(()=>{o.iconsQueueFlag=!1;const{provider:t,prefix:i}=o,s=o.iconsToLoad;delete o.iconsToLoad;let a;if(!s||!(a=_t(t)))return;a.prepare(t,i,s).forEach(l=>{qi(t,l,n=>{if(typeof n!="object")l.icons.forEach(c=>{o.missing.add(c)});else try{const c=yt(o,n);if(!c.length)return;const b=o.pendingIcons;b&&c.forEach(g=>{b.delete(g)}),ca(o,n)}catch(c){console.error(c)}ua(o)})})}))}const Ot=(o,e)=>{const t=ia(o,!0,Li()),i=Yo(t);if(!i.pending.length){let n=!0;return e&&setTimeout(()=>{n&&e(i.loaded,i.missing,i.pending,Zi)}),()=>{n=!1}}const s=Object.create(null),a=[];let r,l;return i.pending.forEach(n=>{const{provider:c,prefix:b}=n;if(b===l&&c===r)return;r=c,l=b,a.push(Y(c,b));const g=s[c]||(s[c]=Object.create(null));g[b]||(g[b]=[])}),i.pending.forEach(n=>{const{provider:c,prefix:b,name:g}=n,v=Y(c,b),y=v.pendingIcons||(v.pendingIcons=new Set);y.has(g)||(y.add(g),s[c][b].push(g))}),a.forEach(n=>{const{provider:c,prefix:b}=n;s[c][b].length&&ha(n,s[c][b])}),e?ta(e,i,a):Zi},pa=o=>new Promise((e,t)=>{const i=typeof o=="string"?$e(o,!0):o;if(!i){t(o);return}Ot([i||o],s=>{if(s.length&&i){const a=ke(i);if(a){e({...we,...a});return}}t(o)})});function fa(o){try{const e=typeof o=="string"?JSON.parse(o):o;if(typeof e.body=="string")return{...e}}catch{}}function ba(o,e){const t=typeof o=="string"?$e(o,!0,!0):null;if(!t){const a=fa(o);return{value:o,data:a}}const i=ke(t);if(i!==void 0||!t.prefix)return{value:o,name:t,data:i};const s=Ot([t],()=>e(o,t,ke(t)));return{value:o,name:t,loading:s}}function Ct(o){return o.hasAttribute("inline")}let Ji=!1;try{Ji=navigator.vendor.indexOf("Apple")===0}catch{}function ga(o,e){switch(e){case"svg":case"bg":case"mask":return e}return e!=="style"&&(Ji||o.indexOf("<a")===-1)?"svg":o.indexOf("currentColor")===-1?"bg":"mask"}const ma=/(-?[0-9.]*[0-9]+[0-9.]*)/g,va=/^-?[0-9.]*[0-9]+[0-9.]*$/g;function Lt(o,e,t){if(e===1)return o;if(t=t||100,typeof o=="number")return Math.ceil(o*e*t)/t;if(typeof o!="string")return o;const i=o.split(ma);if(i===null||!i.length)return o;const s=[];let a=i.shift(),r=va.test(a);for(;;){if(r){const l=parseFloat(a);isNaN(l)?s.push(a):s.push(Math.ceil(l*e*t)/t)}else s.push(a);if(a=i.shift(),a===void 0)return s.join("");r=!r}}function Qi(o,e){const t={...we,...o},i={...Si,...e},s={left:t.left,top:t.top,width:t.width,height:t.height};let a=t.body;[t,i].forEach(y=>{const w=[],L=y.hFlip,N=y.vFlip;let j=y.rotate;L?N?j+=2:(w.push("translate("+(s.width+s.left).toString()+" "+(0-s.top).toString()+")"),w.push("scale(-1 1)"),s.top=s.left=0):N&&(w.push("translate("+(0-s.left).toString()+" "+(s.height+s.top).toString()+")"),w.push("scale(1 -1)"),s.top=s.left=0);let P;switch(j<0&&(j-=Math.floor(j/4)*4),j=j%4,j){case 1:P=s.height/2+s.top,w.unshift("rotate(90 "+P.toString()+" "+P.toString()+")");break;case 2:w.unshift("rotate(180 "+(s.width/2+s.left).toString()+" "+(s.height/2+s.top).toString()+")");break;case 3:P=s.width/2+s.left,w.unshift("rotate(-90 "+P.toString()+" "+P.toString()+")");break}j%2===1&&(s.left!==s.top&&(P=s.left,s.left=s.top,s.top=P),s.width!==s.height&&(P=s.width,s.width=s.height,s.height=P)),w.length&&(a='<g transform="'+w.join(" ")+'">'+a+"</g>")});const r=i.width,l=i.height,n=s.width,c=s.height;let b,g;return r===null?(g=l===null?"1em":l==="auto"?c:l,b=Lt(g,n/c)):(b=r==="auto"?n:r,g=l===null?Lt(b,c/n):l==="auto"?c:l),{attributes:{width:b.toString(),height:g.toString(),viewBox:s.left.toString()+" "+s.top.toString()+" "+n.toString()+" "+c.toString()},body:a}}let He=(()=>{let o;try{if(o=fetch,typeof o=="function")return o}catch{}})();function ya(o){He=o}function wa(){return He}function _a(o,e){const t=Ve(o);if(!t)return 0;let i;if(!t.maxURL)i=0;else{let s=0;t.resources.forEach(r=>{s=Math.max(s,r.length)});const a=e+".json?icons=";i=t.maxURL-s-t.path.length-a.length}return i}function $a(o){return o===404}const xa=(o,e,t)=>{const i=[],s=_a(o,e),a="icons";let r={type:a,provider:o,prefix:e,icons:[]},l=0;return t.forEach((n,c)=>{l+=n.length+1,l>=s&&c>0&&(i.push(r),r={type:a,provider:o,prefix:e,icons:[]},l=n.length),r.icons.push(n)}),i.push(r),i};function ka(o){if(typeof o=="string"){const e=Ve(o);if(e)return e.path}return"/"}const Sa={prepare:xa,send:(o,e,t)=>{if(!He){t("abort",424);return}let i=ka(e.provider);switch(e.type){case"icons":{const a=e.prefix,l=e.icons.join(","),n=new URLSearchParams({icons:l});i+=a+".json?"+n.toString();break}case"custom":{const a=e.uri;i+=a.slice(0,1)==="/"?a.slice(1):a;break}default:t("abort",400);return}let s=503;He(o+i).then(a=>{const r=a.status;if(r!==200){setTimeout(()=>{t($a(r)?"abort":"next",r)});return}return s=501,a.json()}).then(a=>{if(typeof a!="object"||a===null){setTimeout(()=>{a===404?t("abort",a):t("next",s)});return}setTimeout(()=>{t("success",a)})}).catch(()=>{t("next",s)})}};function Yi(o,e){switch(o){case"local":case"session":ae[o]=e;break;case"all":for(const t in ae)ae[t]=e;break}}function Xi(){ji("",Sa),Li(!0);let o;try{o=window}catch{}if(o){if(Ki(),o.IconifyPreload!==void 0){const t=o.IconifyPreload,i="Invalid IconifyPreload syntax.";typeof t=="object"&&t!==null&&(t instanceof Array?t:[t]).forEach(s=>{try{(typeof s!="object"||s===null||s instanceof Array||typeof s.icons!="object"||typeof s.prefix!="string"||!Ii(s))&&console.error(i)}catch{console.error(i)}})}if(o.IconifyProviders!==void 0){const t=o.IconifyProviders;if(typeof t=="object"&&t!==null)for(const i in t){const s="IconifyProviders["+i+"] is invalid.";try{const a=t[i];if(typeof a!="object"||!a||a.resources===void 0)continue;zi(i,a)||console.error(s)}catch{console.error(s)}}}}return{enableCache:t=>Yi(t,!0),disableCache:t=>Yi(t,!1),iconExists:Jo,getIcon:Qo,listIcons:Zo,addIcon:Pi,addCollection:Ii,calculateSize:Lt,buildIcon:Qi,loadIcons:Ot,loadIcon:pa,addAPIProvider:zi,_api:{getAPIConfig:Ve,setAPIModule:ji,sendAPIQuery:qi,setFetch:ya,getFetch:wa,listAPIProviders:aa}}}function es(o,e){let t=o.indexOf("xlink:")===-1?"":' xmlns:xlink="http://www.w3.org/1999/xlink"';for(const i in e)t+=" "+i+'="'+e[i]+'"';return'<svg xmlns="http://www.w3.org/2000/svg"'+t+">"+o+"</svg>"}function Ta(o){return o.replace(/"/g,"'").replace(/%/g,"%25").replace(/#/g,"%23").replace(/</g,"%3C").replace(/>/g,"%3E").replace(/\s+/g," ")}function Aa(o){return'url("data:image/svg+xml,'+Ta(o)+'")'}const Pt={"background-color":"currentColor"},ts={"background-color":"transparent"},is={image:"var(--svg)",repeat:"no-repeat",size:"100% 100%"},ss={"-webkit-mask":Pt,mask:Pt,background:ts};for(const o in ss){const e=ss[o];for(const t in is)e[o+"-"+t]=is[t]}function os(o){return o+(o.match(/^[-0-9.]+$/)?"px":"")}function Ea(o,e,t){const i=document.createElement("span");let s=o.body;s.indexOf("<a")!==-1&&(s+="<!-- "+Date.now()+" -->");const a=o.attributes,r=es(s,{...a,width:e.width+"",height:e.height+""}),l=Aa(r),n=i.style,c={"--svg":l,width:os(a.width),height:os(a.height),...t?Pt:ts};for(const b in c)n.setProperty(b,c[b]);return i}function Oa(o){const e=document.createElement("span");return e.innerHTML=es(o.body,o.attributes),e.firstChild}function as(o,e){const t=e.icon.data,i=e.customisations,s=Qi(t,i);i.preserveAspectRatio&&(s.attributes.preserveAspectRatio=i.preserveAspectRatio);const a=e.renderedMode;let r;switch(a){case"svg":r=Oa(s);break;default:r=Ea(s,{...we,...t},a==="mask")}const l=Array.from(o.childNodes).find(n=>{const c=n.tagName&&n.tagName.toUpperCase();return c==="SPAN"||c==="SVG"});l?r.tagName==="SPAN"&&l.tagName===r.tagName?l.setAttribute("style",r.getAttribute("style")):o.replaceChild(r,l):o.appendChild(r)}const It="data-style";function rs(o,e){let t=Array.from(o.childNodes).find(i=>i.hasAttribute&&i.hasAttribute(It));t||(t=document.createElement("style"),t.setAttribute(It,It),o.appendChild(t)),t.textContent=":host{display:inline-block;vertical-align:"+(e?"-0.125em":"0")+"}span,svg{display:block}"}function ns(o,e,t){const i=t&&(t.rendered?t:t.lastRender);return{rendered:!1,inline:e,icon:o,lastRender:i}}function Ca(o="iconify-icon"){let e,t;try{e=window.customElements,t=window.HTMLElement}catch{return}if(!e||!t)return;const i=e.get(o);if(i)return i;const s=["icon","mode","inline","width","height","rotate","flip"],a=class extends t{constructor(){super();Ye(this,"_shadowRoot");Ye(this,"_state");Ye(this,"_checkQueued",!1);const n=this._shadowRoot=this.attachShadow({mode:"open"}),c=Ct(this);rs(n,c),this._state=ns({value:""},c),this._queueCheck()}static get observedAttributes(){return s.slice(0)}attributeChangedCallback(n){if(n==="inline"){const c=Ct(this),b=this._state;c!==b.inline&&(b.inline=c,rs(this._shadowRoot,c))}else this._queueCheck()}get icon(){const n=this.getAttribute("icon");if(n&&n.slice(0,1)==="{")try{return JSON.parse(n)}catch{}return n}set icon(n){typeof n=="object"&&(n=JSON.stringify(n)),this.setAttribute("icon",n)}get inline(){return Ct(this)}set inline(n){this.setAttribute("inline",n?"true":null)}restartAnimation(){const n=this._state;if(n.rendered){const c=this._shadowRoot;if(n.renderedMode==="svg")try{c.lastChild.setCurrentTime(0);return}catch{}as(c,n)}}get status(){const n=this._state;return n.rendered?"rendered":n.icon.data===null?"failed":"loading"}_queueCheck(){this._checkQueued||(this._checkQueued=!0,setTimeout(()=>{this._check()}))}_check(){if(!this._checkQueued)return;this._checkQueued=!1;const n=this._state,c=this.getAttribute("icon");if(c!==n.icon.value){this._iconChanged(c);return}if(!n.rendered)return;const b=this.getAttribute("mode"),g=Ai(this);(n.attrMode!==b||Uo(n.customisations,g))&&this._renderIcon(n.icon,g,b)}_iconChanged(n){const c=ba(n,(b,g,v)=>{const y=this._state;if(y.rendered||this.getAttribute("icon")!==b)return;const w={value:b,name:g,data:v};w.data?this._gotIconData(w):y.icon=w});c.data?this._gotIconData(c):this._state=ns(c,this._state.inline,this._state)}_gotIconData(n){this._checkQueued=!1,this._renderIcon(n,Ai(this),this.getAttribute("mode"))}_renderIcon(n,c,b){const g=ga(n.data.body,b),v=this._state.inline;as(this._shadowRoot,this._state={rendered:!0,icon:n,inline:v,customisations:c,attrMode:b,renderedMode:g})}};s.forEach(l=>{l in a.prototype||Object.defineProperty(a.prototype,l,{get:function(){return this.getAttribute(l)},set:function(n){this.setAttribute(l,n)}})});const r=Xi();for(const l in r)a[l]=a.prototype[l]=r[l];return e.define(o,a),a}const La=Ca()||Xi(),{enableCache:qn,disableCache:Nn,iconExists:Fn,getIcon:Un,listIcons:Vn,addIcon:Bn,addCollection:Hn,calculateSize:Gn,buildIcon:Wn,loadIcons:Kn,loadIcon:Zn,addAPIProvider:Jn,_api:Qn}=La;class ls extends q{static get styles(){return S`
    ...
    `}}window.customElements.define("dt-icon",ls);class ds extends q{static get styles(){return S`
      :host {
        font-family: var(--font-family);
    ...
    `}}window.customElements.define("dt-checkmark",Ia);class z extends q{static get formAssociated(){return!0}static get styles(){return[S`
        .input-group {
          position: relative;
        }
    ...
    `:""}renderIcons(){return u`
      ${this.touched&&this.invalid?u`<dt-icon
            icon="mdi:alert-circle"
            class="icon-overlay alert"
            tooltip="${this.internals.validationMessage}"
            size="2rem"
          ></dt-icon>`:null}
      ${this.error?u`<dt-icon
            icon="mdi:alert-circle"
            class="icon-overlay alert"
            tooltip="${this.error}"
            size="2rem"
          ...
          ></dt-icon>`:null}
      ${this.loading?u`<dt-spinner class="icon-overlay"></dt-spinner>`:null}
      ${this.saved?u`<dt-checkmark class="icon-overlay success"></dt-checkmark>`:null}
    `}render(){return u`
      ${this.labelTemplate()}
      <slot></slot>
 ...
 */const us=(o,e,t)=>{const i=new Map;for(let s=e;s<=t;s++)i.set(o[s],s);return i},Ee=ct(class extends ut{constructor(o){if(super(o),o.type!==dt.CHILD)throw Error("repeat() can only be used in text expressions")}dt(o,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const s=[],a=[];let r=0;for(const l of o)s[r]=i?i(l,r):r,a[r]=t(l,r),r++;return{values:a,keys:s}}render(o,e,t){return this.dt(o,e,t).values}update(o,[e,t,i]){const s=za(o),{values:a,keys:r}=this.dt(e,t,i);if(!Array.isArray(s))return this.ut=r,a;const l=this.ut??(this.ut=[]),n=[];let c,b,g=0,v=s.length-1,y=0,w=a.length-1;for(;g<=v&&y<=w;)if(s[g]===null)g++;else if(s[v]===null)v--;else if(l[g]===r[y])n[y]=re(s[g],a[y]),g++,y++;else if(l[v]===r[w])n[w]=re(s[v],a[w]),v--,w--;else if(l[g]===r[w])n[w]=re(s[g],a[w]),Ae(o,n[w+1],s[g]),g++,w--;else if(l[v]===r[y])n[y]=re(s[v],a[y]),Ae(o,s[g],s[v]),v--,y++;else if(c===void 0&&(c=us(r,y,w),b=us(l,g,v)),c.has(l[g]))if(c.has(l[v])){const L=b.get(r[y]),N=L!==void 0?s[L]:null;if(N===null){const j=Ae(o,s[g]);re(j,a[y]),n[y]=j}else n[y]=re(N,a[y]),Ae(o,s[g],N),s[L]=null;y++}else Mt(s[v]),v--;else Mt(s[g]),g++;for(;y<=w;){const L=Ae(o,n[w+1]);re(L,a[y]),n[y++]=L}for(;g<=v;){const L=s[g++];L!==null&&Mt(L)}return this.ut=r,Da(o,n),U}}),Ra=o=>class extends o{constructor(){super(),this.activeIndex=-1,this.filteredOptions=[],this.detectTap=!1}static get properties(){return{...super.properties,value:{type:Array,reflect:!0},query:{type:String,state:!0},options:{type:Array},filteredOptions:{type:Array,state:!0},open:{type:Boolean,state:!0},canUpdate:{type:Boolean,state:!0},activeIndex:{type:Number,state:!0},containerHeight:{type:Number,state:!0},loading:{type:Boolean}}}willUpdate(e){if(super.willUpdate(e),e&&!this.containerHeight&&this.shadowRoot.children&&this.shadowRoot.children.length){const t=this.shadowRoot.querySelector(".input-group");t&&(this.containerHeight=t.offsetHeight)}}updated(){this._scrollOptionListToActive();const e=this.shadowRoot.querySelector(".input-group");!e.style.getPropertyValue("--container-width")&&e.clientWidth>0&&e.style.setProperty("--container-width",`${e.clientWidth}px`)}_select(){console.error("Must implement `_select(value)` function"),this._clearSearch()}static _focusInput(e){e.target===e.currentTarget&&e.target.getElementsByTagName("input")[0].focus()}_inputFocusIn(e){(!e.relatedTarget||!["BUTTON","LI"].includes(e.relatedTarget.nodeName))&&(this.open=!0,this.activeIndex=-1)}_inputFocusOut(e){(!e.relatedTarget||!["BUTTON","LI"].includes(e.relatedTarget.nodeName))&&(this.open=!1,this.canUpdate=!0)}_inputKeyDown(e){}_inputKeyUp(e){switch(e.keyCode||e.which){case 38:this.open=!0,this._listHighlightPrevious();break;case 40:this.open=!0,this._listHighlightNext();break;case 9:this.activeIndex<0?this.open=!1:e.preventDefault(),this._keyboardSelectOption();break;case 13:this._keyboardSelectOption();break;case 27:this.open=!1,this.activeIndex=-1;break;default:this.open=!0,this.query=e.target.value;break}}_scrollOptionListToActive(){const e=this.shadowRoot.querySelector(".option-list"),t=this.shadowRoot.querySelector("button.active");if(e&&t){const i=t.offsetTop,s=t.offsetTop+t.clientHeight,a=e.scrollTop,r=e.scrollTop+e.clientHeight;s>r?e.scrollTo({top:s-e.clientHeight,behavior:"smooth"}):i<a&&e.scrollTo({top:i,behavior:"smooth"})}}_touchStart(e){e.target&&(this.detectTap=!1)}_touchMove(e){e.target&&(this.detectTap=!0)}_touchEnd(e){this.detectTap||(e.target&&e.target.value&&this._clickOption(e),this.detectTap=!1)}_keyboardSelectOption(){this.activeIndex>-1&&(this.activeIndex+1>this.filteredOptions.length?this._select(this.query):this._select(this.filteredOptions[this.activeIndex].id))}_clickOption(e){e.target&&e.target.value&&this._select(e.target.value)}_clickAddNew(e){var t;e.target&&this._select((t=e.target.dataset)==null?void 0:t.label)}_clearSearch(){const e=this.shadowRoot.querySelector("input");e&&(e.value="")}_listHighlightNext(){this.allowAdd?this.activeIndex=Math.min(this.filteredOptions.length,this.activeIndex+1):this.activeIndex=Math.min(this.filteredOptions.length-1,this.activeIndex+1)}_listHighlightPrevious(){this.activeIndex=Math.max(0,this.activeIndex-1)}_renderOption(e,t){return u`
    ...
    `}_baseRenderOptions(){return this.filteredOptions.length?Ee(this.filteredOptions,e=>e.id,(e,t)=>this._renderOption(e,t)):this.loading?u`<li><div>${O("Loading options...")}</div></li>`:u`<li><div>${O("No Data Available")}</div></li>`}_renderOptions(){let e=this._baseRenderOptions();return this.allowAdd&&this.query&&(Array.isArray(e)||(e=[e]),e.push(u`<li tabindex="-1">
        <button
...
`}}window.customElements.define("dt-connection",hs);class ps extends Oe{static get styles(){return[...super.styles,S`
    ...
    `}}window.customElements.define("dt-users-connection",ps);class fs extends q{static get styles(){return S`
      :root {
        font-size: inherit;
 ...
 */function*Ge(o,e){if(o!==void 0){let t=0;for(const i of o)yield e(i,t++)}}class gs extends Oe{static get properties(){return{...super.properties,filters:{type:Array},mapboxKey:{type:String},dtMapbox:{type:Object}}}static get styles(){return[...super.styles,S`
    ...
    `}}window.customElements.define("dt-map-modal",ms);class Fa extends V{static get properties(){return{id:{type:String,reflect:!0},placeholder:{type:String},mapboxToken:{type:String,attribute:"mapbox-token"},googleToken:{type:String,attribute:"google-token"},validationMessage:{type:String},metadata:{type:Object},disabled:{type:Boolean},open:{type:Boolean,state:!0},query:{type:String,state:!0},activeIndex:{type:Number,state:!0},containerHeight:{type:Number,state:!0},loading:{type:Boolean},saved:{type:Boolean},error:{type:String},invalid:{type:Boolean},filteredOptions:{type:Array,state:!0}}}static get styles(){return[S`
        :host {
    ...
    `}_renderOptions(){const e=[];return this.filteredOptions.length?e.push(...this.filteredOptions.map((t,i)=>this._renderOption(t,i))):this.loading?e.push(u`<li><div>${O("Loading...")}</div></li>`):e.push(u`<li><div>${O("No Data Available")}</div></li>`),e.push(this._renderOption({value:this.query,label:this.query},(this.filteredOptions||[]).length,u`<strong>${O("Use")}: "${this.query}"</strong>`)),e}get classes(){return{"field-container":!0,invalid:this.invalid}}render(){var s,a,r,l;const e={display:this.open?"block":"none",top:this.containerHeight?`${this.containerHeight}px`:"2.5rem"},t=!!((s=this.metadata)!=null&&s.label),i=((a=this.metadata)==null?void 0:a.lat)&&((r=this.metadata)==null?void 0:r.lng);return u`
      <div class="input-group">
        ...
        ${this.invalid||this.error?u`<dt-icon
            icon="mdi:alert-circle"
            class="icon-overlay alert ${i?"selected":""}"
            tooltip="${this.validationMessage?this.validationMessage:this.error}"
            size="2rem"
          ></dt-icon>`:null}
        ${this.loading?u`<dt-spinner class="icon-overlay ${i?"selected":""}"></dt-spinner>`:null}
        ${this.saved?u`<dt-checkmark class="icon-overlay success ${i?"selected":""}"></dt-checkmark>`:null}
      </div>
...
`}}window.customElements.define("dt-location-map-item",Fa);class vs extends z{static get properties(){return{...super.properties,placeholder:{type:String},value:{type:Array,reflect:!0},locations:{type:Array,state:!0},open:{type:Boolean,state:!0},limit:{type:Number,attribute:"limit"},onchange:{type:String},mapboxToken:{type:String,attribute:"mapbox-token"},googleToken:{type:String,attribute:"google-token"}}}static get styles(){return[...super.styles,S`
    ...
    `:""}renderItem(e,t){return u`
      <dt-location-map-item
        ...
        ?loading=${t===0?this.loading:!1}
        ?saved=${t===0?this.saved:!1}
        error=${t===0?this.error:""}
      ></dt-location-map-item>
 ...
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ue=o=>o??E;class ys extends z{static get styles(){return[...super.styles,S`
        input {
          color: var(--dt-form-text-color, #000);
          appearance: none;
          background-color: var(--dt-form-background-color, #fff);
    ...
    `}}window.customElements.define("dt-textarea",_s);class $s extends z{static get styles(){return[...super.styles,S`
      ...
      `]}static get properties(){return{...super.properties,id:{type:String},checked:{type:Boolean,reflect:!0},onchange:{type:String},hideIcons:{type:Boolean,default:!0}}}constructor(){super(),this.hideIcons=!1}onChange(e){const t=new CustomEvent("change",{detail:{field:this.name,oldValue:this.checked,newValue:e.target.checked}});this.checked=e.target.checked,this._setFormValue(this.checked),this.dispatchEvent(t)}render(){const e=u`<svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" class="Toggle__icon Toggle__icon--checkmark"><path d="M6.08471 10.6237L2.29164 6.83059L1 8.11313L6.08471 13.1978L17 2.28255L15.7175 1L6.08471 10.6237Z" fill="currentcolor" stroke="currentcolor" /></svg>`,t=u`<svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" class="Toggle__icon Toggle__icon--cross"><path d="M11.167 0L6.5 4.667L1.833 0L0 1.833L4.667 6.5L0 11.167L1.833 13L6.5 8.333L11.167 13L13 11.167L8.333 6.5L13 1.833L11.167 0Z" fill="currentcolor" /></svg>`;return u`
 ...
 */function Ua(o,e,t){return o?e(o):t==null?void 0:t(o)}class xs extends zt{static get styles(){return[...super.styles,S`
      ...
      `]}static get properties(){return{...super.properties,value:{type:Array,reflect:!0}}}updated(e){var t;if(e.has("value")){const i=e.get("value");i&&(i==null?void 0:i.length)!==((t=this.value)==null?void 0:t.length)&&this.focusNewItem()}}focusNewItem(){const e=this.shadowRoot.querySelectorAll("input");e&&e.length&&e[e.length-1].focus()}_addItem(){const e={verified:!1,value:"",tempKey:Date.now().toString()};this.value=[...this.value,e]}_removeItem(e){const t=e.currentTarget.dataset.key;if(t){const i=new CustomEvent("change",{bubbles:!0,detail:{field:this.name,oldValue:this.value}}),s=this.value.filter(a=>a.tempKey!==t).map(a=>{const r={...a};return a.key===t&&(r.delete=!0),r});s.filter(a=>!a.delete).length||s.push({value:"",tempKey:Date.now().toString()}),this.value=s,i.detail.newValue=this.value,this.dispatchEvent(i),this._setFormValue(this.value)}}_change(e){var i,s;const t=(s=(i=e==null?void 0:e.currentTarget)==null?void 0:i.dataset)==null?void 0:s.key;if(t){const a=new CustomEvent("change",{detail:{field:this.name,oldValue:this.value}});this.value=this.value.map(r=>{var l;return{...r,value:r.key===t||r.tempKey===t?(l=e.target)==null?void 0:l.value:r.value}}),a.detail.newValue=this.value,this._setFormValue(this.value),this.dispatchEvent(a)}}_inputFieldTemplate(e,t){return u`
      <div class="field-container">
        <input
    ...
    `}_renderInputFields(){return(!this.value||!this.value.length)&&(this.value=[{verified:!1,value:"",tempKey:Date.now().toString()}]),u`
    ...
    <dt-button
      ...
      value="${e.id}"
    >
      ${e.icon?u`<span class="icon"><img src="${e.icon}" alt="${this.iconAltText}" /></span>`:null}
      ${e.label}
    </dt-button>
    ...
    `}}window.customElements.define("dt-multi-select-button-group",ks);class Ss extends q{static get styles(){return S`
      :host {
        display: block;
      }
    ...
    `}}window.customElements.define("dt-alert",Ss);class Ts extends q{static get styles(){return S`
      :host {
        --number-of-columns: 7;
    ...
    `}static get properties(){return{postType:{type:String},postTypeLabel:{type:String},posttypesettings:{type:Object,attribute:!0},posts:{type:Array},total:{type:Number},columns:{type:Array},sortedBy:{type:String},loading:{type:Boolean,default:!0},offset:{type:Number},showArchived:{type:Boolean,default:!1},showFieldsSelector:{type:Boolean,default:!1},showBulkEditSelector:{type:Boolean,default:!1},nonce:{type:String},payload:{type:Object},favorite:{type:Boolean},initialLoadPost:{type:Boolean,default:!1},loadMore:{type:Boolean,default:!1},headerClick:{type:Boolean,default:!1}}}constructor(){super(),this.sortedBy="name",this.payload={sort:this.sortedBy,overall_status:["-closed"],fields_to_return:this.sortedColumns},this.initalLoadPost=!1,this.initalLoadPost||(this.posts=[],this.limit=100)}firstUpdated(){this.postTypeSettings=window.post_type_fields,this.sortedColumns=this.columns.includes("favorite")?["favorite",...this.columns.filter(e=>e!=="favorite")]:this.columns,this.style.setProperty("--number-of-columns",this.columns.length-1)}async _getPosts(e){const t=await new CustomEvent("dt:get-data",{bubbles:!0,detail:{field:this.name,postType:this.postType,query:e,onSuccess:i=>{this.initalLoadPost&&this.loadMore&&(this.posts=[...this.posts,...i],this.postsLength=this.posts.length,this.total=i.length,this.loadMore=!1),this.initalLoadPost||(this.posts=[...i],this.offset=this.posts.length,this.initalLoadPost=!0,this.total=i.length),this.headerClick&&(this.posts=i,this.offset=this.posts.length,this.headerClick=!1),this.total=i.length},onError:i=>{console.warn(i)}}});this.dispatchEvent(t)}_headerClick(e){const t=e.target.dataset.id;this.sortedBy===t?t.startsWith("-")?this.sortedBy=t.replace("-",""):this.sortedBy=`-${t}`:this.sortedBy=t,this.payload={sort:this.sortedBy,overall_status:["-closed"],limit:this.limit,fields_to_return:this.columns},this.headerClick=!0,this._getPosts(this.payload)}static _rowClick(e){window.open(e,"_self")}_bulkEdit(){this.showBulkEditSelector=!this.showBulkEditSelector}_fieldsEdit(){this.showFieldsSelector=!this.showFieldsSelector}_toggleShowArchived(){if(this.showArchived=!this.showArchived,this.headerClick=!0,this.showArchived){const{overall_status:e,offset:t,...i}=this.payload;this.payload=i}else this.payload.overall_status=["-closed"];this._getPosts(this.payload)}_sortArrowsClass(e){return this.sortedBy===e?"sortedBy":""}_sortArrowsToggle(e){return this.sortedBy!==`-${e}`?`-${e}`:e}_headerTemplate(){return this.postTypeSettings?u`
        <thead>
          <tr>
            ...
            ${Ge(this.sortedColumns,e=>{const t=e==="favorite";return u`<th
                class="all"
      ...
      `:null}_rowTemplate(){if(this.posts&&Array.isArray(this.posts)){const e=this.posts.map((t,i)=>this.showArchived||!this.showArchived&&t.overall_status!=="closed"?u`
            ...
            `:null).filter(t=>t!==null);return e.length>0?e:u`<p>No contacts available</p>`}return null}formatDate(e){const t=new Date(e);return new Intl.DateTimeFormat("en-US",{month:"long",day:"numeric",year:"numeric"}).format(t)}_cellTemplate(e){return Ge(this.sortedColumns,t=>{if(["text","textarea","number"].includes(this.postTypeSettings[t].type))return u` <td
          dir="auto"
      ...
      />`:null}_fieldsListTemplate(){return Ee(Object.keys(this.postTypeSettings).sort((e,t)=>{const i=this.postTypeSettings[e].name.toUpperCase(),s=this.postTypeSettings[t].name.toUpperCase();return i<s?-1:i>s?1:0}),e=>e,e=>this.postTypeSettings[e].hidden?null:u`<li class="list-field-picker-item">
            <label>
              <input
                type="checkbox"
                id="${e}"
    ...
    `}}window.customElements.define("dt-list",Ts);class As extends q{static get styles(){return S`
      :host {
    ...
    `}static get properties(){return{title:{type:String},expands:{type:Boolean},collapsed:{type:Boolean}}}get hasHeading(){return this.title||this.expands}_toggle(){this.collapsed=!this.collapsed}renderHeading(){return this.hasHeading?u`
