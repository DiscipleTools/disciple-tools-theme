...
<?php
    ...
    function dt_contact_details_status( $id, $verified, $invalid ){
        ?>
<img id="<?php echo esc_attr( $id . '-verified', 'disciple_tools' ); ?>" class="details-status"
    style="display: <?php echo esc_attr( $verified, 'disciple_tools' ); ?>"
    src="<?php echo esc_url( get_template_directory_uri() ) . '/dt-assets/images/verified.svg'; ?>" />
...
<section class="bordered-box">
    ...
    <div class="grid-x grid-margin-x" style="margin-top: 20px">
        <div class="cell small-12 medium-4">
            ...
            ?>
            <select id="group_status" class="status select-field color-select"
                style="background-color: <?php echo esc_html( $active_color ) ?>">
                    ...
                    <div class="typeahead__container">
                        <div class="typeahead__field">
                            <span class="typeahead__query">
                                <input class="js-typeahead-assigned_to input-height" name="assigned_to[query]"
                                    placeholder="<?php esc_html_e( "Search Users", 'disciple_tools' ) ?>"
                                    autocomplete="off">
                            </span>
                            <span class="typeahead__button">
                                <button type="button" class="search_assigned_to typeahead__image_button input-height"
            ...
            <div class="coaches">
                ...
                <div id="coaches_t" name="form-coaches" class="scrollable-typeahead">
                    <div class="typeahead__container">
                        <div class="typeahead__field">
                            <span class="typeahead__query">
                                <input class="js-typeahead-coaches" name="coaches[query]"
                                    placeholder="<?php esc_html_e( "Search Users and Contacts", 'disciple_tools' ) ?>"
                                    autocomplete="off">
                            </span>
                        </div>
                    </div>
    ...
    <div class="display-fields grid-x grid-margin-x">
        ...
        <div class="xlarge-4 large-6 medium-6 small-12 cell">
            ...
            <ul class="people_groups-list details-list">
                ...
                <li class="<?php echo esc_html( $value["ID"] )?>">
                    <a
                        href="<?php echo esc_url( $value["permalink"] ) ?>"><?php echo esc_html( $value["post_title"] ) ?></a>
                </li>
                <?php }
        ...
        <div class="xlarge-4 large-6 medium-6 small-12 cell">
            <div class="section-subheader"><img
                    src="<?php echo esc_url( get_template_directory_uri() ) . '/dt-assets/images/date-start.svg' ?>">
                <?php esc_html_e( 'Start Date', 'disciple_tools' )?></div>
    ...
    <div class="display-fields">
        ...
        <div class="grix-x">
            ...
            <div class="location_grid">
                ...
                <div id="location_grid_t" name="form-location_grid"
                    class="scrollable-typeahead typeahead-margin-when-active">
                    <div class="typeahead__container">
                        <div class="typeahead__field">
                            <span class="typeahead__query">
                                <input class="js-typeahead-location_grid" name="location_grid[query]"
        ...
        <div class="grix-x">
            ...
            <div class="start_date input-group">
                <input id="start_date" class="input-group-field date-picker" type="text">
                <div class="input-group-button">
                    <button id="start_date_clear" class="button alert" title="Delete Date">x</button>
                </div>
            </div>
        </div>
        ...
        <div class="grix-x">
            ...
            <div class="church_start_date input-group">
                <input id="church_start_date" class="input-group-field date-picker" type="text">
                <div class="input-group-button">
                    <button id="church_start_date_clear" class="button alert" title="Delete Date">x</button>
                </div>
            </div>
        ...
        <div class="grix-x">
            ...
            <div class="end_date input-group">
                <input id="end_date" class="input-group-field date-picker" type="text">
                <div class="input-group-button">
                    <button id="end_date_clear" class="button alert" title="Delete Date">x</button>
                </div>
            </div>
        </div>
            ...
            <div class="people_groups">
                ...
                <div id="people_groups_t" name="form-people_groups" class="scrollable-typeahead">
                    <div class="typeahead__container">
                        <div class="typeahead__field">
                            <span class="typeahead__query">
                                <input class="js-typeahead-people_groups" name="people_groups[query]"
                                    placeholder="<?php esc_html_e( "Search People Groups", 'disciple_tools' ) ?>"
                                    autocomplete="off">
                            </span>
                        </div>
                    </div>
