    ...
    <div class="display-fields">
        ...
        <div class="grid-x">
            ...
            <div class="start_date input-group">
                <input id="start_date" class="input-group-field date-picker" type="text" autocomplete="off">
        ...
        <div class="grid-x">
            ...
            <div class="church_start_date input-group">
                <input id="church_start_date" class="input-group-field date-picker" type="text" autocomplete="off">
                <div class="input-group-button">
        ...
        <div class="grid-x">
            ...
            <div class="end_date input-group">
                <input id="end_date" class="input-group-field date-picker" type="text" autocomplete="off">
                <div class="input-group-button">
