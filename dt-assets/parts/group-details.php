...
<section class="bordered-box">
    ...
    <div class="display-fields grid-x grid-margin-x">
        ...
        <div class="xlarge-4 large-6 medium-6 small-12 cell">
            <div class="section-subheader"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/dt-assets/images/date-success.svg' ?>">
<?php esc_html_e( 'Church Start Date', 'disciple_tools' )?></div>
        ...
        <div class="xlarge-4 large-6 medium-6 small-12 cell">
            <div class="section-subheader">            <img src="<?php echo esc_url( get_template_directory_uri() ) . '/dt-assets/images/date-end.svg' ?>">
<?php esc_html_e( 'End Date', 'disciple_tools' )?></div>
