...
(function ($, list_settings, Foundation) {
  ...
  // Handle dt-multi-select component changes
  $(document).on('change', '#field_selection_component', function (e) {
    const newValue = e.detail.newValue || [];

    // Update the hidden input for backward compatibility
    $('#selected_fields_input').val(JSON.stringify(newValue));

    // Update the global variable
    fields_to_show_in_table = newValue;
  });
