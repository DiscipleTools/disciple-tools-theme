...
window.API = {
  ...
  edit_tile: (post_type, tile_key, tile_label, hide_tile) => makeRequest("POST", `edit-tile`, {
    post_type: post_type,
    tile_key: tile_key,
  ...
  edit_field: (post_type, tile_key, field_key, custom_name, field_private, tile_select, field_description, field_icon) => makeRequest("POST", `edit-field`, {
    post_type: post_type,
    tile_key: tile_key,
    field_key: field_key,
  ...
  edit_field_option: (post_type, tile_key, field_key, field_option_key, new_field_option_label, new_field_option_description) => makeRequest("POST", `edit-field-option`, {
    post_type: post_type,
    tile_key: tile_key,
    field_key: field_key,
    field_option_key: field_option_key,
  ...
  update_tile_and_fields_order: (post_type, dt_custom_tiles_and_fields_ordered) => makeRequest("POST", `update-tiles-and-fields-order`, {
    post_type: post_type,
