                    ...
                    <div class="cell small-4 grid-x grid-margin-x">
                        ...
                        <div class="cell grid-x shrink center-items">
                            <a class="section-chevron navigation-left" href="javascript:void(0)">
                                <img width="25" height="20" alt="previous record" src="<?php echo esc_url( get_template_directory_uri() . "/dt-assets/images/chevron_left.svg" ) ?>">
                            </a>
                        </div>
                        <div class="cell shrink center-items">
                            <a href="javascript:void(0)" class="navigation-right section-chevron">
                                <img width="25" height="20" alt="next record" src="<?php echo esc_url( get_template_directory_uri() . "/dt-assets/images/chevron_right.svg" ) ?>">
                            </a>
                        </div>
                        <div class="cell grid-x shrink center-items">
    ...
    <nav role="navigation"
        ...
        <?php if ( $comment_button ): ?>
            ...
            <div class="grid-x align-center" style="align-items: center">
                <div class="cell shrink center-items">
                    <a class="section-chevron navigation-left" href="javascript:void(0)">
                        <img width="15" height="10" alt="previous record" src="<?php echo esc_url( get_template_directory_uri() . "/dt-assets/images/chevron_left.svg" ) ?>">
                    </a>
                </div>
                <div class="cell shrink center-items">
                    <a href="javascript:void(0)" class="navigation-right section-chevron">
                        <img width="15" height="10" alt="next record" src="<?php echo esc_url( get_template_directory_uri() . "/dt-assets/images/chevron_right.svg" ) ?>">
                    </a>
                </div>
