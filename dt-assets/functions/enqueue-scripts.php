            ...
            wp_localize_script(
                'comments', 'commentsSettings', [
                    ...
                    'translations' => [
                        ...
                        "reaction_title_1" => _x( '%1$s reacted with %2$s emoji', 'Bob reacted with heart emoji (dont translate words in brackets)', 'disciple_tools' ),
                        "reaction_title_many" => _x( '%3$s and %1$s reacted with %2$s emoji', 'Bob, Bill and Ben reacted with heart emoji (dont translate words in brackets)', 'disciple_tools' ),
                    ],
                    'current_user_id' => get_current_user_id(),
