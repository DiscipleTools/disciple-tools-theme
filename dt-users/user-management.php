...
class DT_User_Management
{
    ...
    public function __construct() {
        ...
        if ( self::has_permission() ){
            if ( str_contains( $url_path, 'user-management' ) ) {
                add_filter( 'dt_metrics_menu', [ $this, 'add_menu' ], 20 );
            }
            if ( str_contains( $url_path, 'user-management/user' ) || ( str_contains( $url_path, 'user-management/add-user' ) && ( current_user_can( "create_users" ) ) ) ){
