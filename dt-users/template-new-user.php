                                    ...
                                    <div class="grid-x row gutter-small">
                                        <div class="cell medium-6">
                                            ...
                                            <dl>
                                                ...
                                                <dd><input type="text" class="input" id="name" placeholder="<?php esc_html_e( 'Nickname (Display Name)', 'disciple_tools' ); ?>" required autocomplete="off" /> </dd>
                                                <dt><label for="email"><?php esc_html_e( 'Email', 'disciple_tools' ); ?></label></dt>
                                                <dd><input type="email" class="input" id="email" placeholder="<?php esc_html_e( 'Email', 'disciple_tools' ); ?>" required autocomplete="off" /> </dd>
                                                <div class="hidden-fields" style="display:none">
                                                    <dt><label for="username"><?php esc_html_e( 'Username', 'disciple_tools' ); ?></label></dt>
                                                    <dd><input type="text" class="input" id="username" placeholder="<?php esc_html_e( 'Username', 'disciple_tools' ); ?>" autocomplete="off" /> </dd>
                                                    <dt><label for="password"><?php esc_html_e( 'Password', 'disciple_tools' ); ?></label></dt>
                                                    <dd><input type="password" class="input" id="password" placeholder="<?php esc_html_e( 'Password', 'disciple_tools' ); ?>" autocomplete="off" /> </dd>
                                                </div>
                                                <?php if ( $current_user_can_manage_users ) : ?>
