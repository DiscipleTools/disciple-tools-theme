    ...
    public function dt_custom_fields_settings( $fields, $post_type ){
        if ( $post_type === 'contacts' ){
            ...
            $fields["contact_other"] = [
                ...
                "icon" => get_template_directory_uri() . "/dt-assets/images/links.svg?v=2",
                "hide_domain" => false,
                "type" => "communication_channel",
                "tile" => "details",
                "customizable" => false
            ...
            $fields['gender'] = [
                ...
                'tile'     => 'details',
                "icon" => get_template_directory_uri() . "/dt-assets/images/gender-male-female.svg?v=2",
            ];
    ...
    public static function dt_record_admin_actions( $post_type, $post_id ){
        if ( $post_type === "contacts" ){
            ...
            <li><a data-open="merge-dupe-edit-modal">
                    <img class="dt-icon" src="<?php echo esc_html( get_template_directory_uri() . '/dt-assets/icons/account-box-multiple.svg?v=2' ) ?>"/>

                    <?php esc_html_e( "View Duplicates", 'disciple_tools' ) ?></a></li>
