        ...
        if ( $post_type === "contacts" ) {
            ...
            if ( empty( $post["archive"] ) && ( $post["type"]["key"] === "personal" || $post["type"]["key"] === "placeholder" ) ) :?>
                <li>
                    <a data-open="archive-record-modal">
                        <img class="dt-icon"
                             src="<?php echo esc_html( get_template_directory_uri() . '/dt-assets/images/archive.svg?v=2' ) ?>"/>
                        <?php echo esc_html( sprintf( _x( "Archive %s", "Archive Contact", 'disciple_tools' ), DT_Posts::get_post_settings( $post_type )["label_singular"] ) ) ?>
                    </a>
                </li>
            <?php endif; ?>
            ...
            <li>
                <a data-open="contact-type-modal">
                    <img class="dt-icon"
                         src="<?php echo esc_html( get_template_directory_uri() . '/dt-assets/images/circle-square-triangle.svg?v=2' ) ?>"/>
                    <?php echo esc_html( sprintf( _x( "Change %s Type", "Change Record Type", 'disciple_tools' ), DT_Posts::get_post_settings( $post_type )["label_singular"] ) ) ?>
                </a>
            </li>
        ...
        if ( $post_type === "contacts" ) :
            ...
            <div class="reveal"
                ...
                <div class="grid-x">
                    ...
                    <button class="button alert loader"
                            type="button"
                            id="archive-record">
                ...
                <div class="bordered-box detail-notification-box"
                    ...
                    <h4>
                        <img class="dt-white-icon"
                             src="<?php echo esc_html( get_template_directory_uri() . '/dt-assets/images/alert-circle-exc.svg?v=2?v=2' ) ?>"/>
                        <?php echo esc_html( sprintf( __( 'This %s is archived', 'disciple_tools' ), strtolower( $post_settings["label_singular"] ) ) ) ?>
                    </h4>
                    <button class="button"
                            id="unarchive-record"><?php esc_html_e( 'Restore', 'disciple_tools' ) ?></button>
                </div>
            </section>
        <?php endif;
