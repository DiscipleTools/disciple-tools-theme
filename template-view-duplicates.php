        ...
        <div id="inner-content" class="grid-x grid-margin-x">
            ...
            <main id="main" class="large-12 medium-12 cell" role="main">
                <div class="bordered-box">
                    <h3><?php esc_html_e( 'Duplicate Contacts', 'zume' ) ?><button class="help-button float-right" data-section="duplicates-template-help-text">
                    ...
                    <table id='table-duplicates'>
                        ...
                        foreach ( $dt_duplicates as $dt_id => $dt_duplicate ) {
                            ...
                            <a>" . esc_html( $dt_duplicate['count'] ). /* esc_html_e( 'duplicates' ) . */ " duplicates</a></td></tr>";
                        }
                        ?>
                    </table>
                </div>
