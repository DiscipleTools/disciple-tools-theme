...
class DT_Groups_Base extends DT_Module_Base {
    ...
    public function dt_get_post_type_settings( $settings, $post_type ){
        if ( $post_type === $this->post_type ){
            ...
            $settings['label_singular'] = $post_type_updates[$this->post_type]['label_singular'] ?? __( 'Group', 'disciple_tools' );
            $settings['label_plural'] = $post_type_updates[$this->post_type]['label_plural'] ?? __( 'Groups', 'disciple_tools' );
