...
done < <(find . -path ./vendor -prune -path ./dt-core/dependencies -prune -o -path ./dt-assets/build -prune -o -path ./node_modules -prune -o -path ./dependencies -prune -o -name "*.js" -print0)
