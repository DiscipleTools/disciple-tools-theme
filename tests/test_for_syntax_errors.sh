...
done < <(find . -path ./vendor -prune -path ./dt-core/dependencies -prune -o -path ./dt-assets/build/components -prune -o -path ./node_modules -prune -o -path ./dt-core/dependencies -prune -o -name "*.js" -print0)
