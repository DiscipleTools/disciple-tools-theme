...
class P2P_Box {
	...
	public function init_scripts() {
		...
		wp_enqueue_style( 'p2p-box', P2P_URL .'admin/box.css', // @added by DT
			array(), P2P_PLUGIN_VERSION );

		wp_register_script( 'mustache', P2P_URL . 'admin/mustache.js', // @added by DT
			array(), '0.7.2', true );

		wp_enqueue_script( 'p2p-box', P2P_URL . 'admin/box.js', // @added by DT
