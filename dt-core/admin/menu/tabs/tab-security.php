...
class Disciple_Tools_Security_Tab extends Disciple_Tools_Abstract_Menu_Base
{
    ...
    public function show_dt_api_whitelist(){
        ...
        <form method="post" >
            ...
            <p><?php esc_html_e( 'Examples:', 'disciple_tools' ) ?></p>
            <ul style="list-style: disc; padding: revert">
                <li><?php esc_html_e( 'wp-json/my-plugin/v1/my-endpoint/', 'disciple_tools' ) ?></li>
                <li><?php esc_html_e( 'wp-json/my-plugin/v1/my-endpoint/update', 'disciple_tools' ) ?></li>
                <li><?php esc_html_e( 'wp-json/my-plugin/v1/my-endpoint/*, matching all paths starting with this base', 'disciple_tools' ) ?></li>
            </ul>
