...
class Disciple_Tools_Utilities_Fields_Tab extends Disciple_Tools_Abstract_Menu_Base
{
    ...
    public function box_message( $post_type ) {
        ...
        $types = [ 'text', 'textarea', 'date', 'datetime', 'boolean', 'key_select', 'multi_select', 'array', 'connection', 'number', 'link', 'communication_channel', 'tags', 'user_select', 'task', 'location', 'location_meta', 'file_upload' ];
                    ...
                    <tr>
                        <td>
                            <form method="get">
                                ...
                                <button type="submit" class="button" name="field_selected"><?php esc_html_e( 'Edit', 'disciple_tools' ) ?></button>
                            </form>
                        </td>
