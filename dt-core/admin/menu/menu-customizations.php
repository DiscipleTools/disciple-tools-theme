...
class Disciple_Tools_Customizations_Menu
{
    ...
    public function add_dt_customizations_menu() {
        ...
        add_menu_page( __( 'Customizations (D.T)', 'disciple_tools' ), __( 'Customizations (D.T)', 'disciple_tools' ), 'manage_dt', 'dt_customizations', [ $this, 'content' ], $image_url, 59 );
    }
    ...
    public function content() {
        ...
        ?>
        <div class="wrap">
            <h2><?php esc_attr_e( 'DISCIPLE TOOLS : CUSTOMIZATIONS' ) ?></h2>
