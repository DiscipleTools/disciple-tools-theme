...
class Disciple_Tools_Customizations_Menu
{
    ...
    public function __construct() {
        add_action( 'admin_menu', array( $this, 'add_dt_customizations_menu' ) );
    }
    ...
    public function add_dt_customizations_menu() {
        ...
        add_menu_page( __( 'Customizations (D.T) BETA', 'disciple_tools' ), __( 'Customizations (D.T) BETA', 'disciple_tools' ), 'manage_dt', 'dt_customizations', array( $this, 'content' ), $image_url, 59 );
    }
