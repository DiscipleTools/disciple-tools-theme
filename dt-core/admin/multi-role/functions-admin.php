...
function dt_multi_role_admin_register_scripts() {
    ...
    dt_theme_register_script( 'members-settings', "js/settings{$min}.js", [ 'jquery' ], true );
    dt_theme_register_script( 'members-edit-role', "js/edit-role{$min}.js", [ 'postbox', 'wp-util' ], true );
...
function dt_multi_role_admin_register_styles() {
    ...
    dt_theme_register_style( 'members-admin', "css/admin{$min}.css" );
}
