...
function dt_release_modal() {
    ...
    $show_notification_for_theme_version = '1.41.0'; // increment this number with each new release modal
            ...
            <div id='release-modal' class='reveal medium' data-reveal>
                ...
                <div id="release-modal-content">
                    <div class="dt-tab-wrapper">
                        <a href="#" id="release-modal-theme-news-tab" data-content="theme-news-content" class="dt-tab" style="padding-right:0px">
                            <?php esc_html_e( 'Theme News', 'disciple_tools' ); ?>
                            <span class="badge alert" style="display: inline-block; position:relative; top:-11px">1</span>
                        </a>
                        ...
                        <a href="#" id="release-modal-get-involved-tab" data-content="get-involved-content" class="dt-tab dt-tab-active"><?php esc_html_e( 'Get Involved', 'disciple_tools' ); ?></a>
                    </div>
                    <div class="dt-tab-content dt-hide-content" id="theme-news-content">
                        <p>
                    ...
                    <div class="dt-tab-content" id="get-involved-content">
