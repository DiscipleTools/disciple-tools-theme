            ...
            <div id='release-modal' class='reveal medium' data-reveal>
                ...
                <div id="release-modal-content">
                    <div class="dt-tab-wrapper">
                        ...
                        <a href="#" id="release-modal-translations-tab" data-content="translations-content" class="dt-tab">
                            <svg class="dt-tab-icon" viewBox="0 0 24 24">
                        ...
                        <a href="#" id="release-modal-get-involved-tab" data-content="get-involved-content" class="dt-tab">
                            <svg class="dt-tab-icon" viewBox="0 0 24 24">
