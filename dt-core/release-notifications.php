            ...
            <div id='release-modal' class='reveal medium' data-reveal>
                <div class="release-banner">
                    <div class="release-banner-text">
                        ...
                        <h4><?php echo sprintf( esc_html__( 'Disciple.Tools Theme Version %1$s', 'disciple_tools' ), $show_notification_for_theme_version ); ?></h4>
                    </div>
                </div>
                    ...
                    <div class="dt-tab-content dt-hide-content" id="get-involved-content">
                        <p>
                            <h5>
                                ...
                                <b><?php esc_html_e( 'Give', 'disciple_tools' ); ?></b>
                            </h5>
                            <p><?php esc_html_e( 'Make Disciple.Tools better by joining us financially.', 'disciple_tools' ); ?> Join us <a href="https://disciple.tools/give/" target="_blank">here</a>.</p>
                        </p>
                        <br>
                        <p>
                            <h5>
                                ...
                                <b><?php esc_html_e( 'Translate', 'disciple_tools' ); ?></b>
                            </h5>
                            <p>Translate Disciple.Tools into your language or help make a translation better <a href="https://poeditor.com/join/project/KcPvw3oaKD" target="_blank">here</a>.</p>
                        </p>
                        <br>
                        <p>
                            <h5>
                                ...
                                <b><?php esc_html_e( 'Build or Document', 'disciple_tools' ); ?></b>
                            </h5>
                            <p><?php esc_html_e( 'Make Disciple.Tools better by building a feature or helping us make the documentation better.', 'disciple_tools' ); ?> Find out more <a href="https://disciple.tools/join-the-community/" target="_blank">here</a>.</p>
                        </p>
                    </div>
                </div>
                <br>
