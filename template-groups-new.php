...
-->
                <div style="text-align: center">
                    <a href="/groups/" class="button small clear" title="<?php esc_html_e( 'Cancel and return to the Groups List page', 'disciple_tools' )?>"><?php echo esc_html_x( 'Cancel', 'button', 'disciple_tools' )?></a>
