...
(function () {
    ...
    <div data-sticky-container class="hide-for-small-only" style="z-index: 9">
        <nav role="navigation" data-sticky data-options="marginTop:0;" data-top-anchor="1"
            class="second-bar list-actions-bar">
            <div class="container-width buttons-row"><!--  /* DESKTOP VIEW BUTTON AREA */ -->
                <a class="button dt-green create-post-desktop"
                    href="<?php echo esc_url(home_url('/') . $post_type) . '/new' ?>">
                    <img class="dt-white-icon" style="display: inline-block;"
                        src="<?php echo esc_html(get_template_directory_uri() . '/dt-assets/images/circle-add.svg') ?>" />
                    <span
                        class="hide-for-small-only"><?php echo esc_html(sprintf(_x('Create New %s', 'Create New record', 'disciple_tools'), $post_settings['label_singular'] ?? $post_type)) ?></span>
                </a>
                <a class="button filter-posts-desktop" data-open="filter-modal">
                    <img class="dt-white-icon" style="display: inline-block;"
                        src="<?php echo esc_html(get_template_directory_uri() . '/dt-assets/images/filter.svg?v=2') ?>" />
                ...
                <div class="search-wrapper">
                    <span class="text-input-wrapper">
                        <input class="search-input search-input--desktop" style="margin-right: 0;" type="text"
                        ...
                        <div class="search-input__clear-button"
                            title="<?php echo esc_html(__('Clear', 'disciple_tools')) ?>">
                            <span>&times;</span>
                        </div>
                    </span>
                    <a class="advanced_search" id="advanced_search"
                        ...
                        ?>
                        <span class="badge alert advancedSearch-count" style="<?php if (!$fields_to_search) {
                            echo esc_html('display:none'); } ?>"><?php if ($fields_to_search) {
                                   echo count($fields_to_search); } ?></span>
                    </a>
                </div>
                ...
                <?php if (class_exists('DT_Mapbox_API') && DT_Mapbox_API::get_key()): ?>
                    <button class="button export_map_list no-margin icon-button"
                        style="font-size:large;padding: 0.1rem 0.75rem">
                        <i class="fi-map"></i>
                    </button>
                <?php endif; ?>
            </div>
            <div id="advanced_search_picker" class="list_field_picker"
                style="display:none; padding:20px; border-radius:5px; background-color:#ecf5fc;">
                ...
                <ul class="ul-no-bullets" style="">
                    ...
                    <li style="" class="">
                        <label style="margin-right:15px; cursor:pointer">
                            <input type="checkbox" value="all" <?php echo esc_html(in_array('all', $fields_to_search) ? 'checked' : ''); ?> style="margin:0">
                    ...
                    <li style="" class="">
                        <label style="margin-right:15px; cursor:pointer">
                            <input type="checkbox" value="comms" <?php echo esc_html(in_array('comms', $fields_to_search) ? 'checked' : ''); ?> style="margin:0">
                    ...
                    <?php foreach ($all_searchable_fields as $field_key => $field_values):
                        ...
                        <li style="" class="">
                            <label style="margin-right:15px; cursor:pointer">
                                <input type="checkbox" value="<?php echo esc_html($field_key); ?>" <?php echo esc_html(in_array($field_key, $fields_to_search) ? 'checked' : '');
                                   ?> style="margin:0">
                ...
                <button class="button" id="save_advanced_search_choices"
                    style="display: inline-block"><?php esc_html_e('Apply', 'disciple_tools'); ?></button>
                <a class="button clear" id="advanced_search_reset"
                    style="display: inline-block"><?php esc_html_e('reset to default', 'disciple_tools'); ?></a>
            </div>
        </nav>
    </div>
    <nav role="navigation" style="width:100%;" class="second-bar show-for-small-only center list-actions-bar">
        <!--  /* MOBILE VIEW BUTTON AREA */ -->
        ...
        <div class="hideable-search" style="display: none; margin-top:5px">
            <div class="search-wrapper">
                ...
                <a class="advanced_search" id="advanced_search_mobile"
                    title="<?php esc_html_e('Advanced Search', 'disciple_tools') ?>">
                    <img class="dt-icon"
                        src="<?php echo esc_html(get_template_directory_uri() . '/dt-assets/images/options.svg') ?>"
                        alt="<?php esc_html_e('Advanced Search', 'disciple_tools') ?>" />
                ...
                <button class="button" style="margin-bottom:0"
                    id="search-mobile"><?php esc_html_e('Search', 'disciple_tools') ?></button>
            </div>
        </div>
        ...
        <div id="advanced_search_picker_mobile" class="list_field_picker"
            ...
            <button class="button" id="save_advanced_search_choices_mobile"
                style="display: inline-block"><?php esc_html_e('Apply', 'disciple_tools'); ?></button>
            <a class="button clear" id="advanced_search_reset_mobile"
                style="display: inline-block"><?php esc_html_e('reset to default', 'disciple_tools'); ?></a>
        </div>
    </nav>
            ...
            <aside class="cell large-3 xxlarge-2" id="list-filters">
                <div class="bordered-box">
                    ...
                    <div class="section-body">
                        ...
                        <div style="margin-bottom: 5px">
                            <a data-open="filter-modal"><img class="dt-blue-icon dt-icon"
                                    style="display: inline-block; margin-right:12px"
                                    src="<?php echo esc_html(get_template_directory_uri() . '/dt-assets/images/circle-add.svg') ?>" /><?php esc_html_e('Create custom filter', 'disciple_tools') ?></a>
                        </div>
                ...
                <div class="bordered-box">
                    ...
                    <div class="section-body">
                        <table>
                            <tbody style="border: none;">
                                <tr style="border: none;">
                                    <td style="padding:0">
                                        <select id="split_by_current_filter_select" style="margin-bottom: 0">
                                            <option value="" disabled selected>
                                                <?php echo esc_html(_x('select split by field', 'disciple_tools')) ?>
                                            </option>
                                            <?php
                                            $split_by_fields = [];
                                    ...
                                    <td>
                                        <button id="split_by_current_filter_button" class="button loader"
                                            style='margin-bottom: 0'><?php echo esc_html(_x('Go', 'disciple_tools')) ?></button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        <ul id="list-filter-tabs" class="accordion split-by-current-filter-accordion"
                            data-responsive-accordion-tabs="accordion medium-tabs large-accordion" style="display: none;">
                        ...
                        <span id="split_by_current_filter_no_results_msg"
                            style="display: none;margin-inline-start: 10px"><?php echo esc_attr(__('No results found', 'disciple_tools')) ?></span>
                    </div>
                </div>
                <br>
                <div class="bordered-box">
                    <div class="section-header">
                        ...
                        <button class="float-right" data-open="export_help_text">
                            <img class="help-icon" style="padding-left: 5px;"
                ...
                <div id="export_help_text" class="large reveal" data-reveal data-v-offset="10px">
                    ...
                    <div class="grid-x">
                        <div class="cell">
                            ...
                            <p><?php esc_html_e('Using the current filter, this is a simple way to export basic information and use it in other applications.', 'disciple_tools'); ?>
                            </p>
                        </div>
                        <div class="cell">
                        ...
                        <div class="cell">
                            ...
                            <p><?php esc_html_e('Using the current filter, this is intended for copy pasting a list of numbers into a messaging app, WhatsApp, Signal, etc. This is a quick way of starting a group conversation.', 'disciple_tools'); ?>
                            </p>
                        </div>
                        <div class="cell">
                            <p><strong><?php esc_html_e('Map List', 'disciple_tools'); ?></strong></p>
                            <p><?php esc_html_e('Using the current filter, this creates a basic points map of known locations of listed individuals.', 'disciple_tools'); ?>
                            </p>
                        </div>
                        <?php
            ...
            <main id="main" class="large-9 xxlarge-10 cell padding-bottom" role="main">
                <div class="bordered-box">
                    <div>
                            ...
                            <ul class="dropdown menu" data-dropdown-menu>
                                <li>
                                    ...
                                    <ul class="menu is-dropdown-submenu" style="min-width:220px">
                                        <li>
                                            <a href="#" class="js-sort-by" data-column-index="6" data-order="desc"
                                                data-field="post_date">
                                                <i class="mdi mdi-sort-calendar-descending"></i>
                                                <?php esc_html_e('Newest', 'disciple_tools'); ?></a>
                                        </li>
                                        <li>
                                            <a href="#" class="js-sort-by" data-column-index="6" data-order="asc"
                                                data-field="post_date">
                                            ...
                                            <?php if (isset($key) && (!isset($value['valid_post_type']) || $value['valid_post_type']($post_type))): ?>
                                                ...
                                                <li>
                                                    <a href="javascript:void(0);"
                                                        data-modal="<?php echo esc_html($value['section_id']); ?>"
                                                        data-checkboxes="<?php echo esc_html($show_list_checkboxes); ?>"
                                                        class="list-dropdown-submenu-item-link"
                                                        id="submenu-more-<?php echo esc_html($key); ?>">
                                                        <img src="<?php echo esc_html($value['icon']); ?>"
                                                            class="list-dropdown-submenu-icon">
                        ...
                        <span
                            style="display:<?php echo esc_html(!$status_key || !$archived_key ? 'none' : 'inline-block') ?>"
                            class="show-closed-switch">
                    ...
                    <div id="list_column_picker" class="list_field_picker list_action_section">
                        <button class="close-button list-action-close-button" data-close="list_column_picker"
                            aria-label="<?php esc_html_e('Close', 'disciple_tools'); ?>" type="button">
                            <span aria-hidden="true">×</span>
                        </button>
                        <p style="font-weight:bold">
                            <?php esc_html_e('Choose which fields to display as columns in the list', 'disciple_tools'); ?>
                        </p>
                        <?php
                        ...
                        <ul class="ul-no-bullets" style="">
                            <?php foreach ($post_settings['fields'] as $field_key => $field_values):
                                ...
                                <li style="" class="">
                                    <label style="margin-right:15px; cursor:pointer">
                                        <input type="checkbox" value="<?php echo esc_html($field_key); ?>" <?php echo esc_html(in_array($field_key, $fields_to_show_in_table) ? 'checked' : ''); ?>         <?php echo esc_html((empty($fields_to_show_in_table) && !empty($field_values['show_in_table'])) ? 'checked' : ''); ?> style="margin:0">
                        ...
                        <button class="button" id="save_column_choices"
                            style="display: inline-block"><?php esc_html_e('Apply', 'disciple_tools'); ?></button>
                        <a class="button clear" id="reset_column_choices"
                            style="display: inline-block"><?php esc_html_e('reset to default', 'disciple_tools'); ?></a>
                    </div>

                    <div id="bulk_edit_picker" class="list_action_section">
                        <button class="close-button list-action-close-button" data-close="bulk_edit_picker"
                            aria-label="<?php esc_html_e('Close', 'disciple_tools'); ?>" type="button">
                            <span aria-hidden="true">×</span>
                        </button>
                        <p style="font-weight:bold">
                            <?php
                            echo sprintf(esc_html__('Select all the  %1$s you want to update from the list, and update them below', 'disciple_tools'), esc_html($post_type)); ?>
                        </p>
                        <div class="grid-x grid-margin-x">
                            <?php if (isset($field_options['assigned_to'])): ?>
                                <div class="cell small-12 medium-4">
                                    ...
                                    <div class="bulk_assigned_to details">
                                        <var id="bulk_assigned_to-result-container"
                                            class="result-container bulk_assigned_to-result-container"></var>
                            ...
                            if ($post_type == 'contacts') { ?>
                                ...
                                <?php if (isset($field_options['overall_status'])): ?>
                                    <div class="cell small-12 medium-4">
                                        <div class="section-subheader">
                                            <img
                                                src="<?php echo esc_url(get_template_directory_uri()) . '/dt-assets/images/status.svg' ?>">
                            ...
                            <div class="cell small-12 medium-4">
                                ...
                                <div id="<?php echo esc_attr('bulk_share_connection') ?>" class="dt_typeahead">
                                    <span id="<?php echo esc_html('share'); ?>-result-container"
                                        class="result-container"></span>
                                    <div id="<?php echo esc_html('share'); ?>_t"
                                        name="form-<?php echo esc_html('share'); ?>"
                                        class="scrollable-typeahead typeahead-margin-when-active">
                                        <div class="typeahead__container" style="margin-bottom: 0">
                                            <div class="typeahead__field">
                                                <span class="typeahead__query">
                                                    <input id="bulk_share" class="input-height"
                                                        data-field="<?php echo esc_html('share'); ?>"
                                                        data-post_type="<?php echo esc_html($post_type) ?>"
                                                        data-field_type="connection" name="share[query]"
                            ...
                            <?php if (isset($field_options['requires_update'])): ?>
                                <div class="cell small-12 medium-4 center-items">
                                    <span
                                        style="margin-right:5px"><?php echo esc_html($field_options['requires_update']['name']); ?>:</span>
                                    <input type="checkbox" id="update-needed-bulk" class="dt-switch update-needed"
                                        data-bulk_key_requires_update="" />
                                    <label class="dt-switch" for="update-needed-bulk" style="vertical-align: top;"></label>
                                </div>
                            <?php endif; ?>
                            <div class="cell small-12 medium-4 center-items">
                                <button class="button follow"
                                    data-value=""><?php echo esc_html(__('Follow', 'disciple_tools')) ?></button>
                            </div>
                                ...
                                <div class="cell" id="bulk_add-comment-section">
                                    <div class="auto cell">
                                        <textarea class="mention" dir="auto" id="bulk_comment-input"
                                            placeholder="<?php echo esc_html_x('Write your comment or note here', 'input field placeholder', 'disciple_tools') ?>"></textarea>
                            ...
                            <span class="cell small-12 medium-12 center">
                                <a class="button" id="bulk_edit_seeMore">
                                    <span
                                        class="seeMoreText"><?php esc_html_e('See More Options', 'disciple_tools'); ?></span>
                                    <span class="seeFewerText"
                                        style="display:none"><?php esc_html_e('See Fewer Options', 'disciple_tools'); ?></span>
                                </a>
                            </span>
                            <div id="bulk_more" class="grid-x grid-margin-x" style="display:none;">
                                ...
                                foreach ($field_options as $field_option => $value):
                                    if (
                                        !in_array($field_option, $already_done) && array_key_exists('type', $value) && in_array($value['type'], $allowed_types)
                                        && $value['type'] != 'communication_channel' && empty($value['hidden'])
                                    ): ?>
                                        <div
                                            class="cell small-12 medium-<?php echo esc_attr(($value['type'] === 'multi_select' && ($value['display'] ?? '') !== 'typeahead') ? '12' : '4') ?>">
                        ...
                        <button class="button dt-green" id="bulk_edit_submit">
                            <span class="bulk_edit_submit_text"
                                data-pretext="<?php echo esc_html__('Update', 'disciple_tools'); ?>"
                            ...
                            <span id="bulk_edit_submit-spinner" style="display: inline-block;"
                    ...
                    <div id="bulk_send_msg_picker" class="list_action_section">
                        <button class="close-button list-action-close-button" data-close="bulk_send_msg_picker"
                            aria-label="<?php esc_html_e('Close', 'disciple_tools'); ?>" type="button">
                            <span aria-hidden="true">×</span>
                        </button>
                        <p style="font-weight:bold">
                            <?php
                            echo sprintf(esc_html__('Select all the %1$s to whom you want to message.', 'disciple_tools'), esc_html($post_type)); ?>
                        </p>
                        <div class="grid-x grid-margin-x">
                            <div class="cell">
                                <?php
...
Thanks!';
                                ...
                                <input type="text" id="bulk_send_msg_subject"
                                    value="<?php echo esc_attr($default_subject); ?>" style="margin-bottom: 0" />
                                <span id="bulk_send_msg_subject_support_text"
                                    style="display: none; font-style: italic; font-size: 11px; color: #ff0000;"><?php echo esc_html__('A valid message subject must be entered.', 'disciple_tools'); ?></span><br>

                                <label
                                    for="bulk_send_msg_from_name"><?php echo esc_html__('Message from name', 'disciple_tools'); ?></label>
                                <input type="text" id="bulk_send_msg_from_name"
                                    value="<?php echo esc_attr(dt_default_email_name()); ?>" style="margin-bottom: 0" />
...
//                                }
//                                ?>
                                <span id="bulk_send_msg_method_support_text"
                                    style="display: none; font-style: italic; font-size: 11px; color: #ff0000;"><br><?php echo esc_html__('Please ensure a valid send method has been specified.', 'disciple_tools'); ?></span><br>

                                <label for="bulk_send_msg"><?php echo esc_html__('Message', 'disciple_tools'); ?></label>
                                <textarea type="text" id="bulk_send_msg"
                                    rows="10"><?php echo esc_textarea($default_message); ?></textarea>
                                <span id="bulk_send_msg_support_text"
                                    style="display: none; font-style: italic; font-size: 11px; color: #ff0000;"><?php echo esc_html__('Please ensure a valid send message has been entered.', 'disciple_tools'); ?></span><br>
                                <span><?php echo esc_html__('Message placeholders', 'disciple_tools'); ?></span>
                                <ul>
                                    <li><span style="font-weight: bold;">{{name}}</span>:
                                        <?php echo esc_html__('Name of the Record', 'disciple_tools'); ?>
                                    </li>
                                </ul>
                            </div>
                            <div class="cell">
                                <label
                                    for="bulk_send_msg_required_elements"><?php echo esc_html__('Send to selected records', 'disciple_tools'); ?></label>
                                <span id="bulk_send_msg_required_elements"
                                    style="display:none;color:red;"><?php echo esc_html__('You must select at least one record', 'disciple_tools'); ?></span>
                                <div>
                                    <button class="button dt-green" id="bulk_send_msg_submit">
                                        <span class="bulk_edit_submit_text"
                                            data-pretext="<?php echo esc_html__('Send', 'disciple_tools'); ?>"
                                            data-posttext="<?php echo esc_html__('Links', 'disciple_tools'); ?>"
                                            style="text-transform:capitalize;">
                                            <?php echo esc_html(__('Make Selections Below', 'disciple_tools')); ?>
                                        </span>
                                        <span id="bulk_send_msg_submit-spinner" style="display: inline-block"
                                            class="loading-spinner"></span>
                                    </button><br>
                                    <span id="bulk_send_msg_submit_support_text"
                                        style="display: none; font-style: italic; font-size: 11px; color: #ff0000;"><?php echo esc_html__('Ensure valid record selections have been made.', 'disciple_tools'); ?></span>
                                </div>
                    ...
                    <div class="table-container">
                        ...
                        <table class="table-remove-top-border js-list stack striped" id="records-table">
                            <thead>
                                <tr class="table-headers dnd-moved sortable">
                                    <th id="bulk_edit_master" class="bulk_edit_checkbox"
                                        style="width:32px; background-image:none; cursor:default">
                                        <input type="checkbox" name="bulk_send_app_id" value=""
                                    ...
                                    if (class_exists('DT_Storage') && DT_Storage::is_enabled()):
                                        if (in_array('record_picture', $columns)): ?>
                                            <th data-id="record_picture" style="width:32px; background-image:none; cursor:default">
                                            </th>
                                        <?php endif; ?>
                                    <?php endif;
                            ...
                            <tbody id="table-content">
                                <tr class="js-list-loading">
                                    <td colspan=7><?php esc_html_e('Loading...', 'disciple_tools'); ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <dt-list postType="<?php echo $post_type ?>"
                        columns="<?php echo esc_attr($columns_json); ?>"></dt-list>
                    <div class="center">
                        <button id="load-more" class="button loader"
                            style="display: none"><?php esc_html_e('Load More', 'disciple_tools') ?></button>
                    </div>
                </div>
            </main>
        </div>
            ...
            <div class="grid-x">
                <div class="cell small-4" style="padding: 0 2px 5px 2px">
                    <input type="search" id="field-filter-name"
                        placeholder="<?php esc_html_e('Field Name', 'disciple_tools') ?>" style="margin-bottom: 0" />
                </div>
                    ...
                    <ul class="vertical tabs" data-tabs id="filter-tabs">
                        <?php foreach ($fields as $index => $field):
                            if (isset($field_options[$field]['name'])): ?>
                                <li class="tabs-title <?php if ($index === 0) {
                                    echo 'is-active'; } ?>" data-field="<?php echo esc_html($field) ?>">
                                    <a href="#<?php echo esc_html($field) ?>" <?php if ($index === 0) {
                ...
                <div class="cell small-8 tabs-content filter-modal-right" data-tabs-content="filter-tabs">
                    <?php foreach ($fields as $index => $field):
                        ...
                        if (isset($field_options[$field]) && ($field_options[$field]['type'] === 'connection' || $field_options[$field]['type'] === 'location' || $field_options[$field]['type'] === 'location_meta' || $field_options[$field]['type'] === 'user_select' || $is_multi_select)): ?>
                            <div class="tabs-panel <?php if ($index === 0) {
                                echo 'is-active'; } ?>" id="<?php echo esc_html($field) ?>">
                                <div class="section-header"><?php echo esc_html($field_options[$field]['name']) ?></div>
                                <div
                                    class="<?php echo esc_html($field); ?>  <?php echo esc_html($is_multi_select ? 'multi_select' : '') ?> details">
                                    <var id="<?php echo esc_html($field) ?>-result-container"
                                        class="result-container <?php echo esc_html($field) ?>-result-container"></var>
                                    <div id="<?php echo esc_html($field) ?>_t" name="form-<?php echo esc_html($field) ?>"
                                        class="scrollable-typeahead typeahead-margin-when-active">
                        ...
                        <?php else: ?>
                            <div class="tabs-panel <?php if ($index === 0) {
                                echo 'is-active'; } ?>"" id=" <?php echo esc_html($field) ?>">
                                <div class="section-header">
                                    <?php echo esc_html($field === 'post_date' ? __('Creation Date', 'disciple_tools') : $field_options[$field]['name'] ?? $field) ?>
                                </div>
                                <div id="<?php echo esc_html($field) ?>-options">
                                    ...
                                    <?php elseif (isset($field_options[$field]) && $field_options[$field]['type'] == 'boolean'): ?>
                                        <div class="boolean_options">
                                            <label style="cursor: pointer">
                                                <input autocomplete="off" type="checkbox" data-field="<?php echo esc_html($field) ?>"
                                                    data-label="<?php esc_html_e('No', 'disciple_tools') ?>" value="0">
                                        ...
                                        <div class="boolean_options">
                                            <label style="cursor: pointer">
                                                <input autocomplete="off" type="checkbox" data-field="<?php echo esc_html($field) ?>"
                                                    data-label="<?php esc_html_e('Yes', 'disciple_tools') ?>" value="1">
                                    ...
                                    <?php elseif (isset($field_options[$field]) && in_array($field_options[$field]['type'], ['date', 'datetime'])): ?>
                                        ...
                                        <input id="<?php echo esc_html($field) ?>_start" autocomplete="off" type="text"
                                            data-date-format='yy-mm-dd' class="dt_date_picker" data-delimit="start"
                                            data-field="<?php echo esc_html($field) ?>">
                                        <br>
                                        ...
                                        <button class="clear-date-picker" style="color:firebrick"
                                            ...
                                            <?php echo esc_html_x('Clear', 'Clear/empty input', 'disciple_tools') ?></button>
                                        <input id="<?php echo esc_html($field) ?>_end" autocomplete="off" type="text"
                                            data-date-format='yy-mm-dd' class="dt_date_picker" data-delimit="end"
                                            data-field="<?php echo esc_html($field) ?>">
                                    <?php elseif (isset($field_options[$field]) && in_array($field_options[$field]['type'], ['text', 'communication_channel'])): ?>
                                        <input id="<?php echo esc_html($field) ?>_text_comms_filter" type="text"
                                            class="text-comms-filter-input" data-field="<?php echo esc_html($field) ?>"
                                            placeholder="<?php echo esc_html_x('Filter By Value', 'The value to be searched for', 'disciple_tools') ?>" />

                                        <p>
                                            <label>
                                                <input name="filter_by_text_comms_option" class="filter-by-text-comms-option"
                                                    type="radio" value="all-with-filtered-value"
                                                    data-field="<?php echo esc_html($field) ?>" />
                                            ...
                                            <label>
                                                <input name="filter_by_text_comms_option" class="filter-by-text-comms-option"
                                                    type="radio" value="all-without-filtered-value"
                                                    data-field="<?php echo esc_html($field) ?>" />
                                            ...
                                            <label>
                                                <input name="filter_by_text_comms_option" class="filter-by-text-comms-option"
                                                    type="radio" value="all-with-set-value"
                                                    data-field="<?php echo esc_html($field) ?>" />
                                            ...
                                            <label>
                                                <input name="filter_by_text_comms_option" class="filter-by-text-comms-option"
                                                    type="radio" value="all-without-set-value"
                                                    data-field="<?php echo esc_html($field) ?>" />
            ...
            <div class="cell small-8 filter-modal-right confirm-buttons">
                ...
                <div class="grid-x grid-padding-x">
                    ...
                    <div class="cell small-5 filter-modal-right">
                        <button style="display: inline-block;" class="button loader confirm-filter-records" type="button"
                            id="confirm-filter-records" data-close>
                            <?php esc_html_e('Filter Records', 'disciple_tools') ?>
                        </button>
                        <button class="button loader confirm-filter-records" type="button" id="save-filter-edits" data-close
                            style="display: none;">
