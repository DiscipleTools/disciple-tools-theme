                    ...
                    <div class="type-options">
                        ...
                        foreach ( $post_settings['fields']['type']['default'] as $option_key => $type_option ) {
                            ...
                            if ( empty( $type_option['hidden'] ) && ( !isset( $type_option['in_create_form'] ) || $type_option['in_create_form'] !== false ) ) { ?>
                                <div class="type-option <?php echo esc_html( !empty( $type_option['default'] ) ? 'selected' : '' ); ?>"
                ...
                <div class="form-fields">
                    ...
                    <div id="show-shield-banner"
                        ...
                        <a class="button clear" id="hide-hidden-fields"
                            style="margin:0;padding:3px 0; width:100%; display: none;">
                    ...
                    <div style="text-align: center">
                        ...
                        <dt-button posttype="contacts" context="success" type="submit" id="create-post-button">Save and
                            continue
                            editing</dt-button>
                    </div>
