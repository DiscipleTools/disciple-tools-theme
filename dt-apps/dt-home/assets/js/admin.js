...
jQuery(document).ready(function($) {
    ...
    function setupFormValidation() {
        ...
        $('form:not(.app-form):not(.video-form):not(.app-edit-form):not(.video-edit-form)').on('submit', function(e) {
        ...
        $('.add-app-form, .add-video-form').find('input[required]').removeAttr('required');
        
        // Disable hidden forms to prevent them from interfering with main form submission
        $('.add-app-form, .add-video-form').find('input, textarea, select').prop('disabled', true);
    }
    ...
    function setupEventHandlers() {
        ...
        $(document).on('click', '.add-new-app-btn', function(e) {
            ...
            $('.add-app-form').find('input, textarea, select').prop('disabled', false);
        ...
        $(document).on('click', '.add-new-video-btn', function(e) {
            ...
            // Enable and restore required attributes when form is shown
            $('.add-video-form').find('input, textarea, select').prop('disabled', false);
            $('.add-video-form input[type="text"], .add-video-form input[type="url"]').attr('required', 'required');
        });
    ...
    function showEditVideoForm(videoId) {
        ...
        const $videoRow = $(`.edit-video[data-video-id="${videoId}"]`).closest('tr');
        const videoData = {
            id: videoId,
