...
class DT_Home_Magic_Link_App extends DT_Magic_Url_Base {
    ...
    public function header_style() {
        ?>
        <style>
            /* Base body styles moved to home-screen.css - CSS reset and body styles are now in external CSS file */

            /* Container and header styles moved to home-screen.css - keeping only critical override */
            .home-screen-container {
                background: transparent !important; /* Critical: Ensure transparent background */
            }
            ...
            /* Floating menu styles moved to home-screen.css - all floating menu and menu item styles are now in external CSS file */

            /* Header h1, p, and content styles moved to home-screen.css */
            /* Training card styles moved to home-screen.css - all training video card, grid, and responsive styles are now in external CSS file */

        /* Invite modal styles moved to home-screen.css - all invite modal styles including overlay, content, buttons, and responsive adjustments are now in external CSS file */

        /* Apps grid styles moved to home-screen.css - removed conflicting inline style */
            ...
            /* App card styles moved to home-screen.css - CSS variables above provide early initialization for theme-aware styling */
            /* App icon, title, and description styles moved to home-screen.css - scoped selectors (.apps-grid .app-icon, .apps-grid .app-title) handle styling */
