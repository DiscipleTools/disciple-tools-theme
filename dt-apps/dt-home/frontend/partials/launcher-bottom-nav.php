...
?>
<div class="dt-launcher-bottom-nav">
    <div class="nav-container">
        <button class="nav-item" id="dt-apps-selector-button" aria-label="<?php esc_attr_e( 'Apps', 'disciple_tools' ); ?>">
...
<div class="dt-launcher-apps-selector">
    <ul>
