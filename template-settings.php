                    ...
                    <div class="bordered-box cell" id="profile" data-magellan-target="profile">
                        ...
                        <div class="grid-x grid-margin-x grid-padding-x grid-padding-y ">
                            ...
                            <div class="small-12 medium-4 cell">
                                ...
                                <p>
                                    <?php
                                    if ( Disciple_Tools_Storage::is_enabled() && isset( $dt_user_meta['dt_user_profile_picture'][0] ) ) {
                                        $picture_url = Disciple_Tools_Storage::get_file_url( $dt_user_meta['dt_user_profile_picture'][0] ); ?>
                            ...
                            <table class="table">
                                <tr>
                                    <td>
                                        <?php
                                        if ( Disciple_Tools_Storage::is_enabled() && isset( $dt_user_meta['dt_user_profile_picture'][0] ) ){
                                            $picture_url = Disciple_Tools_Storage::get_thumbnail_url( $dt_user_meta['dt_user_profile_picture'][0] );
